...
dev = tvm.cuda(5)
rt_mod = load_module_from_file("/home/weitao/XIAG8XX/profile/dtas_tuned/general_reduction/layernorm/top1_256_2")
timer=rt_mod.time_evaluator(func_name="fused_layer_norm_cast1", dev=dev, number=10,  min_repeat_ms=50 )
...
save_to_json(
    result,
    "/home/weitao/XIAG8XX/profile/dtas_tuned/general_reduction/layernorm/top1_256_2/latency.json",
)   
