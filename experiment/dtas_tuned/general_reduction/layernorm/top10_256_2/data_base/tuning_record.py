...
#name: fused_layer_norm_cast1
#range: (<n: Range(513, 768)>,)  latency(ms):    0.0144    
#config: ReductionConfig: {'len_tx': 320, 'unroll_depth': 256, 'vector_size': 4, 'temp_storage': 'shared.dyn', 'max_active_blocks_per_sm': 4}
# from tvm.script import ir as I
# from tvm.script import tir as T
...
#name: fused_layer_norm_cast1
#range: (<n: Range(769, 1024)>,)  latency(ms):    0.0192    
#config: ReductionConfig: {'len_tx': 320, 'unroll_depth': 256, 'vector_size': 4, 'temp_storage': 'shared.dyn', 'max_active_blocks_per_sm': 4}
# from tvm.script import ir as I
# from tvm.script import tir as T
...
#name: fused_layer_norm_cast1
#range: (<n: Range(769, 1024)>,)  latency(ms):    0.0194    
#config: ReductionConfig: {'len_tx': 512, 'unroll_depth': 256, 'vector_size': 4, 'temp_storage': 'shared.dyn', 'max_active_blocks_per_sm': 3}
# from tvm.script import ir as I
# from tvm.script import tir as T
...
#name: fused_layer_norm_cast1
#range: (<n: Range(1025, 1280)>,)  latency(ms):    0.0241    
#config: ReductionConfig: {'len_tx': 384, 'unroll_depth': 256, 'vector_size': 4, 'temp_storage': 'shared.dyn', 'max_active_blocks_per_sm': 4}
# from tvm.script import ir as I
# from tvm.script import tir as T
...
#name: fused_layer_norm_cast1
#range: (<n: Range(1025, 1280)>,)  latency(ms):    0.0240    
#config: ReductionConfig: {'len_tx': 320, 'unroll_depth': 256, 'vector_size': 4, 'temp_storage': 'shared.dyn', 'max_active_blocks_per_sm': 4}
# from tvm.script import ir as I
# from tvm.script import tir as T
...
#name: fused_layer_norm_cast1
#range: (<n: Range(1025, 1280)>,)  latency(ms):    0.0252    
#config: ReductionConfig: {'len_tx': 192, 'unroll_depth': 256, 'vector_size': 4, 'temp_storage': 'shared.dyn', 'max_active_blocks_per_sm': 8}
# from tvm.script import ir as I
# from tvm.script import tir as T
...
#name: fused_layer_norm_cast1
#range: (<n: Range(1281, 1536)>,)  latency(ms):    0.0284    
#config: ReductionConfig: {'len_tx': 512, 'unroll_depth': 256, 'vector_size': 4, 'temp_storage': 'shared.dyn', 'max_active_blocks_per_sm': 3}
# from tvm.script import ir as I
# from tvm.script import tir as T
...
#name: fused_layer_norm_cast1
#range: (<n: Range(1537, 1792)>,)  latency(ms):    0.0333    
#config: ReductionConfig: {'len_tx': 512, 'unroll_depth': 256, 'vector_size': 4, 'temp_storage': 'shared.dyn', 'max_active_blocks_per_sm': 3}
# from tvm.script import ir as I
# from tvm.script import tir as T
...
#name: fused_layer_norm_cast1
#range: (<n: Range(1793, 2048)>,)  latency(ms):    0.0398    
#config: ReductionConfig: {'len_tx': 224, 'unroll_depth': 256, 'vector_size': 4, 'temp_storage': 'shared.dyn', 'max_active_blocks_per_sm': 6}
# from tvm.script import ir as I
# from tvm.script import tir as T
...
#name: fused_layer_norm_cast1
#range: (<n: Range(2049, 2304)>,)  latency(ms):    0.0439    
#config: ReductionConfig: {'len_tx': 128, 'unroll_depth': 256, 'vector_size': 4, 'temp_storage': 'shared.dyn', 'max_active_blocks_per_sm': 10}
# from tvm.script import ir as I
# from tvm.script import tir as T
...
#name: fused_layer_norm_cast1
#range: (<n: Range(2049, 2304)>,)  latency(ms):    0.0444    
#config: ReductionConfig: {'len_tx': 224, 'unroll_depth': 256, 'vector_size': 4, 'temp_storage': 'shared.dyn', 'max_active_blocks_per_sm': 6}
# from tvm.script import ir as I
# from tvm.script import tir as T
...
#name: fused_layer_norm_cast1
#range: (<n: Range(2305, 2560)>,)  latency(ms):    0.0475    
#config: ReductionConfig: {'len_tx': 512, 'unroll_depth': 256, 'vector_size': 4, 'temp_storage': 'shared.dyn', 'max_active_blocks_per_sm': 3}
# from tvm.script import ir as I
# from tvm.script import tir as T
...
#name: fused_layer_norm_cast1
#range: (<n: Range(2305, 2560)>,)  latency(ms):    0.0484    
#config: ReductionConfig: {'len_tx': 192, 'unroll_depth': 256, 'vector_size': 4, 'temp_storage': 'shared.dyn', 'max_active_blocks_per_sm': 8}
# from tvm.script import ir as I
# from tvm.script import tir as T
...
#name: fused_layer_norm_cast1
#range: (<n: Range(2305, 2560)>,)  latency(ms):    0.0481    
#config: ReductionConfig: {'len_tx': 384, 'unroll_depth': 256, 'vector_size': 4, 'temp_storage': 'shared.dyn', 'max_active_blocks_per_sm': 4}
# from tvm.script import ir as I
# from tvm.script import tir as T
...
#name: fused_layer_norm_cast1
#range: (<n: Range(2561, 2816)>,)  latency(ms):    0.0522    
#config: ReductionConfig: {'len_tx': 512, 'unroll_depth': 256, 'vector_size': 4, 'temp_storage': 'shared.dyn', 'max_active_blocks_per_sm': 3}
# from tvm.script import ir as I
# from tvm.script import tir as T
...
#name: fused_layer_norm_cast1
#range: (<n: Range(2561, 2816)>,)  latency(ms):    0.0535    
#config: ReductionConfig: {'len_tx': 224, 'unroll_depth': 256, 'vector_size': 4, 'temp_storage': 'shared.dyn', 'max_active_blocks_per_sm': 6}
# from tvm.script import ir as I
# from tvm.script import tir as T
...
#name: fused_layer_norm_cast1
#range: (<n: Range(2817, 3072)>,)  latency(ms):    0.0572    
#config: ReductionConfig: {'len_tx': 192, 'unroll_depth': 256, 'vector_size': 4, 'temp_storage': 'shared.dyn', 'max_active_blocks_per_sm': 8}
# from tvm.script import ir as I
# from tvm.script import tir as T
...
#name: fused_layer_norm_cast1
#range: (<n: Range(2817, 3072)>,)  latency(ms):    0.0580    
#config: ReductionConfig: {'len_tx': 288, 'unroll_depth': 256, 'vector_size': 4, 'temp_storage': 'shared.dyn', 'max_active_blocks_per_sm': 5}
# from tvm.script import ir as I
# from tvm.script import tir as T
...
#name: fused_layer_norm_cast1
#range: (<n: Range(2817, 3072)>,)  latency(ms):    0.0583    
#config: ReductionConfig: {'len_tx': 224, 'unroll_depth': 256, 'vector_size': 4, 'temp_storage': 'shared.dyn', 'max_active_blocks_per_sm': 6}
# from tvm.script import ir as I
# from tvm.script import tir as T
...
#name: fused_layer_norm_cast1
#range: (<n: Range(3073, 3328)>,)  latency(ms):    0.0614    
#config: ReductionConfig: {'len_tx': 512, 'unroll_depth': 256, 'vector_size': 4, 'temp_storage': 'shared.dyn', 'max_active_blocks_per_sm': 3}
# from tvm.script import ir as I
# from tvm.script import tir as T
...
#name: fused_layer_norm_cast1
#range: (<n: Range(3329, 3584)>,)  latency(ms):    0.0678    
#config: ReductionConfig: {'len_tx': 256, 'unroll_depth': 256, 'vector_size': 4, 'temp_storage': 'shared.dyn', 'max_active_blocks_per_sm': 6}
# from tvm.script import ir as I
# from tvm.script import tir as T
...
#name: fused_layer_norm_cast1
#range: (<n: Range(3329, 3584)>,)  latency(ms):    0.0658    
#config: ReductionConfig: {'len_tx': 512, 'unroll_depth': 256, 'vector_size': 4, 'temp_storage': 'shared.dyn', 'max_active_blocks_per_sm': 3}
# from tvm.script import ir as I
# from tvm.script import tir as T
...
#name: fused_layer_norm_cast1
#range: (<n: Range(3585, 3840)>,)  latency(ms):    0.0707    
#config: ReductionConfig: {'len_tx': 512, 'unroll_depth': 256, 'vector_size': 4, 'temp_storage': 'shared.dyn', 'max_active_blocks_per_sm': 3}
# from tvm.script import ir as I
# from tvm.script import tir as T
...
#name: fused_layer_norm_cast1
#range: (<n: Range(3585, 3840)>,)  latency(ms):    0.0728    
#config: ReductionConfig: {'len_tx': 256, 'unroll_depth': 256, 'vector_size': 4, 'temp_storage': 'shared.dyn', 'max_active_blocks_per_sm': 6}
# from tvm.script import ir as I
# from tvm.script import tir as T
...
#name: fused_layer_norm_cast1
#range: (<n: Range(3841, 4096)>,)  latency(ms):    0.0762    
#config: ReductionConfig: {'len_tx': 224, 'unroll_depth': 256, 'vector_size': 4, 'temp_storage': 'shared.dyn', 'max_active_blocks_per_sm': 6}
# from tvm.script import ir as I
# from tvm.script import tir as T
...
#name: fused_layer_norm_cast1
#range: (<n: Range(3841, 4096)>,)  latency(ms):    0.0771    
#config: ReductionConfig: {'len_tx': 256, 'unroll_depth': 256, 'vector_size': 4, 'temp_storage': 'shared.dyn', 'max_active_blocks_per_sm': 6}
# from tvm.script import ir as I
# from tvm.script import tir as T
...
#name: fused_layer_norm_cast1
#range: (<n: Range(3841, 4096)>,)  latency(ms):    0.0765    
#config: ReductionConfig: {'len_tx': 128, 'unroll_depth': 256, 'vector_size': 4, 'temp_storage': 'shared.dyn', 'max_active_blocks_per_sm': 10}
# from tvm.script import ir as I
# from tvm.script import tir as T
...
#name: fused_layer_norm_cast1
#range: (<n: Range(3841, 4096)>,)  latency(ms):    0.0751    
#config: ReductionConfig: {'len_tx': 512, 'unroll_depth': 256, 'vector_size': 4, 'temp_storage': 'shared.dyn', 'max_active_blocks_per_sm': 3}
# from tvm.script import ir as I
# from tvm.script import tir as T
