...
static void* fused_layer_norm_cast1_n_1281_to_4096__kernel_packed = NULL;
#ifdef __cplusplus
extern "C"
#endif
...
TVM_DLL int32_t fused_layer_norm_cast1(void* args, int32_t* arg_type_ids, int32_t num_args, void* out_ret_value, int32_t* out_ret_tcode, void* resource_handle) {
  ...
  kernel_entry_info call_table[] = {
    ...
    {{ n, (int64_t)512, ((int64_t)10240)}, fused_layer_norm_cast1_n_1281_to_4096__kernel_packed, "fused_layer_norm_cast1_n_1281_to_4096__kernel"},
     };
  int64_t index = (n/256) > 15 ? 15 : n/256;
  int64_t index_table[] = {0,1,2,2,2,3,3,3,3,3,3,3,3,3,3,3};
