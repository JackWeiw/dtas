...
def plot_bandwidth_comparison(root_folder):
    ...
    plt.title('Cast Bandwidth Comparison')
    plt.legend()
    plt.tight_layout()
    # plt.show()
...
def plot_throught_comparison(root_folder):    
    ...
    plt.title('Cast Throughputs Comparison')
    plt.legend()
    plt.tight_layout()
...
plot_bandwidth_comparison('/home/weitao/XIAG8XX/profile/dtas_tuned/elementwise/cast')
plot_throught_comparison('/home/weitao/XIAG8XX/profile/dtas_tuned/elementwise/cast')