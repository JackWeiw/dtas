...
TVM_DLL int32_t cast(void* args, int32_t* arg_type_ids, int32_t num_args, void* out_ret_value, int32_t* out_ret_tcode, void* resource_handle) {
  ...
  kernel_entry_info call_table[] = {
    {{ (int64_t)640, (int64_t)256}, cast_n_1_to_256__kernel_packed, "cast_n_1_to_256__kernel"},
    {{ (int64_t)1280, (int64_t)256}, cast_n_257_to_512__kernel_packed, "cast_n_257_to_512__kernel"},
    {{ (int64_t)960, (int64_t)256}, cast_n_513_to_768__kernel_packed, "cast_n_513_to_768__kernel"},
    {{ (int64_t)2560, (int64_t)256}, cast_n_769_to_1024__kernel_packed, "cast_n_769_to_1024__kernel"},
    {{ (int64_t)3200, (int64_t)256}, cast_n_1025_to_1280__kernel_packed, "cast_n_1025_to_1280__kernel"},
    {{ (int64_t)3840, (int64_t)256}, cast_n_1281_to_1536__kernel_packed, "cast_n_1281_to_1536__kernel"},
    {{ (int64_t)2240, (int64_t)256}, cast_n_1537_to_1792__kernel_packed, "cast_n_1537_to_1792__kernel"},
    {{ (int64_t)5120, (int64_t)256}, cast_n_1793_to_2048__kernel_packed, "cast_n_1793_to_2048__kernel"},
    {{ (int64_t)5760, (int64_t)256}, cast_n_2049_to_2304__kernel_packed, "cast_n_2049_to_2304__kernel"},
