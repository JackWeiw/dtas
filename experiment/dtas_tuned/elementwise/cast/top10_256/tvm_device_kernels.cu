...
#endif
extern "C" __global__ void __launch_bounds__(256) cast_n_1_to_256__kernel(half* __restrict__ A, float* __restrict__ compute, int64_t n);
extern "C" __global__ void __launch_bounds__(256) cast_n_257_to_512__kernel(half* __restrict__ A, float* __restrict__ compute, int64_t n);
extern "C" __global__ void __launch_bounds__(256) cast_n_513_to_768__kernel(half* __restrict__ A, float* __restrict__ compute, int64_t n);
extern "C" __global__ void __launch_bounds__(256) cast_n_769_to_1024__kernel(half* __restrict__ A, float* __restrict__ compute, int64_t n);
extern "C" __global__ void __launch_bounds__(256) cast_n_1025_to_1280__kernel(half* __restrict__ A, float* __restrict__ compute, int64_t n);
extern "C" __global__ void __launch_bounds__(256) cast_n_1281_to_1536__kernel(half* __restrict__ A, float* __restrict__ compute, int64_t n);
extern "C" __global__ void __launch_bounds__(256) cast_n_1537_to_1792__kernel(half* __restrict__ A, float* __restrict__ compute, int64_t n);
extern "C" __global__ void __launch_bounds__(256) cast_n_1793_to_2048__kernel(half* __restrict__ A, float* __restrict__ compute, int64_t n);
extern "C" __global__ void __launch_bounds__(256) cast_n_2049_to_2304__kernel(half* __restrict__ A, float* __restrict__ compute, int64_t n);
extern "C" __global__ void __launch_bounds__(256) cast_n_2305_to_2560__kernel(half* __restrict__ A, float* __restrict__ compute, int64_t n);
extern "C" __global__ void __launch_bounds__(256) cast_n_2561_to_2816__kernel(half* __restrict__ A, float* __restrict__ compute, int64_t n);
extern "C" __global__ void __launch_bounds__(256) cast_n_2817_to_3072__kernel(half* __restrict__ A, float* __restrict__ compute, int64_t n);
extern "C" __global__ void __launch_bounds__(256) cast_n_3073_to_3328__kernel(half* __restrict__ A, float* __restrict__ compute, int64_t n);
extern "C" __global__ void __launch_bounds__(256) cast_n_3329_to_3584__kernel(half* __restrict__ A, float* __restrict__ compute, int64_t n);
extern "C" __global__ void __launch_bounds__(256) cast_n_3585_to_3840__kernel(half* __restrict__ A, float* __restrict__ compute, int64_t n);
extern "C" __global__ void __launch_bounds__(256) cast_n_3841_to_4096__kernel(half* __restrict__ A, float* __restrict__ compute, int64_t n);
extern "C" __global__ void __launch_bounds__(256) cast_n_1_to_256__kernel(half* __restrict__ A, float* __restrict__ compute, int64_t n) {
