...
#name: cast
#range: (<n: Range(257, 512)>,)  latency(ms):    0.0064    
...
#name: cast
#range: (<n: Range(257, 512)>,)  latency(ms):    0.0052    
...
#name: cast
#range: (<n: Range(513, 768)>,)  latency(ms):    0.0140    
...
#name: cast
#range: (<n: Range(513, 768)>,)  latency(ms):    0.0137    
...
#name: cast
#range: (<n: Range(769, 1024)>,)  latency(ms):    0.0186    
...
#name: cast
#range: (<n: Range(1025, 1280)>,)  latency(ms):    0.0234    
...
#name: cast
#range: (<n: Range(1281, 1536)>,)  latency(ms):    0.0278    
...
#name: cast
#range: (<n: Range(1281, 1536)>,)  latency(ms):    0.0281    
...
#name: cast
#range: (<n: Range(1537, 1792)>,)  latency(ms):    0.0329    
...
#name: cast
#range: (<n: Range(1793, 2048)>,)  latency(ms):    0.0374    
...
#name: cast
#range: (<n: Range(2049, 2304)>,)  latency(ms):    0.0418    
...
#name: cast
#range: (<n: Range(2049, 2304)>,)  latency(ms):    0.0422    
...
#name: cast
#range: (<n: Range(2305, 2560)>,)  latency(ms):    0.0468    
...
#name: cast
#range: (<n: Range(2305, 2560)>,)  latency(ms):    0.0466    
...
#name: cast
#range: (<n: Range(2561, 2816)>,)  latency(ms):    0.0513    
...
#name: cast
#range: (<n: Range(2561, 2816)>,)  latency(ms):    0.0516    
...
#name: cast
#range: (<n: Range(2817, 3072)>,)  latency(ms):    0.0562    
...
#name: cast
#range: (<n: Range(3073, 3328)>,)  latency(ms):    0.0689    
...
#name: cast
#range: (<n: Range(3073, 3328)>,)  latency(ms):    0.0605    
...
#name: cast
#range: (<n: Range(3329, 3584)>,)  latency(ms):    0.0763    
#config: ElementwiseConfig: {'len_tx': 256, 'vector_size': 2, 'grid_size': 15744, 'unroll_depth': 256}
# from tvm.script import ir as I
# from tvm.script import tir as T
...
#name: cast
#range: (<n: Range(3585, 3840)>,)  latency(ms):    0.0797    
#config: ElementwiseConfig: {'len_tx': 256, 'vector_size': 2, 'grid_size': 15744, 'unroll_depth': 256}
# from tvm.script import ir as I
# from tvm.script import tir as T
...
#name: cast
#range: (<n: Range(3841, 4096)>,)  latency(ms):    0.0833    
#config: ElementwiseConfig: {'len_tx': 256, 'vector_size': 2, 'grid_size': 15744, 'unroll_depth': 256}
# from tvm.script import ir as I
# from tvm.script import tir as T
