...
extern "C" __global__ void __launch_bounds__(256) add_n_1_to_256__kernel(signed char* __restrict__ A, signed char* __restrict__ B, signed char* __restrict__ T_add_n_1_to_256_, int64_t n) {
  for (int64_t ax0_ax1_fused_1 = 0; ax0_ax1_fused_1 < ((n + (int64_t)255) >> (int64_t)8); ++ax0_ax1_fused_1) {
    if ((((((((int64_t)blockIdx.x) * ((n + (int64_t)255) >> (int64_t)8)) * (int64_t)256) + (ax0_ax1_fused_1 * (int64_t)256)) + ((int64_t)threadIdx.x)) - (n * (int64_t)320)) < (int64_t)0) {
      int2 __1;
        int2 v_ = *(int2*)(A + (((ax0_ax1_fused_1 * (int64_t)2048) + ((((int64_t)blockIdx.x) * ((n + (int64_t)255) >> (int64_t)8)) * (int64_t)2048)) + (((int64_t)threadIdx.x) * (int64_t)8)));
        int2 v__1 = *(int2*)(B + (((ax0_ax1_fused_1 * (int64_t)2048) + ((((int64_t)blockIdx.x) * ((n + (int64_t)255) >> (int64_t)8)) * (int64_t)2048)) + (((int64_t)threadIdx.x) * (int64_t)8)));
      ...
      *(int2*)(T_add_n_1_to_256_ + (((ax0_ax1_fused_1 * (int64_t)2048) + ((((int64_t)blockIdx.x) * ((n + (int64_t)255) >> (int64_t)8)) * (int64_t)2048)) + (((int64_t)threadIdx.x) * (int64_t)8))) = __1;
    }
  }
}
...
extern "C" __global__ void __launch_bounds__(256) add_n_257_to_512__kernel(signed char* __restrict__ A, signed char* __restrict__ B, signed char* __restrict__ T_add_n_257_to_512_, int64_t n) {
  for (int64_t ax0_ax1_fused_1 = 0; ax0_ax1_fused_1 < ((n + (int64_t)511) >> (int64_t)9); ++ax0_ax1_fused_1) {
    if ((((((((int64_t)blockIdx.x) * ((n + (int64_t)511) >> (int64_t)9)) * (int64_t)256) + (ax0_ax1_fused_1 * (int64_t)256)) + ((int64_t)threadIdx.x)) - (n * (int64_t)320)) < (int64_t)0) {
      int2 __1;
        int2 v_ = *(int2*)(A + (((ax0_ax1_fused_1 * (int64_t)2048) + ((((int64_t)blockIdx.x) * ((n + (int64_t)511) >> (int64_t)9)) * (int64_t)2048)) + (((int64_t)threadIdx.x) * (int64_t)8)));
        int2 v__1 = *(int2*)(B + (((ax0_ax1_fused_1 * (int64_t)2048) + ((((int64_t)blockIdx.x) * ((n + (int64_t)511) >> (int64_t)9)) * (int64_t)2048)) + (((int64_t)threadIdx.x) * (int64_t)8)));
        __1.x=((((char)(v_.x >> 0))+((char)(v__1.x >> 0))) << 0);
        __1.x=__1.x & ~(0x000000ff << 8) |((((char)(v_.x >> 8))+((char)(v__1.x >> 8))) << 8);
        __1.x=__1.x & ~(0x000000ff << 16) |((((char)(v_.x >> 16))+((char)(v__1.x >> 16))) << 16);
        __1.x=__1.x & ~(0x000000ff << 24) |((((char)(v_.x >> 24))+((char)(v__1.x >> 24))) << 24);
        ...
        __1.y=__1.y & ~(0x000000ff << 16) |((((char)(v_.y >> 16))+((char)(v__1.y >> 16))) << 16);
        __1.y=__1.y & ~(0x000000ff << 24) |((((char)(v_.y >> 24))+((char)(v__1.y >> 24))) << 24);
      *(int2*)(T_add_n_257_to_512_ + (((ax0_ax1_fused_1 * (int64_t)2048) + ((((int64_t)blockIdx.x) * ((n + (int64_t)511) >> (int64_t)9)) * (int64_t)2048)) + (((int64_t)threadIdx.x) * (int64_t)8))) = __1;
    }
  }
}
