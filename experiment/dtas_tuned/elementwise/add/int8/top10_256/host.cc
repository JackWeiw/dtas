...
TVM_DLL int32_t add(void* args, int32_t* arg_type_ids, int32_t num_args, void* out_ret_value, int32_t* out_ret_tcode, void* resource_handle) {
  ...
  kernel_entry_info call_table[] = {
    ...
    {{ (int64_t)480, (int64_t)256}, add_n_513_to_768__kernel_packed, "add_n_513_to_768__kernel"},
    {{ (int64_t)640, (int64_t)256}, add_n_769_to_1024__kernel_packed, "add_n_769_to_1024__kernel"},
    {{ (int64_t)800, (int64_t)256}, add_n_1025_to_1280__kernel_packed, "add_n_1025_to_1280__kernel"},
    {{ (int64_t)960, (int64_t)256}, add_n_1281_to_1536__kernel_packed, "add_n_1281_to_1536__kernel"},
    {{ (int64_t)1120, (int64_t)256}, add_n_1537_to_1792__kernel_packed, "add_n_1537_to_1792__kernel"},
    {{ (int64_t)1280, (int64_t)256}, add_n_1793_to_2048__kernel_packed, "add_n_1793_to_2048__kernel"},
    {{ (int64_t)1440, (int64_t)256}, add_n_2049_to_2304__kernel_packed, "add_n_2049_to_2304__kernel"},
    {{ (int64_t)1600, (int64_t)256}, add_n_2305_to_2560__kernel_packed, "add_n_2305_to_2560__kernel"},
    {{ (int64_t)1760, (int64_t)256}, add_n_2561_to_2816__kernel_packed, "add_n_2561_to_2816__kernel"},
    {{ (int64_t)1920, (int64_t)256}, add_n_2817_to_3072__kernel_packed, "add_n_2817_to_3072__kernel"},
    {{ (int64_t)2080, (int64_t)256}, add_n_3073_to_3328__kernel_packed, "add_n_3073_to_3328__kernel"},
    {{ (int64_t)2240, (int64_t)256}, add_n_3329_to_3584__kernel_packed, "add_n_3329_to_3584__kernel"},
    {{ (int64_t)2400, (int64_t)256}, add_n_3585_to_3840__kernel_packed, "add_n_3585_to_3840__kernel"},
    {{ (int64_t)2560, (int64_t)256}, add_n_3841_to_4096__kernel_packed, "add_n_3841_to_4096__kernel"},
     };
