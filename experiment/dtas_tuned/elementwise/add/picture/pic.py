...
def plot_bandwidth_comparison(root_folder):
    ...
    plt.title('Add Bandwidth Comparison')
    plt.legend()
    plt.tight_layout()
    # plt.show()
    plt.savefig("./f32bandwidth_comparison.png")
...
def plot_throught_comparison(root_folder):    
    ...
    plt.title('Add Throughputs Comparison')
    plt.legend()
    plt.tight_layout()
    plt.savefig("./f32throughput_comparison.png")
# if __name__ == "__main__":
#     root_folder = os.path.dirname(os.path.abspath(__file__))
#     plot_bandwidth_comparison(root_folder)

plot_bandwidth_comparison('/home/weitao/XIAG8XX/profile/dtas_tuned/elementwise/add/float32')
plot_throught_comparison('/home/weitao/XIAG8XX/profile/dtas_tuned/elementwise/add/float32')