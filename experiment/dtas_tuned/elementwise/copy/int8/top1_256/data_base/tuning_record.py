#name: copy
#range: (<n: Range(1, 256)>,)  latency(ms):    0.0021    
...
#name: copy
#range: (<n: Range(257, 512)>,)  latency(ms):    0.0022    
...
#name: copy
#range: (<n: Range(2049, 2304)>,)  latency(ms):    0.0153    
...
#name: copy
#range: (<n: Range(2305, 2560)>,)  latency(ms):    0.0170    
...
#name: copy
#range: (<n: Range(2561, 2816)>,)  latency(ms):    0.0186    
...
#name: copy
#range: (<n: Range(2817, 3072)>,)  latency(ms):    0.0201    
...
#name: copy
#range: (<n: Range(3329, 3584)>,)  latency(ms):    0.0233    
