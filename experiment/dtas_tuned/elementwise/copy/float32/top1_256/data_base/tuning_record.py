...
#name: copy
#range: (<n: Range(1281, 1536)>,)  latency(ms):    0.0366    
...
#name: copy
#range: (<n: Range(1537, 1792)>,)  latency(ms):    0.0428    
...
#name: copy
#range: (<n: Range(2049, 2304)>,)  latency(ms):    0.0552    
...
#name: copy
#range: (<n: Range(2305, 2560)>,)  latency(ms):    0.0616    
...
#name: copy
#range: (<n: Range(2561, 2816)>,)  latency(ms):    0.0677    
...
#name: copy
#range: (<n: Range(2817, 3072)>,)  latency(ms):    0.0740    
...
#name: copy
#range: (<n: Range(3073, 3328)>,)  latency(ms):    0.0802    
...
#name: copy
#range: (<n: Range(3329, 3584)>,)  latency(ms):    0.0864    
...
#name: copy
#range: (<n: Range(3841, 4096)>,)  latency(ms):    0.0987    
