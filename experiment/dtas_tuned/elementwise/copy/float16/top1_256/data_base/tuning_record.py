...
#name: copy
#range: (<n: Range(513, 768)>,)  latency(ms):    0.0061    
...
#name: copy
#range: (<n: Range(1025, 1280)>,)  latency(ms):    0.0162    
...
#name: copy
#range: (<n: Range(1537, 1792)>,)  latency(ms):    0.0225    
...
#name: copy
#range: (<n: Range(2049, 2304)>,)  latency(ms):    0.0288    
...
#name: copy
#range: (<n: Range(3073, 3328)>,)  latency(ms):    0.0414    
...
#name: copy
#range: (<n: Range(3329, 3584)>,)  latency(ms):    0.0444    
...
#name: copy
#range: (<n: Range(3841, 4096)>,)  latency(ms):    0.0506    
