...
extern "C" __global__ void __launch_bounds__(128) softmax_n_1_to_2048__m_1025_to_2048__kernel(float* __restrict__ lv38, half* __restrict__ var_compute_intermediate, int64_t m, int64_t n);
extern "C" __global__ void __launch_bounds__(128) softmax_n_1_to_2048__m_1_to_1024__kernel(float* __restrict__ lv38, half* __restrict__ var_compute_intermediate, int64_t m, int64_t n) {
...
extern "C" __global__ void __launch_bounds__(128) softmax_n_1_to_2048__m_1025_to_2048__kernel(float* __restrict__ lv38, half* __restrict__ var_compute_intermediate, int64_t m, int64_t n) {
  ...
  float in_thread_T_softmax_n_1_to_2048__m_1025_to_2048__maxelem_shared[1];
  __shared__ float red_result[1];
  __shared__ float T_softmax_n_1_to_2048__m_1025_to_2048__maxelem_shared[1];
  float in_thread_T_softmax_n_1_to_2048__m_1025_to_2048__expsum_shared[1];
  __shared__ float red_result_1[1];
  __shared__ float T_softmax_n_1_to_2048__m_1025_to_2048__expsum_shared[1];
  ...
  in_thread_T_softmax_n_1_to_2048__m_1025_to_2048__maxelem_shared[0] = -3.402823e+38f;
  __syncthreads();
  for (int64_t ax2_fused_0 = 0; ax2_fused_0 < ((m + (int64_t)127) >> (int64_t)7); ++ax2_fused_0) {
    if (((ax2_fused_0 * (int64_t)128) + ((int64_t)threadIdx.x)) < m) {
      in_thread_T_softmax_n_1_to_2048__m_1025_to_2048__maxelem_shared[0] = max(in_thread_T_softmax_n_1_to_2048__m_1025_to_2048__maxelem_shared[0], lv38_shared_dyn[((ax2_fused_0 * (int64_t)128) + ((int64_t)threadIdx.x))]);
    }
  }
  float red_buf0[1];
  uint mask[1];
  ...
  float t0_1[1];
  __shared__ float red_buf_staging[4];
  red_buf0_1[0] = in_thread_T_softmax_n_1_to_2048__m_1025_to_2048__maxelem_shared[0];
  mask_1[0] = __activemask();
  t0_1[0] = __shfl_down_sync(mask_1[0], red_buf0_1[0], 16, 32);
  red_buf0_1[0] = max(red_buf0_1[0], t0_1[0]);
  t0_1[0] = __shfl_down_sync(mask_1[0], red_buf0_1[0], 8, 32);
  ...
  __syncthreads();
  if (((int64_t)threadIdx.x) == (int64_t)0) {
    T_softmax_n_1_to_2048__m_1025_to_2048__maxelem_shared[0] = ((volatile float*)red_result)[0];
  }
  in_thread_T_softmax_n_1_to_2048__m_1025_to_2048__expsum_shared[0] = 0.000000e+00f;
  __syncthreads();
  for (int64_t ax2_fused_0_1 = 0; ax2_fused_0_1 < ((m + (int64_t)127) >> (int64_t)7); ++ax2_fused_0_1) {
    if (((ax2_fused_0_1 * (int64_t)128) + ((int64_t)threadIdx.x)) < m) {
      in_thread_T_softmax_n_1_to_2048__m_1025_to_2048__expsum_shared[0] = (in_thread_T_softmax_n_1_to_2048__m_1025_to_2048__expsum_shared[0] + __expf((lv38_shared_dyn[((ax2_fused_0_1 * (int64_t)128) + ((int64_t)threadIdx.x))] - T_softmax_n_1_to_2048__m_1025_to_2048__maxelem_shared[0])));
    }
  }
  float red_buf0_2[1];
  uint mask_2[1];
  ...
  float t0_3[1];
  __shared__ float red_buf_staging_1[4];
  red_buf0_3[0] = in_thread_T_softmax_n_1_to_2048__m_1025_to_2048__expsum_shared[0];
  mask_3[0] = __activemask();
  t0_3[0] = __shfl_down_sync(mask_3[0], red_buf0_3[0], 16, 32);
  red_buf0_3[0] = (red_buf0_3[0] + t0_3[0]);
  t0_3[0] = __shfl_down_sync(mask_3[0], red_buf0_3[0], 8, 32);
  ...
  __syncthreads();
  if (((int64_t)threadIdx.x) == (int64_t)0) {
    T_softmax_n_1_to_2048__m_1025_to_2048__expsum_shared[0] = ((volatile float*)red_result_1)[0];
  }
  __syncthreads();
  for (int64_t ax2_0 = 0; ax2_0 < ((m + (int64_t)127) >> (int64_t)7); ++ax2_0) {
    if (((ax2_0 * (int64_t)128) + ((int64_t)threadIdx.x)) < m) {
      var_compute_intermediate[(((ax2_0 * (int64_t)128) + (((int64_t)blockIdx.x) * m)) + ((int64_t)threadIdx.x))] = ((half)(__expf((lv38_shared_dyn[((ax2_0 * (int64_t)128) + ((int64_t)threadIdx.x))] - T_softmax_n_1_to_2048__m_1025_to_2048__maxelem_shared[0])) / T_softmax_n_1_to_2048__m_1025_to_2048__expsum_shared[0]));
    }
  }
}
