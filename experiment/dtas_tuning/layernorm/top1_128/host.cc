...
static void* fused_layer_norm_cast1_kernel_packed = NULL;
#ifdef __cplusplus
extern "C"
#endif
...
TVM_DLL int32_t fused_layer_norm_cast1(void* args, int32_t* arg_type_ids, int32_t num_args, void* out_ret_value, int32_t* out_ret_tcode, void* resource_handle) {
  ...
  (((TVMValue*)stack_value)[5].v_int64) = n;
  ((int32_t*)stack_tcode)[5] = 0;
  (((TVMValue*)stack_value)[6].v_int64) = (int64_t)128;
  ((int32_t*)stack_tcode)[6] = 0;
  (((TVMValue*)stack_value)[7].v_int64) = ((int64_t)10240);
  ((int32_t*)stack_tcode)[7] = 0;
  if (fused_layer_norm_cast1_kernel_packed == NULL) {
    if (TVMBackendGetFuncFromEnv(__tvm_module_ctx, "fused_layer_norm_cast1_kernel", &fused_layer_norm_cast1_kernel_packed) != 0) {
      return -1;
    }
  }
  TVMValue ret_val_1;
  int ret_type_code_1;
  if (TVMFuncCall(fused_layer_norm_cast1_kernel_packed, (TVMValue*) stack_value, (int*) stack_tcode, 8, &ret_val_1, &ret_type_code_1) != 0) {
    return -1;
  }
  return 0;
}
