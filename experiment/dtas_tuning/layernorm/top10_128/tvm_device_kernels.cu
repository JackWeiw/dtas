...
#endif
extern "C" __global__ void __launch_bounds__(256) fused_layer_norm_cast1_n_1_to_256__kernel(half* __restrict__ compute_intermediate, float* __restrict__ lv6, float* __restrict__ param_1, float* __restrict__ param_2, int64_t n);
extern "C" __global__ void __launch_bounds__(128) fused_layer_norm_cast1_n_257_to_384__kernel(half* __restrict__ compute_intermediate, float* __restrict__ lv6, float* __restrict__ param_1, float* __restrict__ param_2, int64_t n);
extern "C" __global__ void __launch_bounds__(320) fused_layer_norm_cast1_n_385_to_1280__kernel(half* __restrict__ compute_intermediate, float* __restrict__ lv6, float* __restrict__ param_1, float* __restrict__ param_2, int64_t n);
extern "C" __global__ void __launch_bounds__(512) fused_layer_norm_cast1_n_1281_to_2048__kernel(half* __restrict__ compute_intermediate, float* __restrict__ lv6, float* __restrict__ param_1, float* __restrict__ param_2, int64_t n);
extern "C" __global__ void __launch_bounds__(160) fused_layer_norm_cast1_n_2049_to_2176__kernel(half* __restrict__ compute_intermediate, float* __restrict__ lv6, float* __restrict__ param_1, float* __restrict__ param_2, int64_t n);
extern "C" __global__ void __launch_bounds__(512) fused_layer_norm_cast1_n_2177_to_2304__kernel(half* __restrict__ compute_intermediate, float* __restrict__ lv6, float* __restrict__ param_1, float* __restrict__ param_2, int64_t n);
extern "C" __global__ void __launch_bounds__(320) fused_layer_norm_cast1_n_2305_to_2688__kernel(half* __restrict__ compute_intermediate, float* __restrict__ lv6, float* __restrict__ param_1, float* __restrict__ param_2, int64_t n);
extern "C" __global__ void __launch_bounds__(192) fused_layer_norm_cast1_n_2689_to_2816__kernel(half* __restrict__ compute_intermediate, float* __restrict__ lv6, float* __restrict__ param_1, float* __restrict__ param_2, int64_t n);
extern "C" __global__ void __launch_bounds__(512) fused_layer_norm_cast1_n_2817_to_3584__kernel(half* __restrict__ compute_intermediate, float* __restrict__ lv6, float* __restrict__ param_1, float* __restrict__ param_2, int64_t n);
extern "C" __global__ void __launch_bounds__(192) fused_layer_norm_cast1_n_3585_to_3712__kernel(half* __restrict__ compute_intermediate, float* __restrict__ lv6, float* __restrict__ param_1, float* __restrict__ param_2, int64_t n);
extern "C" __global__ void __launch_bounds__(512) fused_layer_norm_cast1_n_3713_to_4096__kernel(half* __restrict__ compute_intermediate, float* __restrict__ lv6, float* __restrict__ param_1, float* __restrict__ param_2, int64_t n);
extern "C" __global__ void __launch_bounds__(256) fused_layer_norm_cast1_n_1_to_256__kernel(half* __restrict__ compute_intermediate, float* __restrict__ lv6, float* __restrict__ param_1, float* __restrict__ param_2, int64_t n) {
  ...
  for (int64_t ax2_0 = 0; ax2_0 < (int64_t)3; ++ax2_0) {
    if (((ax2_0 * (int64_t)2) + (((int64_t)threadIdx.x) >> (int64_t)7)) < (int64_t)5) {
      *(float4*)(lv6_shared_dyn + ((ax2_0 * (int64_t)1024) + (((int64_t)threadIdx.x) * (int64_t)4))) = *(float4*)(lv6 + (((((int64_t)blockIdx.x) * (int64_t)2560) + (ax2_0 * (int64_t)1024)) + (((int64_t)threadIdx.x) * (int64_t)4)));
    }
  }
  ...
  float v_A_red_temp_v0_1 = (in_thread_A_red_temp_v0_shared[0] + lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)256)]);
  float v_A_red_temp_v1_1 = (in_thread_A_red_temp_v1_shared[0] + (lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)256)] * lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)256)]));
  in_thread_A_red_temp_v0_shared[0] = v_A_red_temp_v0_1;
  in_thread_A_red_temp_v1_shared[0] = v_A_red_temp_v1_1;
  float v_A_red_temp_v0_2 = (in_thread_A_red_temp_v0_shared[0] + lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)512)]);
  float v_A_red_temp_v1_2 = (in_thread_A_red_temp_v1_shared[0] + (lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)512)] * lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)512)]));
  in_thread_A_red_temp_v0_shared[0] = v_A_red_temp_v0_2;
  in_thread_A_red_temp_v1_shared[0] = v_A_red_temp_v1_2;
  float v_A_red_temp_v0_3 = (in_thread_A_red_temp_v0_shared[0] + lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)768)]);
  float v_A_red_temp_v1_3 = (in_thread_A_red_temp_v1_shared[0] + (lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)768)] * lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)768)]));
  in_thread_A_red_temp_v0_shared[0] = v_A_red_temp_v0_3;
  in_thread_A_red_temp_v1_shared[0] = v_A_red_temp_v1_3;
  float v_A_red_temp_v0_4 = (in_thread_A_red_temp_v0_shared[0] + lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)1024)]);
  float v_A_red_temp_v1_4 = (in_thread_A_red_temp_v1_shared[0] + (lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)1024)] * lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)1024)]));
  in_thread_A_red_temp_v0_shared[0] = v_A_red_temp_v0_4;
  in_thread_A_red_temp_v1_shared[0] = v_A_red_temp_v1_4;
  float v_A_red_temp_v0_5 = (in_thread_A_red_temp_v0_shared[0] + lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)1280)]);
  float v_A_red_temp_v1_5 = (in_thread_A_red_temp_v1_shared[0] + (lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)1280)] * lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)1280)]));
  in_thread_A_red_temp_v0_shared[0] = v_A_red_temp_v0_5;
  in_thread_A_red_temp_v1_shared[0] = v_A_red_temp_v1_5;
  float v_A_red_temp_v0_6 = (in_thread_A_red_temp_v0_shared[0] + lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)1536)]);
  float v_A_red_temp_v1_6 = (in_thread_A_red_temp_v1_shared[0] + (lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)1536)] * lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)1536)]));
  in_thread_A_red_temp_v0_shared[0] = v_A_red_temp_v0_6;
  in_thread_A_red_temp_v1_shared[0] = v_A_red_temp_v1_6;
  float v_A_red_temp_v0_7 = (in_thread_A_red_temp_v0_shared[0] + lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)1792)]);
  float v_A_red_temp_v1_7 = (in_thread_A_red_temp_v1_shared[0] + (lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)1792)] * lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)1792)]));
  in_thread_A_red_temp_v0_shared[0] = v_A_red_temp_v0_7;
  in_thread_A_red_temp_v1_shared[0] = v_A_red_temp_v1_7;
  float v_A_red_temp_v0_8 = (in_thread_A_red_temp_v0_shared[0] + lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)2048)]);
  float v_A_red_temp_v1_8 = (in_thread_A_red_temp_v1_shared[0] + (lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)2048)] * lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)2048)]));
  in_thread_A_red_temp_v0_shared[0] = v_A_red_temp_v0_8;
  in_thread_A_red_temp_v1_shared[0] = v_A_red_temp_v1_8;
  float v_A_red_temp_v0_9 = (in_thread_A_red_temp_v0_shared[0] + lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)2304)]);
  float v_A_red_temp_v1_9 = (in_thread_A_red_temp_v1_shared[0] + (lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)2304)] * lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)2304)]));
...
extern "C" __global__ void __launch_bounds__(128) fused_layer_norm_cast1_n_257_to_384__kernel(half* __restrict__ compute_intermediate, float* __restrict__ lv6, float* __restrict__ param_1, float* __restrict__ param_2, int64_t n) {
  ...
  for (int64_t ax2_0 = 0; ax2_0 < (int64_t)5; ++ax2_0) {
    *(float4*)(lv6_shared_dyn + ((ax2_0 * (int64_t)512) + (((int64_t)threadIdx.x) * (int64_t)4))) = *(float4*)(lv6 + (((((int64_t)blockIdx.x) * (int64_t)2560) + (ax2_0 * (int64_t)512)) + (((int64_t)threadIdx.x) * (int64_t)4)));
  }
  in_thread_A_red_temp_v0_shared[0] = 0.000000e+00f;
  in_thread_A_red_temp_v1_shared[0] = 0.000000e+00f;
  __syncthreads();
...
extern "C" __global__ void __launch_bounds__(320) fused_layer_norm_cast1_n_385_to_1280__kernel(half* __restrict__ compute_intermediate, float* __restrict__ lv6, float* __restrict__ param_1, float* __restrict__ param_2, int64_t n) {
  ...
  for (int64_t ax2_0 = 0; ax2_0 < (int64_t)2; ++ax2_0) {
    *(float4*)(lv6_shared_dyn + ((ax2_0 * (int64_t)1280) + (((int64_t)threadIdx.x) * (int64_t)4))) = *(float4*)(lv6 + (((((int64_t)blockIdx.x) * (int64_t)2560) + (ax2_0 * (int64_t)1280)) + (((int64_t)threadIdx.x) * (int64_t)4)));
  }
  in_thread_A_red_temp_v0_shared[0] = 0.000000e+00f;
  in_thread_A_red_temp_v1_shared[0] = 0.000000e+00f;
  __syncthreads();
...
extern "C" __global__ void __launch_bounds__(512) fused_layer_norm_cast1_n_1281_to_2048__kernel(half* __restrict__ compute_intermediate, float* __restrict__ lv6, float* __restrict__ param_1, float* __restrict__ param_2, int64_t n) {
  ...
  for (int64_t ax2_0 = 0; ax2_0 < (int64_t)2; ++ax2_0) {
    if (((ax2_0 * (int64_t)4) + (((int64_t)threadIdx.x) >> (int64_t)7)) < (int64_t)5) {
      *(float4*)(lv6_shared_dyn + ((ax2_0 * (int64_t)2048) + (((int64_t)threadIdx.x) * (int64_t)4))) = *(float4*)(lv6 + (((((int64_t)blockIdx.x) * (int64_t)2560) + (ax2_0 * (int64_t)2048)) + (((int64_t)threadIdx.x) * (int64_t)4)));
    }
  }
  in_thread_A_red_temp_v0_shared[0] = 0.000000e+00f;
  in_thread_A_red_temp_v1_shared[0] = 0.000000e+00f;
...
extern "C" __global__ void __launch_bounds__(160) fused_layer_norm_cast1_n_2049_to_2176__kernel(half* __restrict__ compute_intermediate, float* __restrict__ lv6, float* __restrict__ param_1, float* __restrict__ param_2, int64_t n) {
  ...
  for (int64_t ax2_0 = 0; ax2_0 < (int64_t)4; ++ax2_0) {
    *(float4*)(lv6_shared_dyn + ((ax2_0 * (int64_t)640) + (((int64_t)threadIdx.x) * (int64_t)4))) = *(float4*)(lv6 + (((((int64_t)blockIdx.x) * (int64_t)2560) + (ax2_0 * (int64_t)640)) + (((int64_t)threadIdx.x) * (int64_t)4)));
  }
  in_thread_A_red_temp_v0_shared[0] = 0.000000e+00f;
  in_thread_A_red_temp_v1_shared[0] = 0.000000e+00f;
  __syncthreads();
  ...
  in_thread_A_red_temp_v0_shared[0] = v_A_red_temp_v0;
  in_thread_A_red_temp_v1_shared[0] = v_A_red_temp_v1;
  float v_A_red_temp_v0_1 = (in_thread_A_red_temp_v0_shared[0] + lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)160)]);
  float v_A_red_temp_v1_1 = (in_thread_A_red_temp_v1_shared[0] + (lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)160)] * lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)160)]));
  in_thread_A_red_temp_v0_shared[0] = v_A_red_temp_v0_1;
  in_thread_A_red_temp_v1_shared[0] = v_A_red_temp_v1_1;
  float v_A_red_temp_v0_2 = (in_thread_A_red_temp_v0_shared[0] + lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)320)]);
  float v_A_red_temp_v1_2 = (in_thread_A_red_temp_v1_shared[0] + (lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)320)] * lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)320)]));
  in_thread_A_red_temp_v0_shared[0] = v_A_red_temp_v0_2;
  in_thread_A_red_temp_v1_shared[0] = v_A_red_temp_v1_2;
  float v_A_red_temp_v0_3 = (in_thread_A_red_temp_v0_shared[0] + lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)480)]);
  float v_A_red_temp_v1_3 = (in_thread_A_red_temp_v1_shared[0] + (lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)480)] * lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)480)]));
  in_thread_A_red_temp_v0_shared[0] = v_A_red_temp_v0_3;
  in_thread_A_red_temp_v1_shared[0] = v_A_red_temp_v1_3;
  float v_A_red_temp_v0_4 = (in_thread_A_red_temp_v0_shared[0] + lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)640)]);
  float v_A_red_temp_v1_4 = (in_thread_A_red_temp_v1_shared[0] + (lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)640)] * lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)640)]));
  in_thread_A_red_temp_v0_shared[0] = v_A_red_temp_v0_4;
  in_thread_A_red_temp_v1_shared[0] = v_A_red_temp_v1_4;
  float v_A_red_temp_v0_5 = (in_thread_A_red_temp_v0_shared[0] + lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)800)]);
  float v_A_red_temp_v1_5 = (in_thread_A_red_temp_v1_shared[0] + (lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)800)] * lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)800)]));
  in_thread_A_red_temp_v0_shared[0] = v_A_red_temp_v0_5;
  in_thread_A_red_temp_v1_shared[0] = v_A_red_temp_v1_5;
  float v_A_red_temp_v0_6 = (in_thread_A_red_temp_v0_shared[0] + lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)960)]);
  float v_A_red_temp_v1_6 = (in_thread_A_red_temp_v1_shared[0] + (lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)960)] * lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)960)]));
  in_thread_A_red_temp_v0_shared[0] = v_A_red_temp_v0_6;
  in_thread_A_red_temp_v1_shared[0] = v_A_red_temp_v1_6;
  float v_A_red_temp_v0_7 = (in_thread_A_red_temp_v0_shared[0] + lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)1120)]);
  float v_A_red_temp_v1_7 = (in_thread_A_red_temp_v1_shared[0] + (lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)1120)] * lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)1120)]));
  in_thread_A_red_temp_v0_shared[0] = v_A_red_temp_v0_7;
  in_thread_A_red_temp_v1_shared[0] = v_A_red_temp_v1_7;
  float v_A_red_temp_v0_8 = (in_thread_A_red_temp_v0_shared[0] + lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)1280)]);
  float v_A_red_temp_v1_8 = (in_thread_A_red_temp_v1_shared[0] + (lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)1280)] * lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)1280)]));
  in_thread_A_red_temp_v0_shared[0] = v_A_red_temp_v0_8;
  in_thread_A_red_temp_v1_shared[0] = v_A_red_temp_v1_8;
  float v_A_red_temp_v0_9 = (in_thread_A_red_temp_v0_shared[0] + lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)1440)]);
  float v_A_red_temp_v1_9 = (in_thread_A_red_temp_v1_shared[0] + (lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)1440)] * lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)1440)]));
  in_thread_A_red_temp_v0_shared[0] = v_A_red_temp_v0_9;
  in_thread_A_red_temp_v1_shared[0] = v_A_red_temp_v1_9;
  float v_A_red_temp_v0_10 = (in_thread_A_red_temp_v0_shared[0] + lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)1600)]);
  float v_A_red_temp_v1_10 = (in_thread_A_red_temp_v1_shared[0] + (lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)1600)] * lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)1600)]));
  in_thread_A_red_temp_v0_shared[0] = v_A_red_temp_v0_10;
  in_thread_A_red_temp_v1_shared[0] = v_A_red_temp_v1_10;
  float v_A_red_temp_v0_11 = (in_thread_A_red_temp_v0_shared[0] + lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)1760)]);
  float v_A_red_temp_v1_11 = (in_thread_A_red_temp_v1_shared[0] + (lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)1760)] * lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)1760)]));
  in_thread_A_red_temp_v0_shared[0] = v_A_red_temp_v0_11;
  in_thread_A_red_temp_v1_shared[0] = v_A_red_temp_v1_11;
  float v_A_red_temp_v0_12 = (in_thread_A_red_temp_v0_shared[0] + lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)1920)]);
  float v_A_red_temp_v1_12 = (in_thread_A_red_temp_v1_shared[0] + (lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)1920)] * lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)1920)]));
  in_thread_A_red_temp_v0_shared[0] = v_A_red_temp_v0_12;
  in_thread_A_red_temp_v1_shared[0] = v_A_red_temp_v1_12;
  float v_A_red_temp_v0_13 = (in_thread_A_red_temp_v0_shared[0] + lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)2080)]);
  float v_A_red_temp_v1_13 = (in_thread_A_red_temp_v1_shared[0] + (lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)2080)] * lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)2080)]));
  in_thread_A_red_temp_v0_shared[0] = v_A_red_temp_v0_13;
  in_thread_A_red_temp_v1_shared[0] = v_A_red_temp_v1_13;
  float v_A_red_temp_v0_14 = (in_thread_A_red_temp_v0_shared[0] + lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)2240)]);
  float v_A_red_temp_v1_14 = (in_thread_A_red_temp_v1_shared[0] + (lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)2240)] * lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)2240)]));
  in_thread_A_red_temp_v0_shared[0] = v_A_red_temp_v0_14;
  in_thread_A_red_temp_v1_shared[0] = v_A_red_temp_v1_14;
  float v_A_red_temp_v0_15 = (in_thread_A_red_temp_v0_shared[0] + lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)2400)]);
  float v_A_red_temp_v1_15 = (in_thread_A_red_temp_v1_shared[0] + (lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)2400)] * lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)2400)]));
  in_thread_A_red_temp_v0_shared[0] = v_A_red_temp_v0_15;
  in_thread_A_red_temp_v1_shared[0] = v_A_red_temp_v1_15;
  float red_buf1[1];
  float red_buf0[1];
  ...
  __syncthreads();
  compute_intermediate[((((int64_t)blockIdx.x) * (int64_t)2560) + ((int64_t)threadIdx.x))] = ((half)((((lv6_shared_dyn[((int64_t)threadIdx.x)] - (A_red_temp_v0_shared[0] * 3.906250e-04f)) * (1.000000e+00f / sqrtf((((A_red_temp_v1_shared[0] * 3.906250e-04f) - ((A_red_temp_v0_shared[0] * 3.906250e-04f) * (A_red_temp_v0_shared[0] * 3.906250e-04f))) + 1.000000e-05f)))) * param_1[((int64_t)threadIdx.x)]) + param_2[((int64_t)threadIdx.x)]));
  compute_intermediate[(((((int64_t)blockIdx.x) * (int64_t)2560) + ((int64_t)threadIdx.x)) + (int64_t)160)] = ((half)((((lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)160)] - (A_red_temp_v0_shared[0] * 3.906250e-04f)) * (1.000000e+00f / sqrtf((((A_red_temp_v1_shared[0] * 3.906250e-04f) - ((A_red_temp_v0_shared[0] * 3.906250e-04f) * (A_red_temp_v0_shared[0] * 3.906250e-04f))) + 1.000000e-05f)))) * param_1[(((int64_t)threadIdx.x) + (int64_t)160)]) + param_2[(((int64_t)threadIdx.x) + (int64_t)160)]));
  compute_intermediate[(((((int64_t)blockIdx.x) * (int64_t)2560) + ((int64_t)threadIdx.x)) + (int64_t)320)] = ((half)((((lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)320)] - (A_red_temp_v0_shared[0] * 3.906250e-04f)) * (1.000000e+00f / sqrtf((((A_red_temp_v1_shared[0] * 3.906250e-04f) - ((A_red_temp_v0_shared[0] * 3.906250e-04f) * (A_red_temp_v0_shared[0] * 3.906250e-04f))) + 1.000000e-05f)))) * param_1[(((int64_t)threadIdx.x) + (int64_t)320)]) + param_2[(((int64_t)threadIdx.x) + (int64_t)320)]));
  compute_intermediate[(((((int64_t)blockIdx.x) * (int64_t)2560) + ((int64_t)threadIdx.x)) + (int64_t)480)] = ((half)((((lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)480)] - (A_red_temp_v0_shared[0] * 3.906250e-04f)) * (1.000000e+00f / sqrtf((((A_red_temp_v1_shared[0] * 3.906250e-04f) - ((A_red_temp_v0_shared[0] * 3.906250e-04f) * (A_red_temp_v0_shared[0] * 3.906250e-04f))) + 1.000000e-05f)))) * param_1[(((int64_t)threadIdx.x) + (int64_t)480)]) + param_2[(((int64_t)threadIdx.x) + (int64_t)480)]));
  compute_intermediate[(((((int64_t)blockIdx.x) * (int64_t)2560) + ((int64_t)threadIdx.x)) + (int64_t)640)] = ((half)((((lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)640)] - (A_red_temp_v0_shared[0] * 3.906250e-04f)) * (1.000000e+00f / sqrtf((((A_red_temp_v1_shared[0] * 3.906250e-04f) - ((A_red_temp_v0_shared[0] * 3.906250e-04f) * (A_red_temp_v0_shared[0] * 3.906250e-04f))) + 1.000000e-05f)))) * param_1[(((int64_t)threadIdx.x) + (int64_t)640)]) + param_2[(((int64_t)threadIdx.x) + (int64_t)640)]));
  compute_intermediate[(((((int64_t)blockIdx.x) * (int64_t)2560) + ((int64_t)threadIdx.x)) + (int64_t)800)] = ((half)((((lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)800)] - (A_red_temp_v0_shared[0] * 3.906250e-04f)) * (1.000000e+00f / sqrtf((((A_red_temp_v1_shared[0] * 3.906250e-04f) - ((A_red_temp_v0_shared[0] * 3.906250e-04f) * (A_red_temp_v0_shared[0] * 3.906250e-04f))) + 1.000000e-05f)))) * param_1[(((int64_t)threadIdx.x) + (int64_t)800)]) + param_2[(((int64_t)threadIdx.x) + (int64_t)800)]));
  compute_intermediate[(((((int64_t)blockIdx.x) * (int64_t)2560) + ((int64_t)threadIdx.x)) + (int64_t)960)] = ((half)((((lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)960)] - (A_red_temp_v0_shared[0] * 3.906250e-04f)) * (1.000000e+00f / sqrtf((((A_red_temp_v1_shared[0] * 3.906250e-04f) - ((A_red_temp_v0_shared[0] * 3.906250e-04f) * (A_red_temp_v0_shared[0] * 3.906250e-04f))) + 1.000000e-05f)))) * param_1[(((int64_t)threadIdx.x) + (int64_t)960)]) + param_2[(((int64_t)threadIdx.x) + (int64_t)960)]));
  compute_intermediate[(((((int64_t)blockIdx.x) * (int64_t)2560) + ((int64_t)threadIdx.x)) + (int64_t)1120)] = ((half)((((lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)1120)] - (A_red_temp_v0_shared[0] * 3.906250e-04f)) * (1.000000e+00f / sqrtf((((A_red_temp_v1_shared[0] * 3.906250e-04f) - ((A_red_temp_v0_shared[0] * 3.906250e-04f) * (A_red_temp_v0_shared[0] * 3.906250e-04f))) + 1.000000e-05f)))) * param_1[(((int64_t)threadIdx.x) + (int64_t)1120)]) + param_2[(((int64_t)threadIdx.x) + (int64_t)1120)]));
  compute_intermediate[(((((int64_t)blockIdx.x) * (int64_t)2560) + ((int64_t)threadIdx.x)) + (int64_t)1280)] = ((half)((((lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)1280)] - (A_red_temp_v0_shared[0] * 3.906250e-04f)) * (1.000000e+00f / sqrtf((((A_red_temp_v1_shared[0] * 3.906250e-04f) - ((A_red_temp_v0_shared[0] * 3.906250e-04f) * (A_red_temp_v0_shared[0] * 3.906250e-04f))) + 1.000000e-05f)))) * param_1[(((int64_t)threadIdx.x) + (int64_t)1280)]) + param_2[(((int64_t)threadIdx.x) + (int64_t)1280)]));
  compute_intermediate[(((((int64_t)blockIdx.x) * (int64_t)2560) + ((int64_t)threadIdx.x)) + (int64_t)1440)] = ((half)((((lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)1440)] - (A_red_temp_v0_shared[0] * 3.906250e-04f)) * (1.000000e+00f / sqrtf((((A_red_temp_v1_shared[0] * 3.906250e-04f) - ((A_red_temp_v0_shared[0] * 3.906250e-04f) * (A_red_temp_v0_shared[0] * 3.906250e-04f))) + 1.000000e-05f)))) * param_1[(((int64_t)threadIdx.x) + (int64_t)1440)]) + param_2[(((int64_t)threadIdx.x) + (int64_t)1440)]));
  compute_intermediate[(((((int64_t)blockIdx.x) * (int64_t)2560) + ((int64_t)threadIdx.x)) + (int64_t)1600)] = ((half)((((lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)1600)] - (A_red_temp_v0_shared[0] * 3.906250e-04f)) * (1.000000e+00f / sqrtf((((A_red_temp_v1_shared[0] * 3.906250e-04f) - ((A_red_temp_v0_shared[0] * 3.906250e-04f) * (A_red_temp_v0_shared[0] * 3.906250e-04f))) + 1.000000e-05f)))) * param_1[(((int64_t)threadIdx.x) + (int64_t)1600)]) + param_2[(((int64_t)threadIdx.x) + (int64_t)1600)]));
  compute_intermediate[(((((int64_t)blockIdx.x) * (int64_t)2560) + ((int64_t)threadIdx.x)) + (int64_t)1760)] = ((half)((((lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)1760)] - (A_red_temp_v0_shared[0] * 3.906250e-04f)) * (1.000000e+00f / sqrtf((((A_red_temp_v1_shared[0] * 3.906250e-04f) - ((A_red_temp_v0_shared[0] * 3.906250e-04f) * (A_red_temp_v0_shared[0] * 3.906250e-04f))) + 1.000000e-05f)))) * param_1[(((int64_t)threadIdx.x) + (int64_t)1760)]) + param_2[(((int64_t)threadIdx.x) + (int64_t)1760)]));
  compute_intermediate[(((((int64_t)blockIdx.x) * (int64_t)2560) + ((int64_t)threadIdx.x)) + (int64_t)1920)] = ((half)((((lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)1920)] - (A_red_temp_v0_shared[0] * 3.906250e-04f)) * (1.000000e+00f / sqrtf((((A_red_temp_v1_shared[0] * 3.906250e-04f) - ((A_red_temp_v0_shared[0] * 3.906250e-04f) * (A_red_temp_v0_shared[0] * 3.906250e-04f))) + 1.000000e-05f)))) * param_1[(((int64_t)threadIdx.x) + (int64_t)1920)]) + param_2[(((int64_t)threadIdx.x) + (int64_t)1920)]));
  compute_intermediate[(((((int64_t)blockIdx.x) * (int64_t)2560) + ((int64_t)threadIdx.x)) + (int64_t)2080)] = ((half)((((lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)2080)] - (A_red_temp_v0_shared[0] * 3.906250e-04f)) * (1.000000e+00f / sqrtf((((A_red_temp_v1_shared[0] * 3.906250e-04f) - ((A_red_temp_v0_shared[0] * 3.906250e-04f) * (A_red_temp_v0_shared[0] * 3.906250e-04f))) + 1.000000e-05f)))) * param_1[(((int64_t)threadIdx.x) + (int64_t)2080)]) + param_2[(((int64_t)threadIdx.x) + (int64_t)2080)]));
  compute_intermediate[(((((int64_t)blockIdx.x) * (int64_t)2560) + ((int64_t)threadIdx.x)) + (int64_t)2240)] = ((half)((((lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)2240)] - (A_red_temp_v0_shared[0] * 3.906250e-04f)) * (1.000000e+00f / sqrtf((((A_red_temp_v1_shared[0] * 3.906250e-04f) - ((A_red_temp_v0_shared[0] * 3.906250e-04f) * (A_red_temp_v0_shared[0] * 3.906250e-04f))) + 1.000000e-05f)))) * param_1[(((int64_t)threadIdx.x) + (int64_t)2240)]) + param_2[(((int64_t)threadIdx.x) + (int64_t)2240)]));
  compute_intermediate[(((((int64_t)blockIdx.x) * (int64_t)2560) + ((int64_t)threadIdx.x)) + (int64_t)2400)] = ((half)((((lv6_shared_dyn[(((int64_t)threadIdx.x) + (int64_t)2400)] - (A_red_temp_v0_shared[0] * 3.906250e-04f)) * (1.000000e+00f / sqrtf((((A_red_temp_v1_shared[0] * 3.906250e-04f) - ((A_red_temp_v0_shared[0] * 3.906250e-04f) * (A_red_temp_v0_shared[0] * 3.906250e-04f))) + 1.000000e-05f)))) * param_1[(((int64_t)threadIdx.x) + (int64_t)2400)]) + param_2[(((int64_t)threadIdx.x) + (int64_t)2400)]));
}
...
extern "C" __global__ void __launch_bounds__(192) fused_layer_norm_cast1_n_2689_to_2816__kernel(half* __restrict__ compute_intermediate, float* __restrict__ lv6, float* __restrict__ param_1, float* __restrict__ param_2, int64_t n) {
  ...
  for (int64_t ax2_0 = 0; ax2_0 < (int64_t)4; ++ax2_0) {
    if (((ax2_0 * (int64_t)3) + (((int64_t)threadIdx.x) >> (int64_t)6)) < (int64_t)10) {
      *(float4*)(lv6_shared_dyn + ((ax2_0 * (int64_t)768) + (((int64_t)threadIdx.x) * (int64_t)4))) = *(float4*)(lv6 + (((((int64_t)blockIdx.x) * (int64_t)2560) + (ax2_0 * (int64_t)768)) + (((int64_t)threadIdx.x) * (int64_t)4)));
    }
  }
  in_thread_A_red_temp_v0_shared[0] = 0.000000e+00f;
  in_thread_A_red_temp_v1_shared[0] = 0.000000e+00f;
