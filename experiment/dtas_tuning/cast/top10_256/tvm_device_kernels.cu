...
extern "C" __global__ void __launch_bounds__(256) cast_n_2305_to_2560__kernel(half* __restrict__ A, float* __restrict__ compute, int64_t n) {
  for (int64_t ax0_ax1_fused_1 = 0; ax0_ax1_fused_1 < (((n + (int64_t)2559) / (int64_t)2560) + (((n + (int64_t)2559) % (int64_t)2560) >> (int64_t)63)); ++ax0_ax1_fused_1) {
    if ((((((((int64_t)blockIdx.x) * (((n + (int64_t)2559) / (int64_t)2560) + (((n + (int64_t)2559) % (int64_t)2560) >> (int64_t)63))) * (int64_t)256) + (ax0_ax1_fused_1 * (int64_t)256)) + ((int64_t)threadIdx.x)) - (n * (int64_t)640)) < (int64_t)0) {
      float4 __1;
      uint2 v_ = *(uint2*)(A + (((ax0_ax1_fused_1 * (int64_t)1024) + ((((int64_t)blockIdx.x) * (((n + (int64_t)2559) / (int64_t)2560) + (((n + (int64_t)2559) % (int64_t)2560) >> (int64_t)63))) * (int64_t)1024)) + (((int64_t)threadIdx.x) * (int64_t)4)));
      __1.x = (float)(((half2*)(&(v_.x)))->x);
      __1.y = (float)(((half2*)(&(v_.x)))->y);
      __1.z = (float)(((half2*)(&(v_.y)))->x);
      __1.w = (float)(((half2*)(&(v_.y)))->y);
      *(float4*)(compute + (((ax0_ax1_fused_1 * (int64_t)1024) + ((((int64_t)blockIdx.x) * (((n + (int64_t)2559) / (int64_t)2560) + (((n + (int64_t)2559) % (int64_t)2560) >> (int64_t)63))) * (int64_t)1024)) + (((int64_t)threadIdx.x) * (int64_t)4))) = __1;
    }
  }
}
