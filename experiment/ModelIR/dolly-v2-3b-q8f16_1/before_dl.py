...
class Module:
    ...
    def fused_NT_matmul2_add1_add3_add3(lv1813: T.Buffer((T.int64(1), T.int64(1), T.int64(2560)), "float16"), lv2: T.Buffer((T.int64(2560), T.int64(2560)), "float16"), param_11: T.Buffer((T.int64(2560),), "float16"), lv1828: T.Buffer((T.int64(1), T.int64(1), T.int64(2560)), "float16"), lv1774: T.Buffer((T.int64(1), T.int64(1), T.int64(2560)), "float16"), T_add_intermediate_1_2: T.Buffer((T.int64(1), T.int64(1), T.int64(2560)), "float16")):
        ...
        for i0, i1, i2, k in T.grid(T.int64(1), T.int64(1), T.int64(2560), T.int64(2560)):
            with T.block("NT_matmul"):
                ...
                T.reads(lv1813[v_i0, v_i1, v_k], lv2[v_i2, v_k])
                T.writes(NT_matmul_intermediate[v_i0, v_i1, v_i2])
                with T.init():
                    NT_matmul_intermediate[v_i0, v_i1, v_i2] = T.float16(0)
                NT_matmul_intermediate[v_i0, v_i1, v_i2] = NT_matmul_intermediate[v_i0, v_i1, v_i2] + lv1813[v_i0, v_i1, v_k] * lv2[v_i2, v_k]
        for ax0, ax1, ax2 in T.grid(T.int64(1), T.int64(1), T.int64(2560)):
            with T.block("T_add"):
                v_ax0, v_ax1, v_ax2 = T.axis.remap("SSS", [ax0, ax1, ax2])
                T.reads(NT_matmul_intermediate[v_ax0, v_ax1, v_ax2], param_11[v_ax2])
                T.writes(T_add_intermediate[v_ax0, v_ax1, v_ax2])
                T_add_intermediate[v_ax0, v_ax1, v_ax2] = NT_matmul_intermediate[v_ax0, v_ax1, v_ax2] + param_11[v_ax2]
        for ax0, ax1, ax2 in T.grid(T.int64(1), T.int64(1), T.int64(2560)):
    ...
    def fused_NT_matmul2_add1_add3_add3_cast(lv3518: T.Buffer((T.int64(1), T.int64(1), T.int64(2560)), "float16"), lv126: T.Buffer((T.int64(2560), T.int64(2560)), "float16"), param_507: T.Buffer((T.int64(2560),), "float16"), lv3533: T.Buffer((T.int64(1), T.int64(1), T.int64(2560)), "float16"), lv3480: T.Buffer((T.int64(1), T.int64(1), T.int64(2560)), "float16"), compute_intermediate: T.Buffer((T.int64(1), T.int64(1), T.int64(2560)), "float32")):
        ...
        for i0, i1, i2, k in T.grid(T.int64(1), T.int64(1), T.int64(2560), T.int64(2560)):
            with T.block("NT_matmul"):
                v_i0, v_i1, v_i2, v_k = T.axis.remap("SSSR", [i0, i1, i2, k])
                T.reads(lv3518[v_i0, v_i1, v_k], lv126[v_i2, v_k])
                T.writes(NT_matmul_intermediate[v_i0, v_i1, v_i2])
                with T.init():
                    NT_matmul_intermediate[v_i0, v_i1, v_i2] = T.float16(0)
                NT_matmul_intermediate[v_i0, v_i1, v_i2] = NT_matmul_intermediate[v_i0, v_i1, v_i2] + lv3518[v_i0, v_i1, v_k] * lv126[v_i2, v_k]
        for ax0, ax1, ax2 in T.grid(T.int64(1), T.int64(1), T.int64(2560)):
            with T.block("T_add"):
                v_ax0, v_ax1, v_ax2 = T.axis.remap("SSS", [ax0, ax1, ax2])
                T.reads(NT_matmul_intermediate[v_ax0, v_ax1, v_ax2], param_507[v_ax2])
                T.writes(T_add_intermediate[v_ax0, v_ax1, v_ax2])
                T_add_intermediate[v_ax0, v_ax1, v_ax2] = NT_matmul_intermediate[v_ax0, v_ax1, v_ax2] + param_507[v_ax2]
        for ax0, ax1, ax2 in T.grid(T.int64(1), T.int64(1), T.int64(2560)):
            with T.block("T_add_1"):
                v_ax0, v_ax1, v_ax2 = T.axis.remap("SSS", [ax0, ax1, ax2])
    ...
    def fused_NT_matmul8_add5_add7_add7(p_lv43: T.handle, lv132: T.Buffer((T.int64(2560), T.int64(2560)), "float16"), param_1110: T.Buffer((T.int64(2560),), "float16"), p_lv58: T.handle, p_lv2: T.handle, p_output0: T.handle):
        ...
        for i0, i1, i2, k in T.grid(T.int64(1), n, T.int64(2560), T.int64(2560)):
            with T.block("NT_matmul"):
                v_i0, v_i1, v_i2, v_k = T.axis.remap("SSSR", [i0, i1, i2, k])
                T.reads(lv43[v_i0, v_i1, v_k], lv132[v_i2, v_k])
                T.writes(NT_matmul_intermediate[v_i0, v_i1, v_i2])
                with T.init():
                    NT_matmul_intermediate[v_i0, v_i1, v_i2] = T.float16(0)
                NT_matmul_intermediate[v_i0, v_i1, v_i2] = NT_matmul_intermediate[v_i0, v_i1, v_i2] + lv43[v_i0, v_i1, v_k] * lv132[v_i2, v_k]
        for ax0, ax1, ax2 in T.grid(T.int64(1), n, T.int64(2560)):
            with T.block("T_add"):
                v_ax0, v_ax1, v_ax2 = T.axis.remap("SSS", [ax0, ax1, ax2])
                T.reads(NT_matmul_intermediate[v_ax0, v_ax1, v_ax2], param_1110[v_ax2])
                T.writes(T_add_intermediate[v_ax0, v_ax1, v_ax2])
                T_add_intermediate[v_ax0, v_ax1, v_ax2] = NT_matmul_intermediate[v_ax0, v_ax1, v_ax2] + param_1110[v_ax2]
        for ax0, ax1, ax2 in T.grid(T.int64(1), n, T.int64(2560)):
            with T.block("T_add_1"):
                v_ax0, v_ax1, v_ax2 = T.axis.remap("SSS", [ax0, ax1, ax2])
    ...
    def fused_NT_matmul8_add5_add7_add7_cast5(p_lv1748: T.handle, lv256: T.Buffer((T.int64(2560), T.int64(2560)), "float16"), param_5071: T.Buffer((T.int64(2560),), "float16"), p_lv1763: T.handle, p_lv1710: T.handle, p_output0: T.handle):
        ...
        for i0, i1, i2, k in T.grid(T.int64(1), n, T.int64(2560), T.int64(2560)):
            with T.block("NT_matmul"):
                v_i0, v_i1, v_i2, v_k = T.axis.remap("SSSR", [i0, i1, i2, k])
                T.reads(lv1748[v_i0, v_i1, v_k], lv256[v_i2, v_k])
                T.writes(NT_matmul_intermediate[v_i0, v_i1, v_i2])
                with T.init():
                    NT_matmul_intermediate[v_i0, v_i1, v_i2] = T.float16(0)
                NT_matmul_intermediate[v_i0, v_i1, v_i2] = NT_matmul_intermediate[v_i0, v_i1, v_i2] + lv1748[v_i0, v_i1, v_k] * lv256[v_i2, v_k]
        for ax0, ax1, ax2 in T.grid(T.int64(1), n, T.int64(2560)):
            with T.block("T_add"):
                v_ax0, v_ax1, v_ax2 = T.axis.remap("SSS", [ax0, ax1, ax2])
                T.reads(NT_matmul_intermediate[v_ax0, v_ax1, v_ax2], param_5071[v_ax2])
                T.writes(T_add_intermediate[v_ax0, v_ax1, v_ax2])
                T_add_intermediate[v_ax0, v_ax1, v_ax2] = NT_matmul_intermediate[v_ax0, v_ax1, v_ax2] + param_5071[v_ax2]
        for ax0, ax1, ax2 in T.grid(T.int64(1), n, T.int64(2560)):
            with T.block("T_add_1"):
                v_ax0, v_ax1, v_ax2 = T.axis.remap("SSS", [ax0, ax1, ax2])
    ...
    def fused_decode3(model_params_9: T.Buffer((T.int64(2560), T.int64(640)), "uint32"), model_params_10: T.Buffer((T.int64(2560), T.int64(80)), "float16"), decode_intermediate: T.Buffer((T.int64(2560), T.int64(2560)), "float16")):
        ...
        for i, j in T.grid(T.int64(2560), T.int64(2560)):
            with T.block("decode"):
                ...
                T.reads(model_params_9[v_i, v_j // T.int64(4)], model_params_10[v_i, v_j // T.int64(32)])
                T.writes(decode_intermediate[v_i, v_j])
                decode_intermediate[v_i, v_j] = (T.Cast("float16", T.bitwise_and(T.shift_right(model_params_9[v_i, v_j // T.int64(4)], T.Cast("uint32", v_j % T.int64(4)) * T.uint32(8)), T.uint32(255))) - T.float16(127)) * model_params_10[v_i, v_j // T.int64(32)]
    ...
    def fused_fused_decode1_take(lv: T.Buffer((50280, 640), "uint32"), lv1: T.Buffer((50280, 80), "float16"), lv1772: T.Buffer((1,), "int32"), T_take_intermediate: T.Buffer((1, 2560), "float16")):
        ...
        for ax0, ax1 in T.grid(1, 2560):
            with T.block("T_take"):
                ...
                T.reads(lv1772[v_ax0], lv[lv1772[v_ax0], v_ax1 // 4], lv1[lv1772[v_ax0], v_ax1 // 32])
                T.writes(T_take_intermediate[v_ax0, v_ax1])
                T_take_intermediate[v_ax0, v_ax1] = (T.Cast("float16", T.bitwise_and(T.shift_right(lv[lv1772[v_ax0], v_ax1 // 4], T.Cast("uint32", v_ax1 % 4) * T.uint32(8)), T.uint32(255))) - T.float16(127)) * lv1[lv1772[v_ax0], v_ax1 // 32]
    ...
    def fused_fused_decode1_take1(lv775: T.Buffer((50280, 640), "uint32"), lv776: T.Buffer((50280, 80), "float16"), p_lv: T.handle, p_output0: T.handle):
        ...
        # with T.block("root"):
        for ax0, ax1 in T.grid(n, 2560):
            with T.block("T_take"):
                v_ax0, v_ax1 = T.axis.remap("SS", [ax0, ax1])
                T.reads(lv[v_ax0], lv775[lv[v_ax0], v_ax1 // 4], lv776[lv[v_ax0], v_ax1 // 32])
                T.writes(T_take_intermediate[v_ax0, v_ax1])
                T_take_intermediate[v_ax0, v_ax1] = (T.Cast("float16", T.bitwise_and(T.shift_right(lv775[lv[v_ax0], v_ax1 // 4], T.Cast("uint32", v_ax1 % 4) * T.uint32(8)), T.uint32(255))) - T.float16(127)) * lv776[lv[v_ax0], v_ax1 // 32]
    ...
    def fused_fused_decode2_fused_NT_matmul6_add4(lv780: T.Buffer((T.int64(7680), T.int64(640)), "uint32"), lv781: T.Buffer((T.int64(7680), T.int64(80)), "float16"), p_lv779: T.handle, param_810: T.Buffer((T.int64(7680),), "float16"), p_output0: T.handle):
        ...
        # with T.block("root"):
        decode_intermediate_intermediate = T.alloc_buffer((T.int64(7680), T.int64(2560)), "float16")
        NT_matmul_intermediate = T.alloc_buffer((T.int64(1), n, T.int64(7680)), "float16")
        for i, j in T.grid(T.int64(7680), T.int64(2560)):
            with T.block("decode"):
                v_i, v_j = T.axis.remap("SS", [i, j])
                T.reads(lv780[v_i, v_j // T.int64(4)], lv781[v_i, v_j // T.int64(32)])
                T.writes(decode_intermediate_intermediate[v_i, v_j])
                decode_intermediate_intermediate[v_i, v_j] = (T.Cast("float16", T.bitwise_and(T.shift_right(lv780[v_i, v_j // T.int64(4)], T.Cast("uint32", v_j % T.int64(4)) * T.uint32(8)), T.uint32(255))) - T.float16(127)) * lv781[v_i, v_j // T.int64(32)]
        for i0, i1, i2, k in T.grid(T.int64(1), n, T.int64(7680), T.int64(2560)):
            with T.block("NT_matmul"):
                v_i0, v_i1, v_i2, v_k = T.axis.remap("SSSR", [i0, i1, i2, k])
                T.reads(lv779[v_i0, v_i1, v_k], decode_intermediate_intermediate[v_i2, v_k])
                T.writes(NT_matmul_intermediate[v_i0, v_i1, v_i2])
                with T.init():
                    NT_matmul_intermediate[v_i0, v_i1, v_i2] = T.float16(0)
                NT_matmul_intermediate[v_i0, v_i1, v_i2] = NT_matmul_intermediate[v_i0, v_i1, v_i2] + lv779[v_i0, v_i1, v_k] * decode_intermediate_intermediate[v_i2, v_k]
        for ax0, ax1, ax2 in T.grid(T.int64(1), n, T.int64(7680)):
            with T.block("T_add"):
                ...
                T_add_intermediate_intermediate[v_ax0, v_ax1, v_ax2] = NT_matmul_intermediate[v_ax0, v_ax1, v_ax2] + param_810[v_ax2]
    ...
    def fused_fused_decode2_fused_NT_matmul_add(lv4: T.Buffer((T.int64(7680), T.int64(640)), "uint32"), lv5: T.Buffer((T.int64(7680), T.int64(80)), "float16"), lv3: T.Buffer((T.int64(1), T.int64(1), T.int64(2560)), "float16"), param_8: T.Buffer((T.int64(7680),), "float16"), T_add_intermediate_intermediate: T.Buffer((T.int64(1), T.int64(1), T.int64(7680)), "float16")):
        ...
        for i, j in T.grid(T.int64(7680), T.int64(2560)):
            with T.block("decode"):
                v_i, v_j = T.axis.remap("SS", [i, j])
                T.reads(lv4[v_i, v_j // T.int64(4)], lv5[v_i, v_j // T.int64(32)])
                T.writes(decode_intermediate_intermediate[v_i, v_j])
                decode_intermediate_intermediate[v_i, v_j] = (T.Cast("float16", T.bitwise_and(T.shift_right(lv4[v_i, v_j // T.int64(4)], T.Cast("uint32", v_j % T.int64(4)) * T.uint32(8)), T.uint32(255))) - T.float16(127)) * lv5[v_i, v_j // T.int64(32)]
        for i0, i1, i2, k in T.grid(T.int64(1), T.int64(1), T.int64(7680), T.int64(2560)):
            with T.block("NT_matmul"):
                v_i0, v_i1, v_i2, v_k = T.axis.remap("SSSR", [i0, i1, i2, k])
                T.reads(lv3[v_i0, v_i1, v_k], decode_intermediate_intermediate[v_i2, v_k])
                T.writes(NT_matmul_intermediate[v_i0, v_i1, v_i2])
                with T.init():
                    NT_matmul_intermediate[v_i0, v_i1, v_i2] = T.float16(0)
                NT_matmul_intermediate[v_i0, v_i1, v_i2] = NT_matmul_intermediate[v_i0, v_i1, v_i2] + lv3[v_i0, v_i1, v_k] * decode_intermediate_intermediate[v_i2, v_k]
        for ax0, ax1, ax2 in T.grid(T.int64(1), T.int64(1), T.int64(7680)):
            with T.block("T_add"):
                v_ax0, v_ax1, v_ax2 = T.axis.remap("SSS", [ax0, ax1, ax2])
                T.reads(NT_matmul_intermediate[v_ax0, v_ax1, v_ax2], param_8[v_ax2])
                T.writes(T_add_intermediate_intermediate[v_ax0, v_ax1, v_ax2])
                T_add_intermediate_intermediate[v_ax0, v_ax1, v_ax2] = NT_matmul_intermediate[v_ax0, v_ax1, v_ax2] + param_8[v_ax2]
    ...
    def fused_fused_decode4_fused_NT_matmul3_add2_gelu(lv18: T.Buffer((T.int64(10240), T.int64(640)), "uint32"), lv19: T.Buffer((T.int64(10240), T.int64(80)), "float16"), lv17: T.Buffer((T.int64(1), T.int64(1), T.int64(2560)), "float16"), param_14: T.Buffer((T.int64(10240),), "float16"), T_multiply_intermediate_intermediate: T.Buffer((T.int64(1), T.int64(1), T.int64(10240)), "float16")):
        T.func_attr({"tir.noalias": T.bool(True)})
        # with T.block("root"):
        decode_intermediate_intermediate = T.alloc_buffer((T.int64(10240), T.int64(2560)), "float16")
        ...
        for i, j in T.grid(T.int64(10240), T.int64(2560)):
            with T.block("decode"):
                v_i, v_j = T.axis.remap("SS", [i, j])
                T.reads(lv18[v_i, v_j // T.int64(4)], lv19[v_i, v_j // T.int64(32)])
                T.writes(decode_intermediate_intermediate[v_i, v_j])
                decode_intermediate_intermediate[v_i, v_j] = (T.Cast("float16", T.bitwise_and(T.shift_right(lv18[v_i, v_j // T.int64(4)], T.Cast("uint32", v_j % T.int64(4)) * T.uint32(8)), T.uint32(255))) - T.float16(127)) * lv19[v_i, v_j // T.int64(32)]
        for i0, i1, i2, k in T.grid(T.int64(1), T.int64(1), T.int64(10240), T.int64(2560)):
            with T.block("NT_matmul"):
                v_i0, v_i1, v_i2, v_k = T.axis.remap("SSSR", [i0, i1, i2, k])
                T.reads(lv17[v_i0, v_i1, v_k], decode_intermediate_intermediate[v_i2, v_k])
                T.writes(NT_matmul_intermediate[v_i0, v_i1, v_i2])
                with T.init():
                    NT_matmul_intermediate[v_i0, v_i1, v_i2] = T.float16(0)
                NT_matmul_intermediate[v_i0, v_i1, v_i2] = NT_matmul_intermediate[v_i0, v_i1, v_i2] + lv17[v_i0, v_i1, v_k] * decode_intermediate_intermediate[v_i2, v_k]
        for ax0, ax1, ax2 in T.grid(T.int64(1), T.int64(1), T.int64(10240)):
            with T.block("T_add"):
                v_ax0, v_ax1, v_ax2 = T.axis.remap("SSS", [ax0, ax1, ax2])
                T.reads(NT_matmul_intermediate[v_ax0, v_ax1, v_ax2], param_14[v_ax2])
                T.writes(T_add_intermediate[v_ax0, v_ax1, v_ax2])
                T_add_intermediate[v_ax0, v_ax1, v_ax2] = NT_matmul_intermediate[v_ax0, v_ax1, v_ax2] + param_14[v_ax2]
        for ax0, ax1, ax2 in T.grid(T.int64(1), T.int64(1), T.int64(10240)):
        ...
        for ax0, ax1, ax2 in T.grid(T.int64(1), T.int64(1), T.int64(10240)):
            with T.block("T_multiply_2"):
                ...
                T.writes(T_multiply_intermediate_intermediate[v_ax0, v_ax1, v_ax2])
                T_multiply_intermediate_intermediate[v_ax0, v_ax1, v_ax2] = T_add_intermediate[v_ax0, v_ax1, v_ax2] * T_add[v_ax0, v_ax1, v_ax2]
    ...
    def fused_fused_decode4_fused_NT_matmul9_add6_gelu1(lv792: T.Buffer((T.int64(10240), T.int64(640)), "uint32"), lv793: T.Buffer((T.int64(10240), T.int64(80)), "float16"), p_lv791: T.handle, param_1410: T.Buffer((T.int64(10240),), "float16"), p_output0: T.handle):
        ...
        for i, j in T.grid(T.int64(10240), T.int64(2560)):
            with T.block("decode"):
                v_i, v_j = T.axis.remap("SS", [i, j])
                T.reads(lv792[v_i, v_j // T.int64(4)], lv793[v_i, v_j // T.int64(32)])
                T.writes(decode_intermediate_intermediate[v_i, v_j])
                decode_intermediate_intermediate[v_i, v_j] = (T.Cast("float16", T.bitwise_and(T.shift_right(lv792[v_i, v_j // T.int64(4)], T.Cast("uint32", v_j % T.int64(4)) * T.uint32(8)), T.uint32(255))) - T.float16(127)) * lv793[v_i, v_j // T.int64(32)]
        for i0, i1, i2, k in T.grid(T.int64(1), n, T.int64(10240), T.int64(2560)):
            with T.block("NT_matmul"):
                v_i0, v_i1, v_i2, v_k = T.axis.remap("SSSR", [i0, i1, i2, k])
                T.reads(lv791[v_i0, v_i1, v_k], decode_intermediate_intermediate[v_i2, v_k])
                T.writes(NT_matmul_intermediate[v_i0, v_i1, v_i2])
                with T.init():
                    NT_matmul_intermediate[v_i0, v_i1, v_i2] = T.float16(0)
                NT_matmul_intermediate[v_i0, v_i1, v_i2] = NT_matmul_intermediate[v_i0, v_i1, v_i2] + lv791[v_i0, v_i1, v_k] * decode_intermediate_intermediate[v_i2, v_k]
        for ax0, ax1, ax2 in T.grid(T.int64(1), n, T.int64(10240)):
            with T.block("T_add"):
                v_ax0, v_ax1, v_ax2 = T.axis.remap("SSS", [ax0, ax1, ax2])
                T.reads(NT_matmul_intermediate[v_ax0, v_ax1, v_ax2], param_1410[v_ax2])
                T.writes(T_add_intermediate[v_ax0, v_ax1, v_ax2])
                T_add_intermediate[v_ax0, v_ax1, v_ax2] = NT_matmul_intermediate[v_ax0, v_ax1, v_ax2] + param_1410[v_ax2]
        for ax0, ax1, ax2 in T.grid(T.int64(1), n, T.int64(10240)):
            with T.block("T_multiply"):
                v_ax0, v_ax1, v_ax2 = T.axis.remap("SSS", [ax0, ax1, ax2])
                T.reads(T_add_intermediate[v_ax0, v_ax1, v_ax2])
    ...
    def fused_fused_decode5_fused_NT_matmul10_add5(lv796: T.Buffer((T.int64(2560), T.int64(2560)), "uint32"), lv797: T.Buffer((T.int64(2560), T.int64(320)), "float16"), p_lv795: T.handle, param_1710: T.Buffer((T.int64(2560),), "float16"), p_output0: T.handle):
        ...
        # with T.block("root"):
        decode_intermediate_intermediate = T.alloc_buffer((T.int64(2560), T.int64(10240)), "float16")
        NT_matmul_intermediate = T.alloc_buffer((T.int64(1), n, T.int64(2560)), "float16")
        for i, j in T.grid(T.int64(2560), T.int64(10240)):
            with T.block("decode"):
                v_i, v_j = T.axis.remap("SS", [i, j])
                T.reads(lv796[v_i, v_j // T.int64(4)], lv797[v_i, v_j // T.int64(32)])
                T.writes(decode_intermediate_intermediate[v_i, v_j])
                decode_intermediate_intermediate[v_i, v_j] = (T.Cast("float16", T.bitwise_and(T.shift_right(lv796[v_i, v_j // T.int64(4)], T.Cast("uint32", v_j % T.int64(4)) * T.uint32(8)), T.uint32(255))) - T.float16(127)) * lv797[v_i, v_j // T.int64(32)]
        for i0, i1, i2, k in T.grid(T.int64(1), n, T.int64(2560), T.int64(10240)):
            with T.block("NT_matmul"):
                v_i0, v_i1, v_i2, v_k = T.axis.remap("SSSR", [i0, i1, i2, k])
                T.reads(lv795[v_i0, v_i1, v_k], decode_intermediate_intermediate[v_i2, v_k])
                T.writes(NT_matmul_intermediate[v_i0, v_i1, v_i2])
                with T.init():
                    NT_matmul_intermediate[v_i0, v_i1, v_i2] = T.float16(0)
                NT_matmul_intermediate[v_i0, v_i1, v_i2] = NT_matmul_intermediate[v_i0, v_i1, v_i2] + lv795[v_i0, v_i1, v_k] * decode_intermediate_intermediate[v_i2, v_k]
        for ax0, ax1, ax2 in T.grid(T.int64(1), n, T.int64(2560)):
            with T.block("T_add"):
                v_ax0, v_ax1, v_ax2 = T.axis.remap("SSS", [ax0, ax1, ax2])
                T.reads(NT_matmul_intermediate[v_ax0, v_ax1, v_ax2], param_1710[v_ax2])
                T.writes(T_add_intermediate_intermediate[v_ax0, v_ax1, v_ax2])
                T_add_intermediate_intermediate[v_ax0, v_ax1, v_ax2] = NT_matmul_intermediate[v_ax0, v_ax1, v_ax2] + param_1710[v_ax2]
    ...
    def fused_fused_decode5_fused_NT_matmul4_add1(lv22: T.Buffer((T.int64(2560), T.int64(2560)), "uint32"), lv23: T.Buffer((T.int64(2560), T.int64(320)), "float16"), lv21: T.Buffer((T.int64(1), T.int64(1), T.int64(10240)), "float16"), param_17: T.Buffer((T.int64(2560),), "float16"), T_add_intermediate_intermediate: T.Buffer((T.int64(1), T.int64(1), T.int64(2560)), "float16")):
        ...
        for i, j in T.grid(T.int64(2560), T.int64(10240)):
            with T.block("decode"):
                v_i, v_j = T.axis.remap("SS", [i, j])
                T.reads(lv22[v_i, v_j // T.int64(4)], lv23[v_i, v_j // T.int64(32)])
                T.writes(decode_intermediate_intermediate[v_i, v_j])
                decode_intermediate_intermediate[v_i, v_j] = (T.Cast("float16", T.bitwise_and(T.shift_right(lv22[v_i, v_j // T.int64(4)], T.Cast("uint32", v_j % T.int64(4)) * T.uint32(8)), T.uint32(255))) - T.float16(127)) * lv23[v_i, v_j // T.int64(32)]
        for i0, i1, i2, k in T.grid(T.int64(1), T.int64(1), T.int64(2560), T.int64(10240)):
            with T.block("NT_matmul"):
                v_i0, v_i1, v_i2, v_k = T.axis.remap("SSSR", [i0, i1, i2, k])
                T.reads(lv21[v_i0, v_i1, v_k], decode_intermediate_intermediate[v_i2, v_k])
                T.writes(NT_matmul_intermediate[v_i0, v_i1, v_i2])
                with T.init():
                    NT_matmul_intermediate[v_i0, v_i1, v_i2] = T.float16(0)
                NT_matmul_intermediate[v_i0, v_i1, v_i2] = NT_matmul_intermediate[v_i0, v_i1, v_i2] + lv21[v_i0, v_i1, v_k] * decode_intermediate_intermediate[v_i2, v_k]
        for ax0, ax1, ax2 in T.grid(T.int64(1), T.int64(1), T.int64(2560)):
            with T.block("T_add"):
                v_ax0, v_ax1, v_ax2 = T.axis.remap("SSS", [ax0, ax1, ax2])
                T.reads(NT_matmul_intermediate[v_ax0, v_ax1, v_ax2], param_17[v_ax2])
                T.writes(T_add_intermediate_intermediate[v_ax0, v_ax1, v_ax2])
                T_add_intermediate_intermediate[v_ax0, v_ax1, v_ax2] = NT_matmul_intermediate[v_ax0, v_ax1, v_ax2] + param_17[v_ax2]
    ...
    def fused_fused_decode6_NT_matmul5(lv772: T.Buffer((T.int64(50280), T.int64(640)), "uint32"), lv773: T.Buffer((T.int64(50280), T.int64(80)), "float32"), lv771: T.Buffer((T.int64(1), T.int64(1), T.int64(2560)), "float32"), NT_matmul_intermediate: T.Buffer((T.int64(1), T.int64(1), T.int64(50280)), "float32")):
        T.func_attr({"tir.noalias": T.bool(True)})
        # with T.block("root"):
        decode_intermediate_intermediate = T.alloc_buffer((T.int64(50280), T.int64(2560)))
        for i, j in T.grid(T.int64(50280), T.int64(2560)):
            with T.block("decode"):
                v_i, v_j = T.axis.remap("SS", [i, j])
                T.reads(lv772[v_i, v_j // T.int64(4)], lv773[v_i, v_j // T.int64(32)])
                T.writes(decode_intermediate_intermediate[v_i, v_j])
                decode_intermediate_intermediate[v_i, v_j] = T.Cast("float32", T.Cast("float16", T.bitwise_and(T.shift_right(lv772[v_i, v_j // T.int64(4)], T.Cast("uint32", v_j % T.int64(4)) * T.uint32(8)), T.uint32(255))) - T.float16(127)) * lv773[v_i, v_j // T.int64(32)]
        for i0, i1, i2, k in T.grid(T.int64(1), T.int64(1), T.int64(50280), T.int64(2560)):
            with T.block("NT_matmul"):
                v_i0, v_i1, v_i2, v_k = T.axis.remap("SSSR", [i0, i1, i2, k])
                T.reads(lv771[v_i0, v_i1, v_k], decode_intermediate_intermediate[v_i2, v_k])
                T.writes(NT_matmul_intermediate[v_i0, v_i1, v_i2])
                with T.init():
                    NT_matmul_intermediate[v_i0, v_i1, v_i2] = T.float32(0)
                NT_matmul_intermediate[v_i0, v_i1, v_i2] = NT_matmul_intermediate[v_i0, v_i1, v_i2] + lv771[v_i0, v_i1, v_k] * decode_intermediate_intermediate[v_i2, v_k]
    ...
    def fused_layer_norm_cast1(lv1776: T.Buffer((T.int64(1), T.int64(1), T.int64(2560)), "float32"), param_2: T.Buffer((T.int64(2560),), "float32"), param_3: T.Buffer((T.int64(2560),), "float32"), compute_intermediate: T.Buffer((T.int64(1), T.int64(1), T.int64(2560)), "float16")):
        ...
        for ax0, ax1, ax2 in T.grid(T.int64(1), T.int64(1), T.int64(2560)):
            with T.block("T_layer_norm"):
                v_ax0, v_ax1, v_ax2 = T.axis.remap("SSS", [ax0, ax1, ax2])
                T.reads(lv1776[v_ax0, v_ax1, v_ax2], A_red_temp_v0[v_ax0, v_ax1], A_red_temp_v1[v_ax0, v_ax1], param_2[v_ax2], param_3[v_ax2])
                T.writes(T_layer_norm_intermediate[v_ax0, v_ax1, v_ax2])
                T_layer_norm_intermediate[v_ax0, v_ax1, v_ax2] = (lv1776[v_ax0, v_ax1, v_ax2] - A_red_temp_v0[v_ax0, v_ax1] * T.float32(0.00039062500000000002)) * T.rsqrt(A_red_temp_v1[v_ax0, v_ax1] * T.float32(0.00039062500000000002) - A_red_temp_v0[v_ax0, v_ax1] * T.float32(0.00039062500000000002) * (A_red_temp_v0[v_ax0, v_ax1] * T.float32(0.00039062500000000002)) + T.float32(1.0000000000000001e-05)) * param_2[v_ax2] + param_3[v_ax2]
        for i0, i1, i2 in T.grid(T.int64(1), T.int64(1), T.int64(2560)):
            with T.block("compute"):
                v_i0, v_i1, v_i2 = T.axis.remap("SSS", [i0, i1, i2])
                T.reads(T_layer_norm_intermediate[v_i0, v_i1, v_i2])
    ...
    def transpose2(var_A: T.handle, var_T_transpose: T.handle):
        ...
        # with T.block("root"):
        for ax0, ax1, ax2, ax3 in T.grid(T.int64(1), T.int64(32), m, T.int64(80)):
            with T.block("T_transpose"):
                v_ax0, v_ax1, v_ax2, v_ax3 = T.axis.remap("SSSS", [ax0, ax1, ax2, ax3])
                T.reads(A[v_ax0, v_ax2, v_ax1, v_ax3])
                T.writes(T_transpose[v_ax0, v_ax1, v_ax2, v_ax3])
