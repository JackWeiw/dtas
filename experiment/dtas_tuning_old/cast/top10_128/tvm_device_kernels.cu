...
extern "C" __global__ void __launch_bounds__(256) cast_n_1_to_128__kernel(half* __restrict__ A, float* __restrict__ compute, int64_t n) {
  for (int64_t ax0_ax1_fused_1 = 0; ax0_ax1_fused_1 < ((n + (int64_t)127) >> (int64_t)7); ++ax0_ax1_fused_1) {
    if ((((((((int64_t)blockIdx.x) * ((n + (int64_t)127) >> (int64_t)7)) * (int64_t)256) + (ax0_ax1_fused_1 * (int64_t)256)) + ((int64_t)threadIdx.x)) - (n * (int64_t)640)) < (int64_t)0) {
      float4 __1;
      uint2 v_ = *(uint2*)(A + (((ax0_ax1_fused_1 * (int64_t)1024) + ((((int64_t)blockIdx.x) * ((n + (int64_t)127) >> (int64_t)7)) * (int64_t)1024)) + (((int64_t)threadIdx.x) * (int64_t)4)));
      __1.x = (float)(((half2*)(&(v_.x)))->x);
      __1.y = (float)(((half2*)(&(v_.x)))->y);
      __1.z = (float)(((half2*)(&(v_.y)))->x);
      __1.w = (float)(((half2*)(&(v_.y)))->y);
      *(float4*)(compute + (((ax0_ax1_fused_1 * (int64_t)1024) + ((((int64_t)blockIdx.x) * ((n + (int64_t)127) >> (int64_t)7)) * (int64_t)1024)) + (((int64_t)threadIdx.x) * (int64_t)4))) = __1;
    }
  }
}
...
extern "C" __global__ void __launch_bounds__(256) cast_n_129_to_256__kernel(half* __restrict__ A, float* __restrict__ compute, int64_t n) {
  for (int64_t ax0_ax1_fused_1 = 0; ax0_ax1_fused_1 < ((n + (int64_t)255) >> (int64_t)8); ++ax0_ax1_fused_1) {
    if ((((((((int64_t)blockIdx.x) * ((n + (int64_t)255) >> (int64_t)8)) * (int64_t)256) + (ax0_ax1_fused_1 * (int64_t)256)) + ((int64_t)threadIdx.x)) - (n * (int64_t)640)) < (int64_t)0) {
      float4 __1;
      uint2 v_ = *(uint2*)(A + (((ax0_ax1_fused_1 * (int64_t)1024) + ((((int64_t)blockIdx.x) * ((n + (int64_t)255) >> (int64_t)8)) * (int64_t)1024)) + (((int64_t)threadIdx.x) * (int64_t)4)));
      __1.x = (float)(((half2*)(&(v_.x)))->x);
      __1.y = (float)(((half2*)(&(v_.x)))->y);
      __1.z = (float)(((half2*)(&(v_.y)))->x);
      __1.w = (float)(((half2*)(&(v_.y)))->y);
      *(float4*)(compute + (((ax0_ax1_fused_1 * (int64_t)1024) + ((((int64_t)blockIdx.x) * ((n + (int64_t)255) >> (int64_t)8)) * (int64_t)1024)) + (((int64_t)threadIdx.x) * (int64_t)4))) = __1;
    }
  }
}
...
extern "C" __global__ void __launch_bounds__(256) cast_n_257_to_384__kernel(half* __restrict__ A, float* __restrict__ compute, int64_t n) {
  for (int64_t ax0_ax1_fused_1 = 0; ax0_ax1_fused_1 < (((n + (int64_t)383) / (int64_t)384) + (((n + (int64_t)383) % (int64_t)384) >> (int64_t)63)); ++ax0_ax1_fused_1) {
    if ((((((((int64_t)blockIdx.x) * (((n + (int64_t)383) / (int64_t)384) + (((n + (int64_t)383) % (int64_t)384) >> (int64_t)63))) * (int64_t)256) + (ax0_ax1_fused_1 * (int64_t)256)) + ((int64_t)threadIdx.x)) - (n * (int64_t)640)) < (int64_t)0) {
      float4 __1;
      uint2 v_ = *(uint2*)(A + (((ax0_ax1_fused_1 * (int64_t)1024) + ((((int64_t)blockIdx.x) * (((n + (int64_t)383) / (int64_t)384) + (((n + (int64_t)383) % (int64_t)384) >> (int64_t)63))) * (int64_t)1024)) + (((int64_t)threadIdx.x) * (int64_t)4)));
      __1.x = (float)(((half2*)(&(v_.x)))->x);
      __1.y = (float)(((half2*)(&(v_.x)))->y);
      __1.z = (float)(((half2*)(&(v_.y)))->x);
      __1.w = (float)(((half2*)(&(v_.y)))->y);
      *(float4*)(compute + (((ax0_ax1_fused_1 * (int64_t)1024) + ((((int64_t)blockIdx.x) * (((n + (int64_t)383) / (int64_t)384) + (((n + (int64_t)383) % (int64_t)384) >> (int64_t)63))) * (int64_t)1024)) + (((int64_t)threadIdx.x) * (int64_t)4))) = __1;
    }
  }
}
...
extern "C" __global__ void __launch_bounds__(256) cast_n_385_to_512__kernel(half* __restrict__ A, float* __restrict__ compute, int64_t n) {
  for (int64_t ax0_ax1_fused_1 = 0; ax0_ax1_fused_1 < ((n + (int64_t)511) >> (int64_t)9); ++ax0_ax1_fused_1) {
    if ((((((((int64_t)blockIdx.x) * ((n + (int64_t)511) >> (int64_t)9)) * (int64_t)256) + (ax0_ax1_fused_1 * (int64_t)256)) + ((int64_t)threadIdx.x)) - (n * (int64_t)640)) < (int64_t)0) {
      float4 __1;
      uint2 v_ = *(uint2*)(A + (((ax0_ax1_fused_1 * (int64_t)1024) + ((((int64_t)blockIdx.x) * ((n + (int64_t)511) >> (int64_t)9)) * (int64_t)1024)) + (((int64_t)threadIdx.x) * (int64_t)4)));
      __1.x = (float)(((half2*)(&(v_.x)))->x);
      __1.y = (float)(((half2*)(&(v_.x)))->y);
      __1.z = (float)(((half2*)(&(v_.y)))->x);
      __1.w = (float)(((half2*)(&(v_.y)))->y);
      *(float4*)(compute + (((ax0_ax1_fused_1 * (int64_t)1024) + ((((int64_t)blockIdx.x) * ((n + (int64_t)511) >> (int64_t)9)) * (int64_t)1024)) + (((int64_t)threadIdx.x) * (int64_t)4))) = __1;
    }
  }
}
...
extern "C" __global__ void __launch_bounds__(256) cast_n_513_to_640__kernel(half* __restrict__ A, float* __restrict__ compute, int64_t n) {
  for (int64_t ax0_ax1_fused_1 = 0; ax0_ax1_fused_1 < (((n + (int64_t)639) / (int64_t)640) + (((n + (int64_t)639) % (int64_t)640) >> (int64_t)63)); ++ax0_ax1_fused_1) {
    if ((((((((int64_t)blockIdx.x) * (((n + (int64_t)639) / (int64_t)640) + (((n + (int64_t)639) % (int64_t)640) >> (int64_t)63))) * (int64_t)256) + (ax0_ax1_fused_1 * (int64_t)256)) + ((int64_t)threadIdx.x)) - (n * (int64_t)640)) < (int64_t)0) {
      float4 __1;
      uint2 v_ = *(uint2*)(A + (((ax0_ax1_fused_1 * (int64_t)1024) + ((((int64_t)blockIdx.x) * (((n + (int64_t)639) / (int64_t)640) + (((n + (int64_t)639) % (int64_t)640) >> (int64_t)63))) * (int64_t)1024)) + (((int64_t)threadIdx.x) * (int64_t)4)));
      __1.x = (float)(((half2*)(&(v_.x)))->x);
      __1.y = (float)(((half2*)(&(v_.x)))->y);
      __1.z = (float)(((half2*)(&(v_.y)))->x);
      __1.w = (float)(((half2*)(&(v_.y)))->y);
      *(float4*)(compute + (((ax0_ax1_fused_1 * (int64_t)1024) + ((((int64_t)blockIdx.x) * (((n + (int64_t)639) / (int64_t)640) + (((n + (int64_t)639) % (int64_t)640) >> (int64_t)63))) * (int64_t)1024)) + (((int64_t)threadIdx.x) * (int64_t)4))) = __1;
    }
  }
}
...
extern "C" __global__ void __launch_bounds__(256) cast_n_897_to_1024__kernel(half* __restrict__ A, float* __restrict__ compute, int64_t n) {
  for (int64_t ax0_ax1_fused_1 = 0; ax0_ax1_fused_1 < ((n + (int64_t)1023) >> (int64_t)10); ++ax0_ax1_fused_1) {
    if ((((((((int64_t)blockIdx.x) * ((n + (int64_t)1023) >> (int64_t)10)) * (int64_t)256) + (ax0_ax1_fused_1 * (int64_t)256)) + ((int64_t)threadIdx.x)) - (n * (int64_t)640)) < (int64_t)0) {
      float4 __1;
      uint2 v_ = *(uint2*)(A + (((ax0_ax1_fused_1 * (int64_t)1024) + ((((int64_t)blockIdx.x) * ((n + (int64_t)1023) >> (int64_t)10)) * (int64_t)1024)) + (((int64_t)threadIdx.x) * (int64_t)4)));
      __1.x = (float)(((half2*)(&(v_.x)))->x);
      __1.y = (float)(((half2*)(&(v_.x)))->y);
      __1.z = (float)(((half2*)(&(v_.y)))->x);
      __1.w = (float)(((half2*)(&(v_.y)))->y);
      *(float4*)(compute + (((ax0_ax1_fused_1 * (int64_t)1024) + ((((int64_t)blockIdx.x) * ((n + (int64_t)1023) >> (int64_t)10)) * (int64_t)1024)) + (((int64_t)threadIdx.x) * (int64_t)4))) = __1;
    }
  }
}
...
extern "C" __global__ void __launch_bounds__(256) cast_n_1025_to_1152__kernel(half* __restrict__ A, float* __restrict__ compute, int64_t n) {
  for (int64_t ax0_ax1_fused_1 = 0; ax0_ax1_fused_1 < (((n + (int64_t)1151) / (int64_t)1152) + (((n + (int64_t)1151) % (int64_t)1152) >> (int64_t)63)); ++ax0_ax1_fused_1) {
    if ((((((((int64_t)blockIdx.x) * (((n + (int64_t)1151) / (int64_t)1152) + (((n + (int64_t)1151) % (int64_t)1152) >> (int64_t)63))) * (int64_t)256) + (ax0_ax1_fused_1 * (int64_t)256)) + ((int64_t)threadIdx.x)) - (n * (int64_t)640)) < (int64_t)0) {
      float4 __1;
      uint2 v_ = *(uint2*)(A + (((ax0_ax1_fused_1 * (int64_t)1024) + ((((int64_t)blockIdx.x) * (((n + (int64_t)1151) / (int64_t)1152) + (((n + (int64_t)1151) % (int64_t)1152) >> (int64_t)63))) * (int64_t)1024)) + (((int64_t)threadIdx.x) * (int64_t)4)));
      __1.x = (float)(((half2*)(&(v_.x)))->x);
      __1.y = (float)(((half2*)(&(v_.x)))->y);
      __1.z = (float)(((half2*)(&(v_.y)))->x);
      __1.w = (float)(((half2*)(&(v_.y)))->y);
      *(float4*)(compute + (((ax0_ax1_fused_1 * (int64_t)1024) + ((((int64_t)blockIdx.x) * (((n + (int64_t)1151) / (int64_t)1152) + (((n + (int64_t)1151) % (int64_t)1152) >> (int64_t)63))) * (int64_t)1024)) + (((int64_t)threadIdx.x) * (int64_t)4))) = __1;
    }
  }
}
...
extern "C" __global__ void __launch_bounds__(256) cast_n_1153_to_1280__kernel(half* __restrict__ A, float* __restrict__ compute, int64_t n) {
  for (int64_t ax0_ax1_fused_1 = 0; ax0_ax1_fused_1 < (((n + (int64_t)1279) / (int64_t)1280) + (((n + (int64_t)1279) % (int64_t)1280) >> (int64_t)63)); ++ax0_ax1_fused_1) {
    if ((((((((int64_t)blockIdx.x) * (((n + (int64_t)1279) / (int64_t)1280) + (((n + (int64_t)1279) % (int64_t)1280) >> (int64_t)63))) * (int64_t)256) + (ax0_ax1_fused_1 * (int64_t)256)) + ((int64_t)threadIdx.x)) - (n * (int64_t)640)) < (int64_t)0) {
      float4 __1;
      uint2 v_ = *(uint2*)(A + (((ax0_ax1_fused_1 * (int64_t)1024) + ((((int64_t)blockIdx.x) * (((n + (int64_t)1279) / (int64_t)1280) + (((n + (int64_t)1279) % (int64_t)1280) >> (int64_t)63))) * (int64_t)1024)) + (((int64_t)threadIdx.x) * (int64_t)4)));
      __1.x = (float)(((half2*)(&(v_.x)))->x);
      __1.y = (float)(((half2*)(&(v_.x)))->y);
      __1.z = (float)(((half2*)(&(v_.y)))->x);
      __1.w = (float)(((half2*)(&(v_.y)))->y);
      *(float4*)(compute + (((ax0_ax1_fused_1 * (int64_t)1024) + ((((int64_t)blockIdx.x) * (((n + (int64_t)1279) / (int64_t)1280) + (((n + (int64_t)1279) % (int64_t)1280) >> (int64_t)63))) * (int64_t)1024)) + (((int64_t)threadIdx.x) * (int64_t)4))) = __1;
    }
  }
}
...
extern "C" __global__ void __launch_bounds__(256) cast_n_1281_to_1408__kernel(half* __restrict__ A, float* __restrict__ compute, int64_t n) {
  for (int64_t ax0_ax1_fused_1 = 0; ax0_ax1_fused_1 < (((n + (int64_t)1407) / (int64_t)1408) + (((n + (int64_t)1407) % (int64_t)1408) >> (int64_t)63)); ++ax0_ax1_fused_1) {
    if ((((((((int64_t)blockIdx.x) * (((n + (int64_t)1407) / (int64_t)1408) + (((n + (int64_t)1407) % (int64_t)1408) >> (int64_t)63))) * (int64_t)256) + (ax0_ax1_fused_1 * (int64_t)256)) + ((int64_t)threadIdx.x)) - (n * (int64_t)640)) < (int64_t)0) {
      float4 __1;
      uint2 v_ = *(uint2*)(A + (((ax0_ax1_fused_1 * (int64_t)1024) + ((((int64_t)blockIdx.x) * (((n + (int64_t)1407) / (int64_t)1408) + (((n + (int64_t)1407) % (int64_t)1408) >> (int64_t)63))) * (int64_t)1024)) + (((int64_t)threadIdx.x) * (int64_t)4)));
      __1.x = (float)(((half2*)(&(v_.x)))->x);
      __1.y = (float)(((half2*)(&(v_.x)))->y);
      __1.z = (float)(((half2*)(&(v_.y)))->x);
      __1.w = (float)(((half2*)(&(v_.y)))->y);
      *(float4*)(compute + (((ax0_ax1_fused_1 * (int64_t)1024) + ((((int64_t)blockIdx.x) * (((n + (int64_t)1407) / (int64_t)1408) + (((n + (int64_t)1407) % (int64_t)1408) >> (int64_t)63))) * (int64_t)1024)) + (((int64_t)threadIdx.x) * (int64_t)4))) = __1;
    }
  }
}
...
extern "C" __global__ void __launch_bounds__(256) cast_n_1409_to_1536__kernel(half* __restrict__ A, float* __restrict__ compute, int64_t n) {
  for (int64_t ax0_ax1_fused_1 = 0; ax0_ax1_fused_1 < (((n + (int64_t)1535) / (int64_t)1536) + (((n + (int64_t)1535) % (int64_t)1536) >> (int64_t)63)); ++ax0_ax1_fused_1) {
    if ((((((((int64_t)blockIdx.x) * (((n + (int64_t)1535) / (int64_t)1536) + (((n + (int64_t)1535) % (int64_t)1536) >> (int64_t)63))) * (int64_t)256) + (ax0_ax1_fused_1 * (int64_t)256)) + ((int64_t)threadIdx.x)) - (n * (int64_t)640)) < (int64_t)0) {
      float4 __1;
      uint2 v_ = *(uint2*)(A + (((ax0_ax1_fused_1 * (int64_t)1024) + ((((int64_t)blockIdx.x) * (((n + (int64_t)1535) / (int64_t)1536) + (((n + (int64_t)1535) % (int64_t)1536) >> (int64_t)63))) * (int64_t)1024)) + (((int64_t)threadIdx.x) * (int64_t)4)));
      __1.x = (float)(((half2*)(&(v_.x)))->x);
      __1.y = (float)(((half2*)(&(v_.x)))->y);
      __1.z = (float)(((half2*)(&(v_.y)))->x);
      __1.w = (float)(((half2*)(&(v_.y)))->y);
      *(float4*)(compute + (((ax0_ax1_fused_1 * (int64_t)1024) + ((((int64_t)blockIdx.x) * (((n + (int64_t)1535) / (int64_t)1536) + (((n + (int64_t)1535) % (int64_t)1536) >> (int64_t)63))) * (int64_t)1024)) + (((int64_t)threadIdx.x) * (int64_t)4))) = __1;
    }
  }
}
...
extern "C" __global__ void __launch_bounds__(256) cast_n_1921_to_2048__kernel(half* __restrict__ A, float* __restrict__ compute, int64_t n) {
  for (int64_t ax0_ax1_fused_1 = 0; ax0_ax1_fused_1 < ((n + (int64_t)2047) >> (int64_t)11); ++ax0_ax1_fused_1) {
    if ((((((((int64_t)blockIdx.x) * ((n + (int64_t)2047) >> (int64_t)11)) * (int64_t)256) + (ax0_ax1_fused_1 * (int64_t)256)) + ((int64_t)threadIdx.x)) - (n * (int64_t)640)) < (int64_t)0) {
      float4 __1;
      uint2 v_ = *(uint2*)(A + (((ax0_ax1_fused_1 * (int64_t)1024) + ((((int64_t)blockIdx.x) * ((n + (int64_t)2047) >> (int64_t)11)) * (int64_t)1024)) + (((int64_t)threadIdx.x) * (int64_t)4)));
      __1.x = (float)(((half2*)(&(v_.x)))->x);
      __1.y = (float)(((half2*)(&(v_.x)))->y);
      __1.z = (float)(((half2*)(&(v_.y)))->x);
      __1.w = (float)(((half2*)(&(v_.y)))->y);
      *(float4*)(compute + (((ax0_ax1_fused_1 * (int64_t)1024) + ((((int64_t)blockIdx.x) * ((n + (int64_t)2047) >> (int64_t)11)) * (int64_t)1024)) + (((int64_t)threadIdx.x) * (int64_t)4))) = __1;
    }
  }
}
...
extern "C" __global__ void __launch_bounds__(256) cast_n_2049_to_2176__kernel(half* __restrict__ A, float* __restrict__ compute, int64_t n) {
  for (int64_t ax0_ax1_fused_1 = 0; ax0_ax1_fused_1 < (((n + (int64_t)2175) / (int64_t)2176) + (((n + (int64_t)2175) % (int64_t)2176) >> (int64_t)63)); ++ax0_ax1_fused_1) {
    if ((((((((int64_t)blockIdx.x) * (((n + (int64_t)2175) / (int64_t)2176) + (((n + (int64_t)2175) % (int64_t)2176) >> (int64_t)63))) * (int64_t)256) + (ax0_ax1_fused_1 * (int64_t)256)) + ((int64_t)threadIdx.x)) - (n * (int64_t)640)) < (int64_t)0) {
      float4 __1;
      uint2 v_ = *(uint2*)(A + (((ax0_ax1_fused_1 * (int64_t)1024) + ((((int64_t)blockIdx.x) * (((n + (int64_t)2175) / (int64_t)2176) + (((n + (int64_t)2175) % (int64_t)2176) >> (int64_t)63))) * (int64_t)1024)) + (((int64_t)threadIdx.x) * (int64_t)4)));
      __1.x = (float)(((half2*)(&(v_.x)))->x);
      __1.y = (float)(((half2*)(&(v_.x)))->y);
      __1.z = (float)(((half2*)(&(v_.y)))->x);
      __1.w = (float)(((half2*)(&(v_.y)))->y);
      *(float4*)(compute + (((ax0_ax1_fused_1 * (int64_t)1024) + ((((int64_t)blockIdx.x) * (((n + (int64_t)2175) / (int64_t)2176) + (((n + (int64_t)2175) % (int64_t)2176) >> (int64_t)63))) * (int64_t)1024)) + (((int64_t)threadIdx.x) * (int64_t)4))) = __1;
    }
  }
}
...
extern "C" __global__ void __launch_bounds__(256) cast_n_2177_to_2304__kernel(half* __restrict__ A, float* __restrict__ compute, int64_t n) {
  for (int64_t ax0_ax1_fused_1 = 0; ax0_ax1_fused_1 < (((n + (int64_t)2303) / (int64_t)2304) + (((n + (int64_t)2303) % (int64_t)2304) >> (int64_t)63)); ++ax0_ax1_fused_1) {
    if ((((((((int64_t)blockIdx.x) * (((n + (int64_t)2303) / (int64_t)2304) + (((n + (int64_t)2303) % (int64_t)2304) >> (int64_t)63))) * (int64_t)256) + (ax0_ax1_fused_1 * (int64_t)256)) + ((int64_t)threadIdx.x)) - (n * (int64_t)640)) < (int64_t)0) {
      float4 __1;
      uint2 v_ = *(uint2*)(A + (((ax0_ax1_fused_1 * (int64_t)1024) + ((((int64_t)blockIdx.x) * (((n + (int64_t)2303) / (int64_t)2304) + (((n + (int64_t)2303) % (int64_t)2304) >> (int64_t)63))) * (int64_t)1024)) + (((int64_t)threadIdx.x) * (int64_t)4)));
      __1.x = (float)(((half2*)(&(v_.x)))->x);
      __1.y = (float)(((half2*)(&(v_.x)))->y);
      __1.z = (float)(((half2*)(&(v_.y)))->x);
      __1.w = (float)(((half2*)(&(v_.y)))->y);
      *(float4*)(compute + (((ax0_ax1_fused_1 * (int64_t)1024) + ((((int64_t)blockIdx.x) * (((n + (int64_t)2303) / (int64_t)2304) + (((n + (int64_t)2303) % (int64_t)2304) >> (int64_t)63))) * (int64_t)1024)) + (((int64_t)threadIdx.x) * (int64_t)4))) = __1;
    }
  }
}
...
extern "C" __global__ void __launch_bounds__(256) cast_n_2305_to_2432__kernel(half* __restrict__ A, float* __restrict__ compute, int64_t n) {
  for (int64_t ax0_ax1_fused_1 = 0; ax0_ax1_fused_1 < (((n + (int64_t)2431) / (int64_t)2432) + (((n + (int64_t)2431) % (int64_t)2432) >> (int64_t)63)); ++ax0_ax1_fused_1) {
    if ((((((((int64_t)blockIdx.x) * (((n + (int64_t)2431) / (int64_t)2432) + (((n + (int64_t)2431) % (int64_t)2432) >> (int64_t)63))) * (int64_t)256) + (ax0_ax1_fused_1 * (int64_t)256)) + ((int64_t)threadIdx.x)) - (n * (int64_t)640)) < (int64_t)0) {
      float4 __1;
      uint2 v_ = *(uint2*)(A + (((ax0_ax1_fused_1 * (int64_t)1024) + ((((int64_t)blockIdx.x) * (((n + (int64_t)2431) / (int64_t)2432) + (((n + (int64_t)2431) % (int64_t)2432) >> (int64_t)63))) * (int64_t)1024)) + (((int64_t)threadIdx.x) * (int64_t)4)));
      __1.x = (float)(((half2*)(&(v_.x)))->x);
      __1.y = (float)(((half2*)(&(v_.x)))->y);
      __1.z = (float)(((half2*)(&(v_.y)))->x);
      __1.w = (float)(((half2*)(&(v_.y)))->y);
      *(float4*)(compute + (((ax0_ax1_fused_1 * (int64_t)1024) + ((((int64_t)blockIdx.x) * (((n + (int64_t)2431) / (int64_t)2432) + (((n + (int64_t)2431) % (int64_t)2432) >> (int64_t)63))) * (int64_t)1024)) + (((int64_t)threadIdx.x) * (int64_t)4))) = __1;
    }
  }
}
...
extern "C" __global__ void __launch_bounds__(256) cast_n_2689_to_2816__kernel(half* __restrict__ A, float* __restrict__ compute, int64_t n) {
  for (int64_t ax0_ax1_fused_1 = 0; ax0_ax1_fused_1 < (((n + (int64_t)2815) / (int64_t)2816) + (((n + (int64_t)2815) % (int64_t)2816) >> (int64_t)63)); ++ax0_ax1_fused_1) {
    if ((((((((int64_t)blockIdx.x) * (((n + (int64_t)2815) / (int64_t)2816) + (((n + (int64_t)2815) % (int64_t)2816) >> (int64_t)63))) * (int64_t)256) + (ax0_ax1_fused_1 * (int64_t)256)) + ((int64_t)threadIdx.x)) - (n * (int64_t)640)) < (int64_t)0) {
      float4 __1;
      uint2 v_ = *(uint2*)(A + (((ax0_ax1_fused_1 * (int64_t)1024) + ((((int64_t)blockIdx.x) * (((n + (int64_t)2815) / (int64_t)2816) + (((n + (int64_t)2815) % (int64_t)2816) >> (int64_t)63))) * (int64_t)1024)) + (((int64_t)threadIdx.x) * (int64_t)4)));
      __1.x = (float)(((half2*)(&(v_.x)))->x);
      __1.y = (float)(((half2*)(&(v_.x)))->y);
      __1.z = (float)(((half2*)(&(v_.y)))->x);
      __1.w = (float)(((half2*)(&(v_.y)))->y);
      *(float4*)(compute + (((ax0_ax1_fused_1 * (int64_t)1024) + ((((int64_t)blockIdx.x) * (((n + (int64_t)2815) / (int64_t)2816) + (((n + (int64_t)2815) % (int64_t)2816) >> (int64_t)63))) * (int64_t)1024)) + (((int64_t)threadIdx.x) * (int64_t)4))) = __1;
    }
  }
}
...
extern "C" __global__ void __launch_bounds__(256) cast_n_2817_to_2944__kernel(half* __restrict__ A, float* __restrict__ compute, int64_t n) {
  for (int64_t ax0_ax1_fused_1 = 0; ax0_ax1_fused_1 < (((n + (int64_t)2943) / (int64_t)2944) + (((n + (int64_t)2943) % (int64_t)2944) >> (int64_t)63)); ++ax0_ax1_fused_1) {
    if ((((((((int64_t)blockIdx.x) * (((n + (int64_t)2943) / (int64_t)2944) + (((n + (int64_t)2943) % (int64_t)2944) >> (int64_t)63))) * (int64_t)256) + (ax0_ax1_fused_1 * (int64_t)256)) + ((int64_t)threadIdx.x)) - (n * (int64_t)640)) < (int64_t)0) {
      float4 __1;
      uint2 v_ = *(uint2*)(A + (((ax0_ax1_fused_1 * (int64_t)1024) + ((((int64_t)blockIdx.x) * (((n + (int64_t)2943) / (int64_t)2944) + (((n + (int64_t)2943) % (int64_t)2944) >> (int64_t)63))) * (int64_t)1024)) + (((int64_t)threadIdx.x) * (int64_t)4)));
      __1.x = (float)(((half2*)(&(v_.x)))->x);
      __1.y = (float)(((half2*)(&(v_.x)))->y);
      __1.z = (float)(((half2*)(&(v_.y)))->x);
      __1.w = (float)(((half2*)(&(v_.y)))->y);
      *(float4*)(compute + (((ax0_ax1_fused_1 * (int64_t)1024) + ((((int64_t)blockIdx.x) * (((n + (int64_t)2943) / (int64_t)2944) + (((n + (int64_t)2943) % (int64_t)2944) >> (int64_t)63))) * (int64_t)1024)) + (((int64_t)threadIdx.x) * (int64_t)4))) = __1;
    }
  }
}
