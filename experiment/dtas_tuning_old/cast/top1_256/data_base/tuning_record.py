...
#name: cast
#range: (<n: Range(257, 512)>,)  latency(ms):    0.0068    
...
#name: cast
#range: (<n: Range(1025, 1280)>,)  latency(ms):    0.0231    
...
#name: cast
#range: (<n: Range(1793, 2048)>,)  latency(ms):    0.0370    
...
#name: cast
#range: (<n: Range(2305, 2560)>,)  latency(ms):    0.0464    
...
#name: cast
#range: (<n: Range(2561, 2816)>,)  latency(ms):    0.0511    
...
#name: cast
#range: (<n: Range(2817, 3072)>,)  latency(ms):    0.0558    
...
#name: cast
#range: (<n: Range(3073, 3328)>,)  latency(ms):    0.0604    
