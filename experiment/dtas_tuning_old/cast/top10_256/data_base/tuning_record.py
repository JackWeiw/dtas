#name: cast
#range: (<n: Range(1, 256)>,)  latency(ms):    0.0026    
...
#name: cast
#range: (<n: Range(257, 512)>,)  latency(ms):    0.0070    
...
#name: cast
#range: (<n: Range(257, 512)>,)  latency(ms):    0.0065    
...
#name: cast
#range: (<n: Range(513, 768)>,)  latency(ms):    0.0141    
...
#name: cast
#range: (<n: Range(769, 1024)>,)  latency(ms):    0.0187    
...
#name: cast
#range: (<n: Range(1281, 1536)>,)  latency(ms):    0.0282    
...
#name: cast
#range: (<n: Range(2305, 2560)>,)  latency(ms):    0.0469    
...
#name: cast
#range: (<n: Range(2817, 3072)>,)  latency(ms):    0.0563    
...
#name: cast
#range: (<n: Range(3073, 3328)>,)  latency(ms):    0.0690    
...
#name: cast
#range: (<n: Range(3329, 3584)>,)  latency(ms):    0.0761    
#config: ElementwiseConfig: {'len_tx': 256, 'vector_size': 2, 'grid_size': 15744, 'unroll_depth': 256}
# from tvm.script import ir as I
# from tvm.script import tir as T
...
#name: cast
#range: (<n: Range(3585, 3840)>,)  latency(ms):    0.0698    
...
#name: cast
#range: (<n: Range(3585, 3840)>,)  latency(ms):    0.0796    
#config: ElementwiseConfig: {'len_tx': 256, 'vector_size': 2, 'grid_size': 15744, 'unroll_depth': 256}
# from tvm.script import ir as I
# from tvm.script import tir as T
...
#name: cast
#range: (<n: Range(3841, 4096)>,)  latency(ms):    0.0743    
...
#name: cast
#range: (<n: Range(3841, 4096)>,)  latency(ms):    0.0832    
#config: ElementwiseConfig: {'len_tx': 256, 'vector_size': 2, 'grid_size': 15744, 'unroll_depth': 256}
# from tvm.script import ir as I
# from tvm.script import tir as T
