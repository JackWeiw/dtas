...
TVM_DLL int32_t gemm(void* args, int32_t* arg_type_ids, int32_t num_args, void* out_ret_value, int32_t* out_ret_tcode, void* resource_handle) {
  ...
  kernel_entry_info call_table[] = {
    {{ (int64_t)1, (((n + (int64_t)159) / (int64_t)160) + (((n + (int64_t)159) % (int64_t)160) >> (int64_t)63)), (int64_t)20, (int64_t)32, (int64_t)20, ((int64_t)82944)}, gemm_n_1_to_256__kernel_packed, "gemm_n_1_to_256__kernel"},
    ...
    {{ (int64_t)1, (((n + (int64_t)159) / (int64_t)160) + (((n + (int64_t)159) % (int64_t)160) >> (int64_t)63)), (int64_t)20, (int64_t)32, (int64_t)10, ((int64_t)82944)}, gemm_n_769_to_1024__kernel_packed, "gemm_n_769_to_1024__kernel"},
    ...
    {{ (int64_t)1, (((n + (int64_t)191) / (int64_t)192) + (((n + (int64_t)191) % (int64_t)192) >> (int64_t)63)), (int64_t)20, (int64_t)32, (int64_t)16, ((int64_t)92160)}, gemm_n_2817_to_3072__kernel_packed, "gemm_n_2817_to_3072__kernel"},
