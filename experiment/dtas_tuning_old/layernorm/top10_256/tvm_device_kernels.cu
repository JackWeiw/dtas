...
extern "C" __global__ void __launch_bounds__(320) fused_layer_norm_cast1_n_2049_to_2304__kernel(half* __restrict__ compute_intermediate, float* __restrict__ lv6, float* __restrict__ param_1, float* __restrict__ param_2, int64_t n);
extern "C" __global__ void __launch_bounds__(512) fused_layer_norm_cast1_n_2305_to_4096__kernel(half* __restrict__ compute_intermediate, float* __restrict__ lv6, float* __restrict__ param_1, float* __restrict__ param_2, int64_t n);
extern "C" __global__ void __launch_bounds__(256) fused_layer_norm_cast1_n_1_to_256__kernel(half* __restrict__ compute_intermediate, float* __restrict__ lv6, float* __restrict__ param_1, float* __restrict__ param_2, int64_t n) {
