...
#endif
extern "C" __global__ void __launch_bounds__(128) fused_layer_norm_cast1_kernel(half* __restrict__ compute_intermediate, float* __restrict__ lv6, float* __restrict__ param_1, float* __restrict__ param_2, int64_t n);
extern "C" __global__ void __launch_bounds__(128) fused_layer_norm_cast1_kernel(half* __restrict__ compute_intermediate, float* __restrict__ lv6, float* __restrict__ param_1, float* __restrict__ param_2, int64_t n) {
