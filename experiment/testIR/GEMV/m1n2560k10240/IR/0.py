        ...
        for u_fused_ax0_fused_fused_0 in T.thread_binding(160, thread="blockIdx.x"):
            for u_fused_ax0_fused_fused_1 in T.thread_binding(16, thread="threadIdx.y"):
                for ax1_fused_u_fused_1_ax1_fused_u_fused_3_fused_0 in T.thread_binding(32, thread="threadIdx.x"):
                    ...
                    for ax1_fused_u_fused_0 in T.serial(20, annotations={"pragma_auto_unroll_max_step": 256, "pragma_unroll_explicit": 1}):
                        for ax0_0, ax1 in T.grid(1, 16):
                            for ax0_1 in T.vectorized(1):
                                with T.block("lv3_local"):
                                    ...
                                    v1 = T.axis.spatial(10240, ax1_fused_u_fused_0 * 512 + ax1_fused_u_fused_1_ax1_fused_u_fused_3_fused_0 * 16 + ax1)
                                    T.reads(lv3[v0, v1])
                                    T.writes(lv3_local[v0, v1])
                                    lv3_local[v0, v1] = lv3[v0, v1]
                        for u_fused_ax0_fused_fused_2, ax1_fused_u_fused_2 in T.grid(1, 4):
                            for ax1_fused_u_fused_1_ax1_fused_u_fused_3_fused_1 in T.vectorized(4):
                                with T.block("NT_matmul_rf_update"):
                                    ...
                                    T.reads(var_NT_matmul_intermediate_rf_local[vax1_fused_u_fused_1_ax1_fused_u_fused_3_fused, 0, 0, v0], lv9_shared[0, 0, vax1_fused_u_fused_0 * 512 + vax1_fused_u_fused_1_ax1_fused_u_fused_3_fused // 4 * 16 + vax1_fused_u_fused_2 * 4 + vax1_fused_u_fused_1_ax1_fused_u_fused_3_fused % 4], lv3_local[v0, vax1_fused_u_fused_0 * 512 + vax1_fused_u_fused_1_ax1_fused_u_fused_3_fused // 4 * 16 + vax1_fused_u_fused_2 * 4 + vax1_fused_u_fused_1_ax1_fused_u_fused_3_fused % 4])
                                    T.writes(var_NT_matmul_intermediate_rf_local[vax1_fused_u_fused_1_ax1_fused_u_fused_3_fused, 0, 0, v0])
                                    var_NT_matmul_intermediate_rf_local[vax1_fused_u_fused_1_ax1_fused_u_fused_3_fused, 0, 0, v0] = var_NT_matmul_intermediate_rf_local[vax1_fused_u_fused_1_ax1_fused_u_fused_3_fused, 0, 0, v0] + lv9_shared[0, 0, vax1_fused_u_fused_0 * 512 + vax1_fused_u_fused_1_ax1_fused_u_fused_3_fused // 4 * 16 + vax1_fused_u_fused_2 * 4 + vax1_fused_u_fused_1_ax1_fused_u_fused_3_fused % 4] * lv3_local[v0, vax1_fused_u_fused_0 * 512 + vax1_fused_u_fused_1_ax1_fused_u_fused_3_fused // 4 * 16 + vax1_fused_u_fused_2 * 4 + vax1_fused_u_fused_1_ax1_fused_u_fused_3_fused % 4]
