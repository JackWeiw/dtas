            ...
            for u_fused_ax0_fused_fused_1 in T.thread_binding(16, thread="threadIdx.y"):
                for ax1_fused_u_fused_1_ax1_fused_u_fused_3_fused_0 in T.thread_binding(32, thread="threadIdx.x"):
                    for ax0, ax1 in T.grid(1, 1):
                        for ax2_0 in T.serial(3, annotations={"pragma_unroll_explicit": 256, "pragma_vectorize": 1}):
                                ...
                                for ax2_2 in T.thread_binding(32, thread="threadIdx.x"):
                                    for ax2_3 in T.vectorized(8):
                                        with T.block("lv9_shared"):
                                            ...
                                            v2 = T.axis.spatial(10240, ax2_0 * 4096 + ax2_1 * 256 + ax2_2 * 8 + ax2_3)
                                            T.where(((ax2_0 * 16 + ax2_1) * 32 + ax2_2) * 8 + ax2_3 < 10240)
                        ...
                        for u_fused_ax0_fused_fused_2, ax1_fused_u_fused_2 in T.grid(1, 1):
                            for ax1_fused_u_fused_1_ax1_fused_u_fused_3_fused_1 in T.vectorized(8):
                                with T.block("NT_matmul_rf_update"):
                                    ...
                                    T.reads(var_NT_matmul_intermediate_rf_local[vax1_fused_u_fused_1_ax1_fused_u_fused_3_fused, 0, 0, v0], lv9_shared[0, 0, vax1_fused_u_fused_0 * 4 + vax1_fused_u_fused_1_ax1_fused_u_fused_3_fused // 64, vax1_fused_u_fused_1_ax1_fused_u_fused_3_fused % 64], lv3_local[v0, vax1_fused_u_fused_0 * 256 + vax1_fused_u_fused_2 * 8 + vax1_fused_u_fused_1_ax1_fused_u_fused_3_fused])
                                    T.writes(var_NT_matmul_intermediate_rf_local[vax1_fused_u_fused_1_ax1_fused_u_fused_3_fused, 0, 0, v0])
                                    var_NT_matmul_intermediate_rf_local[vax1_fused_u_fused_1_ax1_fused_u_fused_3_fused, 0, 0, v0] = var_NT_matmul_intermediate_rf_local[vax1_fused_u_fused_1_ax1_fused_u_fused_3_fused, 0, 0, v0] + lv9_shared[0, 0, vax1_fused_u_fused_0 * 4 + vax1_fused_u_fused_1_ax1_fused_u_fused_3_fused // 64, vax1_fused_u_fused_1_ax1_fused_u_fused_3_fused % 64] * lv3_local[v0, vax1_fused_u_fused_0 * 256 + vax1_fused_u_fused_2 * 8 + vax1_fused_u_fused_1_ax1_fused_u_fused_3_fused]
