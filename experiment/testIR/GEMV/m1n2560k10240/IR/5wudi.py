...
class Module:
    ...
    def main(lv9: T.Buffer((1, 1, 10240), "float16"), lv3: T.Buffer((2560, 10240), "float16"), lv4: T.Buffer((2560,), "float16"), var_T_add_intermediate: T.Buffer((1, 1, 2560), "float16")):
        ...
        var_NT_matmul_intermediate_rf_local = T.alloc_buffer((256, 1, 1, 2560), "float16", scope="local")
        ...
        lv9_shared = T.alloc_buffer((1, 1, 1280, 8), "float16", scope="shared")
                ...
                for ax1_fused_u_fused_1_ax1_fused_u_fused_3_fused_0 in T.thread_binding(32, thread="threadIdx.x"):
                                ...
                                for ax2_2 in T.thread_binding(32, thread="threadIdx.x"):
                                    for ax2_3 in T.vectorized(8):
                                        with T.block("lv9_shared"):
                                            ...
                                            T.writes(lv9_shared[v0, v1, v2 // 8, v2 % 8])
                                            T.block_attr({"buffer_dim_align": [[0, 2, 16, 8]]})
                                            lv9_shared[v0, v1, v2 // 8, v2 % 8] = lv9[v0, v1, v2]
                    for u_fused_ax0_fused_fused_2_init in range(1):
                        for ax1_fused_u_fused_1_ax1_fused_u_fused_3_fused_1_init in T.vectorized(8):
                            with T.block("NT_matmul_rf_init"):
                                vax1_fused_u_fused_1_ax1_fused_u_fused_3_fused = T.axis.spatial(256, ax1_fused_u_fused_1_ax1_fused_u_fused_3_fused_0 * 8 + ax1_fused_u_fused_1_ax1_fused_u_fused_3_fused_1_init)
                    ...
                    for ax1_fused_u_fused_0 in T.serial(40, annotations={"pragma_auto_unroll_max_step": 256, "pragma_unroll_explicit": 1}):
                        ...
                        for u_fused_ax0_fused_fused_2, ax1_fused_u_fused_2 in T.grid(1, 1):
                            for ax1_fused_u_fused_1_ax1_fused_u_fused_3_fused_1 in T.vectorized(8):
                                with T.block("NT_matmul_rf_update"):
                                    vax1_fused_u_fused_1_ax1_fused_u_fused_3_fused = T.axis.spatial(256, ax1_fused_u_fused_1_ax1_fused_u_fused_3_fused_0 * 8 + ax1_fused_u_fused_1_ax1_fused_u_fused_3_fused_1)
                                    ...
                                    T.reads(var_NT_matmul_intermediate_rf_local[vax1_fused_u_fused_1_ax1_fused_u_fused_3_fused, 0, 0, v0], lv9_shared[0, 0, vax1_fused_u_fused_0 * 32 + vax1_fused_u_fused_1_ax1_fused_u_fused_3_fused // 8, vax1_fused_u_fused_1_ax1_fused_u_fused_3_fused % 8], lv3_local[v0, vax1_fused_u_fused_0 * 256 + vax1_fused_u_fused_2 * 8 + vax1_fused_u_fused_1_ax1_fused_u_fused_3_fused])
                                    T.writes(var_NT_matmul_intermediate_rf_local[vax1_fused_u_fused_1_ax1_fused_u_fused_3_fused, 0, 0, v0])
                                    var_NT_matmul_intermediate_rf_local[vax1_fused_u_fused_1_ax1_fused_u_fused_3_fused, 0, 0, v0] = var_NT_matmul_intermediate_rf_local[vax1_fused_u_fused_1_ax1_fused_u_fused_3_fused, 0, 0, v0] + lv9_shared[0, 0, vax1_fused_u_fused_0 * 32 + vax1_fused_u_fused_1_ax1_fused_u_fused_3_fused // 8, vax1_fused_u_fused_1_ax1_fused_u_fused_3_fused % 8] * lv3_local[v0, vax1_fused_u_fused_0 * 256 + vax1_fused_u_fused_2 * 8 + vax1_fused_u_fused_1_ax1_fused_u_fused_3_fused]
                        ...
                        for ax2_fused_1_1 in T.vectorized(1):
                            ...
                            for ax1 in range(8):
                                with T.block("NT_matmul_rf_update"):
                                    ...
                                    v0 = T.axis.spatial(2560, u_fused_ax0_fused_fused_0 * 32 + ax2_fused_0 + ax2_fused_1_0 + ax2_fused_1_1)
                                    T.reads(var_NT_matmul_intermediate_rf_local_1[vax1_fused_u_fused_1_ax1_fused_u_fused_3_fused_0, 0, 0, v0], var_NT_matmul_intermediate_rf_local[vax1_fused_u_fused_1_ax1_fused_u_fused_3_fused_0 * 8 + vax1_fused_u_fused_1_ax1_fused_u_fused_3_fused_1, 0, 0, v0])
                                    T.writes(var_NT_matmul_intermediate_rf_local_1[vax1_fused_u_fused_1_ax1_fused_u_fused_3_fused_0, 0, 0, v0])
                                    var_NT_matmul_intermediate_rf_local_1[vax1_fused_u_fused_1_ax1_fused_u_fused_3_fused_0, 0, 0, v0] = var_NT_matmul_intermediate_rf_local_1[vax1_fused_u_fused_1_ax1_fused_u_fused_3_fused_0, 0, 0, v0] + var_NT_matmul_intermediate_rf_local[vax1_fused_u_fused_1_ax1_fused_u_fused_3_fused_0 * 8 + vax1_fused_u_fused_1_ax1_fused_u_fused_3_fused_1, 0, 0, v0]
