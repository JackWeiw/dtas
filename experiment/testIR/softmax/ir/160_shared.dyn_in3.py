...
class Module:
    ...
    def main(p_lv38: T.handle, p_output0: T.handle):
        ...
        for ax0_ax1_fused in T.thread_binding(n * T.int64(32), thread="blockIdx.x"):
            for ax0, ax1, ax2, ax3_0 in T.grid(T.int64(1), T.int64(1), T.int64(1), (T.max(T.int64(1), (m + T.int64(159)) // T.int64(160) * T.int64(160)) + T.int64(479) - T.min(T.int64(0), (m + T.int64(159)) // T.int64(160) * T.int64(160) - T.int64(1))) // T.int64(480)):
                for ax3_1 in T.thread_binding(T.int64(160), thread="threadIdx.x"):
                    for ax3_2 in T.vectorized(T.int64(3)):
                        with T.block("lv38_shared.dyn"):
                            ...
                            v3 = T.axis.spatial(m, ax3_0 * T.int64(480) + ax3_1 * T.int64(3) + ax3_2 + (T.int64(0) - (T.int64(0) - T.min(T.int64(0), (m + T.int64(159)) // T.int64(160) * T.int64(160) - T.int64(1)))) + (T.min(T.int64(0), (m + T.int64(159)) // T.int64(160) * T.int64(160) - T.int64(1)) + T.max(T.int64(0) - T.min(T.int64(0), (m + T.int64(159)) // T.int64(160) * T.int64(160) - T.int64(1)), T.int64(0))))
                            T.where(T.int64(0) <= T.min(T.int64(0), (m + T.int64(159)) // T.int64(160) * T.int64(160) - T.int64(1)) + ((ax3_0 * T.int64(160) + ax3_1) * T.int64(3) + ax3_2) and T.min(T.int64(0), (m + T.int64(159)) // T.int64(160) * T.int64(160) - T.int64(1)) + ((ax3_0 * T.int64(160) + ax3_1) * T.int64(3) + ax3_2) < m and (ax3_0 * T.int64(160) + ax3_1) * T.int64(3) + ax3_2 < T.max(T.int64(1), (m + T.int64(159)) // T.int64(160) * T.int64(160)) - T.min(T.int64(0), (m + T.int64(159)) // T.int64(160) * T.int64(160) - T.int64(1)))
...
save_to_json(
    result,
    "/home/weitao/XIAG8XX/profile/testIR/softmax/data/32*400/160_in3.json",
)                                                                             