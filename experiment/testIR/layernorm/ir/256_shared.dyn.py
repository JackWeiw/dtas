...
save_to_json(
    result,
    "/home/weitao/XIAG8XX/profile/testIR/layernorm/data/2560_hid/224_shared.dyn.json",
)             
...
# pass_list = []
# pass_list.append(tir.transform.VerifyVTCMLimit(target)) 
# # pass_list.append(tir.transform.LowerVtcmAlloc())
# pass_list.append(tir.transform.BindTarget(target))
# pass_list.append(tir.transform.VerifyMemory())  
# # pass_list.append(tir.transform.ThreadSync("shared"))
# pass_list.append(tir.transform.ThreadSync("shared.dyn"))        

# pass_seq = tvm.ir.transform.Sequential(pass_list)
# mod = pass_seq(mod)                                        
