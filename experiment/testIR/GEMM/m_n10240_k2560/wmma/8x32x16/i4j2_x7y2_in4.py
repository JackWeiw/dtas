            ...
            for ax1_0_0_ax2_0_0_fused in T.thread_binding((n + T.int64(895)) // T.int64(896) * T.int64(4), thread="blockIdx.x"):
                for ax1_0_1_ax2_0_1_fused in T.thread_binding(T.int64(80), thread="blockIdx.y"):
                    for ax2_0_2_ax1_0_2_fused in T.thread_binding(T.int64(8), thread="threadIdx.y"):
                        for ax1_0_3_init, ax2_0_3_init in T.grid(T.int64(7), T.int64(2)):
                            with T.block("NT_matmul_o_init"):
                                v0_o = T.axis.spatial(T.int64(1), ax0)
                                v1_o = T.axis.spatial((n + T.int64(895)) // T.int64(896) * T.int64(112), ax1_0_0_ax2_0_0_fused * T.int64(28) + ax2_0_2_ax1_0_2_fused % T.int64(4) * T.int64(7) + ax1_0_3_init)
                        ...
                        for ax3_0_0 in T.serial(T.int64(40), annotations={"software_pipeline_order": [0, 3, 1, 4, 5, 2, 6], "software_pipeline_stage": [0, 0, 0, 0, 0, 1, 1]}):
                            for ax0_1, ax1_ax2_fused_0_0_0 in T.grid(T.int64(1), T.int64(14)):
                                    ...
                                    for ax1_ax2_fused_0_1 in T.thread_binding(T.int64(32), thread="threadIdx.x"):
                                        for ax1_ax2_fused_1 in T.vectorized(T.int64(4), annotations={"check_vector_load": 1, "remove_vector_condition": 1}):
                                            with T.block("lv55_reindex_pad_shared.dyn"):
                                                ...
                                                v1 = T.axis.spatial((n + T.int64(895)) // T.int64(896) * T.int64(896), ax1_0_0_ax2_0_0_fused * T.int64(224) + (ax1_ax2_fused_0_0_0 * T.int64(1024) + ax1_ax2_fused_0_0_1 * T.int64(128) + ax1_ax2_fused_0_1 * T.int64(4) + ax1_ax2_fused_1) // T.int64(64))
                            ...
                            for ax3_0_1 in T.serial(T.int64(4), annotations={"software_pipeline_order": [0, 1, 2], "software_pipeline_stage": [0, 0, 1]}):
                                for ax0_0 in T.unroll(T.int64(7)):
                                    for ax1_0 in T.unroll(T.int64(1)):
                                        with T.block("lv55_reindex_pad_shared.dyn_wmma.matrix_a_o"):
                                            ...
                                            v1_o = T.axis.spatial(T.int64(28) * ((n + T.int64(895)) // T.int64(896) * T.int64(4)), ax1_0_0_ax2_0_0_fused * T.int64(28) + ax2_0_2_ax1_0_2_fused % T.int64(4) * T.int64(7) + ax0_0)
                                ...
                                for ax1_0_3, ax2_0_3 in T.grid(T.int64(7), T.int64(2)):
                                    with T.block("NT_matmul_o_update"):
                                        v0_o = T.axis.spatial(T.int64(1), ax0)
                                        v1_o = T.axis.spatial((n + T.int64(895)) // T.int64(896) * T.int64(112), ax1_0_0_ax2_0_0_fused * T.int64(28) + ax2_0_2_ax1_0_2_fused % T.int64(4) * T.int64(7) + ax1_0_3)
                        ...
                        for ax0_0, ax1_0 in T.grid(T.int64(7), T.int64(2)):
                            ...
                            for ax0_ax1_fused_1 in T.thread_binding(T.int64(32), thread="threadIdx.x"):
                                for ax0_ax1_fused_2 in T.vectorized(T.int64(4)):
                                    with T.block("var_NT_matmul_intermediate_reindex_pad_shared.dyn"):
                                        ...
                                        v1 = T.axis.spatial((n + T.int64(895)) // T.int64(896) * T.int64(896), ax1_0_0_ax2_0_0_fused * T.int64(224) + ax2_0_2_ax1_0_2_fused % T.int64(4) * T.int64(56) + (ax0_ax1_fused_0 * T.int64(128) + ax0_ax1_fused_1 * T.int64(4) + ax0_ax1_fused_2) // T.int64(64))
...
save_to_json(result,"/home/weitao/XIAG8XX/profile/testIR/m_n10240_k2560/data/8x32x16/i4j2_x7y2_in4.json")                                               