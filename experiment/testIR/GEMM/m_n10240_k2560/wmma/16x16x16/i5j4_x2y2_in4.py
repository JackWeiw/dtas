...
class Module:
    ...
    def main(p_lv55: T.handle, lv11: T.Buffer((T.int64(10240), T.int64(2560)), "float16"), lv12: T.Buffer((T.int64(10240),), "float16"), p_output0: T.handle):
        ...
        var_NT_matmul_intermediate_reindex_pad_shared_dyn = T.alloc_buffer((T.int64(1), (n + T.int64(159)) // T.int64(160) * T.int64(160), T.int64(10240)), "float16", scope="shared.dyn")
        var_NT_matmul_intermediate_reindex_pad_shared_dyn_wmma_accumulator = T.alloc_buffer((T.int64(1), (n + T.int64(159)) // T.int64(160) * T.int64(160), T.int64(10240)), "float16", scope="wmma.accumulator")
                    ...
                    for ax2_0_2_ax1_0_2_fused in T.thread_binding(T.int64(20), thread="threadIdx.y"):
                        for ax1_0_3_init, ax2_0_3_init in T.grid(T.int64(2), T.int64(2)):
                            with T.block("NT_matmul_o_init"):
                                ...
                                v2_o = T.axis.spatial(T.int64(640), ax1_0_1_ax2_0_1_fused * T.int64(8) + ax2_0_2_ax1_0_2_fused // T.int64(5) * T.int64(2) + ax2_0_3_init)
                                T.reads()
                                    ...
                                    for ax1_ax2_fused_0_1 in T.thread_binding(T.int64(32), thread="threadIdx.x"):
                                        for ax1_ax2_fused_1 in T.vectorized(T.int64(4), annotations={"check_vector_load": 1, "remove_vector_condition": 1}):
                                            with T.block("lv11_reindex_shared.dyn"):
                                                v0 = T.axis.spatial(T.int64(1), ax0_1)
                                                v1 = T.axis.spatial(T.int64(10240), ax1_0_1_ax2_0_1_fused * T.int64(128) + ((ax1_ax2_fused_0_0_0 * T.int64(20) + ax1_ax2_fused_0_0_1) * T.int64(128) + ax1_ax2_fused_0_1 * T.int64(4) + ax1_ax2_fused_1) // T.int64(64))
                                                ...
                                                T.where(ax1_ax2_fused_0_0_0 * T.int64(20) + ax1_ax2_fused_0_0_1 < T.int64(64))
                                                T.reads(lv11[v1, v2])
                            ...
                            for ax3_0_1 in T.serial(T.int64(4), annotations={"software_pipeline_order": [0, 1, 2], "software_pipeline_stage": [0, 0, 1]}):
                                ...
                                for ax0_0 in T.unroll(T.int64(2)):
                                    for ax1_0 in T.unroll(T.int64(1)):
                                        with T.block("lv11_reindex_shared.dyn_wmma.matrix_b_o"):
                                            v0_o = T.axis.spatial(T.int64(1), T.int64(0))
                                            v1_o = T.axis.spatial(T.int64(640), ax1_0_1_ax2_0_1_fused * T.int64(8) + ax2_0_2_ax1_0_2_fused // T.int64(5) * T.int64(2) + ax0_0)
                                            v2_o = T.axis.spatial(T.int64(160), ax3_0_0 * T.int64(4) + ax3_0_1 + ax1_0)
                                ...
                                for ax1_0_3, ax2_0_3 in T.grid(T.int64(2), T.int64(2)):
                                    with T.block("NT_matmul_o_update"):
                                        ...
                                        v2_o = T.axis.spatial(T.int64(640), ax1_0_1_ax2_0_1_fused * T.int64(8) + ax2_0_2_ax1_0_2_fused // T.int64(5) * T.int64(2) + ax2_0_3)
                        ...
                        for ax0_0, ax1_0 in T.grid(T.int64(2), T.int64(2)):
                            with T.block("var_NT_matmul_intermediate_reindex_pad_shared.dyn_wmma.accumulator_o"):
                                v0_o = T.axis.spatial(T.int64(1), T.int64(0))
                                v1_o = T.axis.spatial(T.int64(10) * ((n + T.int64(159)) // T.int64(160)), ax1_0_0_ax2_0_0_fused * T.int64(10) + ax2_0_2_ax1_0_2_fused % T.int64(5) * T.int64(2) + ax0_0)
                                v2_o = T.axis.spatial(T.int64(640), ax1_0_1_ax2_0_1_fused * T.int64(8) + ax2_0_2_ax1_0_2_fused // T.int64(5) * T.int64(2) + ax1_0)
                            ...
                            for ax0_ax1_fused_1 in T.thread_binding(T.int64(32), thread="threadIdx.x"):
                                for ax0_ax1_fused_2 in T.vectorized(T.int64(4)):
                                    with T.block("var_NT_matmul_intermediate_reindex_pad_shared.dyn"):
                                        ...
                                        v1 = T.axis.spatial((n + T.int64(159)) // T.int64(160) * T.int64(160), ax1_0_0_ax2_0_0_fused * T.int64(160) + ax2_0_2_ax1_0_2_fused % T.int64(5) * T.int64(32) + (ax0_ax1_fused_0 * T.int64(128) + ax0_ax1_fused_1 * T.int64(4) + ax0_ax1_fused_2) // T.int64(32))
                                        v2 = T.axis.spatial(T.int64(10240), ax1_0_1_ax2_0_1_fused * T.int64(128) + ax2_0_2_ax1_0_2_fused // T.int64(5) * T.int64(32) + (ax0_ax1_fused_0 * T.int64(128) + ax0_ax1_fused_1 * T.int64(4) + ax0_ax1_fused_2) % T.int64(32))
...
save_to_json(
    result,
    "/home/weitao/XIAG8XX/profile/testIR/m_n10240_k2560/data/16x16x16/i5j4_x2y2_in4.json",
)
