...
class Module:
    ...
    def main(p_lv55: T.handle, lv11: T.Buffer((T.int64(10240), T.int64(2560)), "float16"), lv12: T.Buffer((T.int64(10240),), "float16"), p_output0: T.handle):
        ...
        # with T.block("root"):
        lv55_reindex_pad_shared_dyn = T.alloc_buffer((T.int64(1), (n + T.int64(127)) // T.int64(128) * T.int64(128), T.int64(2560)), "float16", scope="shared.dyn")
        lv11_reindex_pad_shared_dyn = T.alloc_buffer((T.int64(1), T.int64(10368), T.int64(2560)), "float16", scope="shared.dyn")
        lv55_reindex_pad_shared_dyn_wmma_matrix_a = T.alloc_buffer((T.int64(1), (n + T.int64(127)) // T.int64(128) * T.int64(128), T.int64(2560)), "float16", scope="wmma.matrix_a")
        ...
        var_NT_matmul_intermediate_reindex_pad_shared_dyn = T.alloc_buffer((T.int64(1), (n + T.int64(127)) // T.int64(128) * T.int64(128), T.int64(10368)), "float16", scope="shared.dyn")
        var_NT_matmul_intermediate_reindex_pad_shared_dyn_wmma_accumulator = T.alloc_buffer((T.int64(1), (n + T.int64(127)) // T.int64(128) * T.int64(128), T.int64(10368)), "float16", scope="wmma.accumulator")
                                    ...
                                    for ax1_ax2_fused_0_1 in T.thread_binding(T.int64(32), thread="threadIdx.x"):
                                        for ax1_ax2_fused_1 in T.vectorized(T.int64(4), annotations={"check_vector_load": 1, "remove_vector_condition": 1}):
                                            with T.block("lv55_reindex_pad_shared.dyn"):
                                                ...
                                                v1 = T.axis.spatial((n + T.int64(127)) // T.int64(128) * T.int64(128), ax1_0_0_ax2_0_0_fused * T.int64(128) + (ax1_ax2_fused_0_0_0 * T.int64(1024) + ax1_ax2_fused_0_0_1 * T.int64(128) + ax1_ax2_fused_0_1 * T.int64(4) + ax1_ax2_fused_1) // T.int64(64))
                            ...
                            for ax0_ax1_fused_1 in T.thread_binding(T.int64(32), thread="threadIdx.x"):
                                for ax0_ax1_fused_2 in T.vectorized(T.int64(4)):
                                    with T.block("var_NT_matmul_intermediate_reindex_pad_shared.dyn"):
                                        ...
                                        v1 = T.axis.spatial((n + T.int64(127)) // T.int64(128) * T.int64(128), ax1_0_0_ax2_0_0_fused * T.int64(128) + ax2_0_2_ax1_0_2_fused % T.int64(2) * T.int64(64) + (ax0_ax1_fused_0 * T.int64(128) + ax0_ax1_fused_1 * T.int64(4) + ax0_ax1_fused_2) // T.int64(48))
...
save_to_json(
    result,
    "/home/weitao/XIAG8XX/profile/testIR/m_n10240_k2560/data/16x16x16/i2j4_x4y3_in4.json",
)                                                                                                                    