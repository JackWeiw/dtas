...
class Module:
    ...
    def main(p_lv55: T.handle, lv11: T.Buffer((T.int64(10240), T.int64(2560)), "float16"), lv12: T.Buffer((T.int64(10240),), "float16"), p_output0: T.handle):
        ...
        # with T.block("root"):
        lv55_reindex_pad_shared_dyn = T.alloc_buffer((T.int64(1), (n + T.int64(159)) // T.int64(160) * T.int64(160), T.int64(2560)), "float16", scope="shared.dyn")
        lv11_reindex_pad_shared_dyn = T.alloc_buffer((T.int64(1), T.int64(10368), T.int64(2560)), "float16", scope="shared.dyn")
        lv55_reindex_pad_shared_dyn_wmma_matrix_a = T.alloc_buffer((T.int64(1), (n + T.int64(159)) // T.int64(160) * T.int64(160), T.int64(2560)), "float16", scope="wmma.matrix_a")
        lv11_reindex_pad_shared_dyn_wmma_matrix_b = T.alloc_buffer((T.int64(1), T.int64(10368), T.int64(2560)), "float16", scope="wmma.matrix_b")
        var_NT_matmul_intermediate_reindex_pad_shared_dyn = T.alloc_buffer((T.int64(1), (n + T.int64(159)) // T.int64(160) * T.int64(160), T.int64(10368)), "float16", scope="shared.dyn")
        var_NT_matmul_intermediate_reindex_pad_shared_dyn_wmma_accumulator = T.alloc_buffer((T.int64(1), (n + T.int64(159)) // T.int64(160) * T.int64(160), T.int64(10368)), "float16", scope="wmma.accumulator")
        for ax0 in T.thread_binding(T.int64(1), thread="blockIdx.z"):
            for ax1_0_0_ax2_0_0_fused in T.thread_binding((n + T.int64(159)) // T.int64(160), thread="blockIdx.x"):
                for ax1_0_1_ax2_0_1_fused in T.thread_binding(T.int64(54), thread="blockIdx.y"):
                    for ax2_0_2_ax1_0_2_fused in T.thread_binding(T.int64(8), thread="threadIdx.y"):
                        for ax1_0_3_init, ax2_0_3_init in T.grid(T.int64(5), T.int64(3)):
                            with T.block("NT_matmul_o_init"):
                                v0_o = T.axis.spatial(T.int64(1), ax0)
                                v1_o = T.axis.spatial((n + T.int64(159)) // T.int64(160) * T.int64(10), ax1_0_0_ax2_0_0_fused * T.int64(10) + ax2_0_2_ax1_0_2_fused % T.int64(2) * T.int64(5) + ax1_0_3_init)
                                v2_o = T.axis.spatial(T.int64(648), ax1_0_1_ax2_0_1_fused * T.int64(12) + ax2_0_2_ax1_0_2_fused // T.int64(2) * T.int64(3) + ax2_0_3_init)
                                T.reads()
                        ...
                        for ax3_0_0 in T.serial(T.int64(40), annotations={"software_pipeline_order": [0, 3, 1, 4, 5, 2, 6], "software_pipeline_stage": [0, 0, 0, 0, 0, 1, 1]}):
                                    ...
                                    for ax1_ax2_fused_0_1 in T.thread_binding(T.int64(32), thread="threadIdx.x"):
                                        for ax1_ax2_fused_1 in T.vectorized(T.int64(4), annotations={"check_vector_load": 1, "remove_vector_condition": 1}):
                                            with T.block("lv55_reindex_pad_shared.dyn"):
                                                ...
                                                v1 = T.axis.spatial((n + T.int64(159)) // T.int64(160) * T.int64(160), ax1_0_0_ax2_0_0_fused * T.int64(160) + (ax1_ax2_fused_0_0_0 * T.int64(1024) + ax1_ax2_fused_0_0_1 * T.int64(128) + ax1_ax2_fused_0_1 * T.int64(4) + ax1_ax2_fused_1) // T.int64(64))
                            ...
                            for ax0_1, ax1_ax2_fused_0_0_0 in T.grid(T.int64(1), T.int64(12)):
                                for ax1_ax2_fused_0_0_1 in T.thread_binding(T.int64(8), thread="threadIdx.y"):
                                    for ax1_ax2_fused_0_1 in T.thread_binding(T.int64(32), thread="threadIdx.x"):
                                        for ax1_ax2_fused_1 in T.vectorized(T.int64(4), annotations={"check_vector_load": 1, "remove_vector_condition": 1}):
                                            with T.block("lv11_reindex_pad_shared.dyn"):
                                                v0 = T.axis.spatial(T.int64(1), ax0_1)
                                                v1 = T.axis.spatial(T.int64(10368), ax1_0_1_ax2_0_1_fused * T.int64(192) + (ax1_ax2_fused_0_0_0 * T.int64(1024) + ax1_ax2_fused_0_0_1 * T.int64(128) + ax1_ax2_fused_0_1 * T.int64(4) + ax1_ax2_fused_1) // T.int64(64))
                                                v2 = T.axis.spatial(T.int64(2560), ax3_0_0 * T.int64(64) + (ax1_ax2_fused_0_0_0 * T.int64(1024) + ax1_ax2_fused_0_0_1 * T.int64(128) + ax1_ax2_fused_0_1 * T.int64(4) + ax1_ax2_fused_1) % T.int64(64))
                                                T.reads(lv11[v1, v2])
                                                T.writes(lv11_reindex_pad_shared_dyn[v0, v1, v2])
                                                T.block_attr({"buffer_dim_align": [[0, 1, 16, 8]], "double_buffer_scope": 0, "tir.manifest_shared_memory_local_stage": 1})
                                                lv11_reindex_pad_shared_dyn[v0, v1, v2] = T.if_then_else(v1 < T.int64(10240), lv11[v1, v2], T.float16(0))
                            for ax3_0_1 in T.serial(T.int64(4), annotations={"software_pipeline_order": [0, 1, 2], "software_pipeline_stage": [0, 0, 1]}):
                                for ax0_0 in T.unroll(T.int64(5)):
                                    for ax1_0 in T.unroll(T.int64(1)):
                                        with T.block("lv55_reindex_pad_shared.dyn_wmma.matrix_a_o"):
                                            ...
                                            v1_o = T.axis.spatial(T.int64(10) * ((n + T.int64(159)) // T.int64(160)), ax1_0_0_ax2_0_0_fused * T.int64(10) + ax2_0_2_ax1_0_2_fused % T.int64(2) * T.int64(5) + ax0_0)
                                ...
                                for ax0_0 in T.unroll(T.int64(3)):
                                    for ax1_0 in T.unroll(T.int64(1)):
                                        with T.block("lv11_reindex_pad_shared.dyn_wmma.matrix_b_o"):
                                            v0_o = T.axis.spatial(T.int64(1), T.int64(0))
                                            v1_o = T.axis.spatial(T.int64(648), ax1_0_1_ax2_0_1_fused * T.int64(12) + ax2_0_2_ax1_0_2_fused // T.int64(2) * T.int64(3) + ax0_0)
                                            v2_o = T.axis.spatial(T.int64(160), ax3_0_0 * T.int64(4) + ax3_0_1 + ax1_0)
                                            T.reads(lv11_reindex_pad_shared_dyn[v0_o, v1_o * T.int64(16):v1_o * T.int64(16) + T.int64(16), v2_o * T.int64(16):v2_o * T.int64(16) + T.int64(16)])
                                            T.writes(lv11_reindex_pad_shared_dyn_wmma_matrix_b[v0_o, v1_o * T.int64(16):v1_o * T.int64(16) + T.int64(16), v2_o * T.int64(16):v2_o * T.int64(16) + T.int64(16)])
                                            A = T.match_buffer(lv11_reindex_pad_shared_dyn[v0_o, v1_o * T.int64(16):v1_o * T.int64(16) + T.int64(16), v2_o * T.int64(16):v2_o * T.int64(16) + T.int64(16)], (T.int64(16), T.int64(16)), "float16", strides=("A_s0", "A_s1"), scope="shared.dyn", offset_factor=16)
                                            C = T.match_buffer(lv11_reindex_pad_shared_dyn_wmma_matrix_b[v0_o, v1_o * T.int64(16):v1_o * T.int64(16) + T.int64(16), v2_o * T.int64(16):v2_o * T.int64(16) + T.int64(16)], (T.int64(16), T.int64(16)), "float16", strides=("C_s0", "C_s1"), scope="wmma.matrix_b", offset_factor=16)
                                ...
                                for ax1_0_3, ax2_0_3 in T.grid(T.int64(5), T.int64(3)):
                                    with T.block("NT_matmul_o_update"):
                                        ...
                                        with T.block("NT_matmul_o"):
                                            ...
                                            B = T.match_buffer(lv11_reindex_pad_shared_dyn_wmma_matrix_b[T.int64(0), v2_o * T.int64(16):v2_o * T.int64(16) + T.int64(16), v3_o * T.int64(16):v3_o * T.int64(16) + T.int64(16)], (T.int64(16), T.int64(16)), "float16", strides=("B_s0", "B_s1"), scope="wmma.matrix_b", offset_factor=16)
                                            C = T.match_buffer(var_NT_matmul_intermediate_reindex_pad_shared_dyn_wmma_accumulator[T.int64(0), v1_o * T.int64(16):v1_o * T.int64(16) + T.int64(16), v2_o * T.int64(16):v2_o * T.int64(16) + T.int64(16)], (T.int64(16), T.int64(16)), "float16", strides=("C_s0", "C_s1"), scope="wmma.accumulator", offset_factor=16)
                        ...
                        for ax0_0, ax1_0 in T.grid(T.int64(5), T.int64(3)):
                            with T.block("var_NT_matmul_intermediate_reindex_pad_shared.dyn_wmma.accumulator_o"):
                                v0_o = T.axis.spatial(T.int64(1), T.int64(0))
                                v1_o = T.axis.spatial(T.int64(10) * ((n + T.int64(159)) // T.int64(160)), ax1_0_0_ax2_0_0_fused * T.int64(10) + ax2_0_2_ax1_0_2_fused % T.int64(2) * T.int64(5) + ax0_0)
                                v2_o = T.axis.spatial(T.int64(648), ax1_0_1_ax2_0_1_fused * T.int64(12) + ax2_0_2_ax1_0_2_fused // T.int64(2) * T.int64(3) + ax1_0)
                        ...
                        for ax0_ax1_fused_0 in range(T.int64(30)):
                            for ax0_ax1_fused_1 in T.thread_binding(T.int64(32), thread="threadIdx.x"):
                                for ax0_ax1_fused_2 in T.vectorized(T.int64(4)):
                                    with T.block("var_NT_matmul_intermediate_reindex_pad_shared.dyn"):
                                        ...
                                        v1 = T.axis.spatial((n + T.int64(159)) // T.int64(160) * T.int64(160), ax1_0_0_ax2_0_0_fused * T.int64(160) + ax2_0_2_ax1_0_2_fused % T.int64(2) * T.int64(80) + (ax0_ax1_fused_0 * T.int64(128) + ax0_ax1_fused_1 * T.int64(4) + ax0_ax1_fused_2) // T.int64(48))
                                        v2 = T.axis.spatial(T.int64(10368), ax1_0_1_ax2_0_1_fused * T.int64(192) + ax2_0_2_ax1_0_2_fused // T.int64(2) * T.int64(48) + (ax0_ax1_fused_0 * T.int64(128) + ax0_ax1_fused_1 * T.int64(4) + ax0_ax1_fused_2) % T.int64(48))
...
for i in range(4096, 4097):
    ...
    weight = tvm.nd.array(
        np.random.uniform(0, 1, (4 * hidden_size, hidden_size)).astype(dtype), dev
    )
...
save_to_json(
    result,
    "/home/weitao/XIAG8XX/profile/testIR/m_n10240_k2560/data/16x16x16/i2j4_x5y3_in4.json",
)                                                                            