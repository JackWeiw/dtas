...
class Module:
    ...
    def main(p_lv9: T.handle, lv3: T.Buffer((T.int64(2560), T.int64(10240)), "float16"), lv4: T.Buffer((T.int64(2560),), "float16"), p_output0: T.handle):
        ...
        # with T.block("root"):
        lv9_reindex_pad_shared_dyn = T.alloc_buffer((T.int64(1), (n + T.int64(767)) // T.int64(768) * T.int64(768), T.int64(10240)), "float16", scope="shared.dyn")
        lv3_reindex_shared_dyn = T.alloc_buffer((T.int64(1), T.int64(2560), T.int64(10240)), "float16", scope="shared.dyn")
        lv9_reindex_pad_shared_dyn_wmma_matrix_a = T.alloc_buffer((T.int64(1), (n + T.int64(767)) // T.int64(768) * T.int64(768), T.int64(10240)), "float16", scope="wmma.matrix_a")
        lv3_reindex_shared_dyn_wmma_matrix_b = T.alloc_buffer((T.int64(1), T.int64(2560), T.int64(10240)), "float16", scope="wmma.matrix_b")
        var_NT_matmul_intermediate_reindex_pad_shared_dyn = T.alloc_buffer((T.int64(1), (n + T.int64(767)) // T.int64(768) * T.int64(768), T.int64(2560)), "float16", scope="shared.dyn")
        var_NT_matmul_intermediate_reindex_pad_shared_dyn_wmma_accumulator = T.alloc_buffer((T.int64(1), (n + T.int64(767)) // T.int64(768) * T.int64(768), T.int64(2560)), "float16", scope="wmma.accumulator")
                    ...
                    for ax2_0_2_ax1_0_2_fused in T.thread_binding(T.int64(12), thread="threadIdx.y"):
                        for ax1_0_3_init, ax2_0_3_init in T.grid(T.int64(4), T.int64(2)):
                            with T.block("NT_matmul_o_init"):
                                ...
                                v2_o = T.axis.spatial(T.int64(80), ax1_0_1_ax2_0_1_fused * T.int64(4) + ax2_0_2_ax1_0_2_fused // T.int64(6) * T.int64(2) + ax2_0_3_init)
                                T.reads()
                            ...
                            for ax3_0_1 in T.serial(T.int64(4), annotations={"software_pipeline_order": [0, 1, 2], "software_pipeline_stage": [0, 0, 1]}):
                                ...
                                for ax0_0 in T.unroll(T.int64(2)):
                                    for ax1_0 in T.unroll(T.int64(1)):
                                        with T.block("lv3_reindex_shared.dyn_wmma.matrix_b_o"):
                                            v0_o = T.axis.spatial(T.int64(1), T.int64(0))
                                            v1_o = T.axis.spatial(T.int64(80), ax1_0_1_ax2_0_1_fused * T.int64(4) + ax2_0_2_ax1_0_2_fused // T.int64(6) * T.int64(2) + ax0_0)
                                            v2_o = T.axis.spatial(T.int64(640), ax3_0_0 * T.int64(4) + ax3_0_1 + ax1_0)
                                ...
                                for ax1_0_3, ax2_0_3 in T.grid(T.int64(4), T.int64(2)):
                                    with T.block("NT_matmul_o_update"):
                                        ...
                                        v2_o = T.axis.spatial(T.int64(80), ax1_0_1_ax2_0_1_fused * T.int64(4) + ax2_0_2_ax1_0_2_fused // T.int64(6) * T.int64(2) + ax2_0_3)
                        ...
                        for ax0_0, ax1_0 in T.grid(T.int64(4), T.int64(2)):
                            with T.block("var_NT_matmul_intermediate_reindex_pad_shared.dyn_wmma.accumulator_o"):
                                v0_o = T.axis.spatial(T.int64(1), T.int64(0))
                                v1_o = T.axis.spatial(T.int64(24) * ((n + T.int64(767)) // T.int64(768) * T.int64(4)), ax1_0_0_ax2_0_0_fused * T.int64(24) + ax2_0_2_ax1_0_2_fused % T.int64(6) * T.int64(4) + ax0_0)
                                v2_o = T.axis.spatial(T.int64(80), ax1_0_1_ax2_0_1_fused * T.int64(4) + ax2_0_2_ax1_0_2_fused // T.int64(6) * T.int64(2) + ax1_0)
                            ...
                            for ax0_ax1_fused_1 in T.thread_binding(T.int64(32), thread="threadIdx.x"):
                                for ax0_ax1_fused_2 in T.vectorized(T.int64(4)):
                                    with T.block("var_NT_matmul_intermediate_reindex_pad_shared.dyn"):
                                        ...
                                        v2 = T.axis.spatial(T.int64(2560), ax1_0_1_ax2_0_1_fused * T.int64(128) + ax2_0_2_ax1_0_2_fused // T.int64(6) * T.int64(64) + (ax0_ax1_fused_0 * T.int64(128) + ax0_ax1_fused_1 * T.int64(4) + ax0_ax1_fused_2) % T.int64(64))
...
save_to_json(
    result,
    "/home/weitao/XIAG8XX/profile/testIR/GEMM/m_n2560_k10240/data/8x32x16/i6j2_x4y2_in8.json",
)                                                  