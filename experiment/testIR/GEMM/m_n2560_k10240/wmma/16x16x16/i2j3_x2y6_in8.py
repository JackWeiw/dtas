...
class Module:
    ...
    def main(p_lv9: T.handle, lv3: T.Buffer((T.int64(2560), T.int64(10240)), "float16"), lv4: T.Buffer((T.int64(2560),), "float16"), p_output0: T.handle):
        ...
        # with T.block("root"):
        lv9_reindex_pad_shared_dyn = T.alloc_buffer((T.int64(1), (n + T.int64(63)) // T.int64(64) * T.int64(64), T.int64(10240)), "float16", scope="shared.dyn")
        lv3_reindex_pad_shared_dyn = T.alloc_buffer((T.int64(1), T.int64(2592), T.int64(10240)), "float16", scope="shared.dyn")
        lv9_reindex_pad_shared_dyn_wmma_matrix_a = T.alloc_buffer((T.int64(1), (n + T.int64(63)) // T.int64(64) * T.int64(64), T.int64(10240)), "float16", scope="wmma.matrix_a")
        lv3_reindex_pad_shared_dyn_wmma_matrix_b = T.alloc_buffer((T.int64(1), T.int64(2592), T.int64(10240)), "float16", scope="wmma.matrix_b")
        var_NT_matmul_intermediate_reindex_pad_shared_dyn = T.alloc_buffer((T.int64(1), (n + T.int64(63)) // T.int64(64) * T.int64(64), T.int64(2592)), "float16", scope="shared.dyn")
        var_NT_matmul_intermediate_reindex_pad_shared_dyn_wmma_accumulator = T.alloc_buffer((T.int64(1), (n + T.int64(63)) // T.int64(64) * T.int64(64), T.int64(2592)), "float16", scope="wmma.accumulator")
        for ax0 in T.thread_binding(T.int64(1), thread="blockIdx.z"):
            for ax1_0_0_ax2_0_0_fused in T.thread_binding((n + T.int64(63)) // T.int64(64), thread="blockIdx.x"):
                for ax1_0_1_ax2_0_1_fused in T.thread_binding(T.int64(9), thread="blockIdx.y"):
                    for ax2_0_2_ax1_0_2_fused in T.thread_binding(T.int64(6), thread="threadIdx.y"):
                        for ax1_0_3_init, ax2_0_3_init in T.grid(T.int64(2), T.int64(6)):
                            with T.block("NT_matmul_o_init"):
                                v0_o = T.axis.spatial(T.int64(1), ax0)
                                v1_o = T.axis.spatial((n + T.int64(63)) // T.int64(64) * T.int64(4), ax1_0_0_ax2_0_0_fused * T.int64(4) + ax2_0_2_ax1_0_2_fused % T.int64(2) * T.int64(2) + ax1_0_3_init)
                                v2_o = T.axis.spatial(T.int64(162), ax1_0_1_ax2_0_1_fused * T.int64(18) + ax2_0_2_ax1_0_2_fused // T.int64(2) * T.int64(6) + ax2_0_3_init)
                                T.reads()
                        ...
                        for ax3_0_0 in T.serial(T.int64(160), annotations={"software_pipeline_order": [0, 3, 1, 4, 5, 2, 6], "software_pipeline_stage": [0, 0, 0, 0, 0, 1, 1]}):
                            for ax0_1, ax1_ax2_fused_0_0_0 in T.grid(T.int64(1), T.int64(3)):
                                for ax1_ax2_fused_0_0_1 in T.thread_binding(T.int64(6), thread="threadIdx.y"):
                                    for ax1_ax2_fused_0_1 in T.thread_binding(T.int64(32), thread="threadIdx.x"):
                                        for ax1_ax2_fused_1 in T.vectorized(T.int64(8), annotations={"check_vector_load": 1, "remove_vector_condition": 1}):
                                            with T.block("lv9_reindex_pad_shared.dyn"):
                                                ...
                                                v1 = T.axis.spatial((n + T.int64(63)) // T.int64(64) * T.int64(64), ax1_0_0_ax2_0_0_fused * T.int64(64) + ((ax1_ax2_fused_0_0_0 * T.int64(6) + ax1_ax2_fused_0_0_1) * T.int64(256) + ax1_ax2_fused_0_1 * T.int64(8) + ax1_ax2_fused_1) // T.int64(64))
                                                v2 = T.axis.spatial(T.int64(10240), ax3_0_0 * T.int64(64) + ((ax1_ax2_fused_0_0_0 * T.int64(6) + ax1_ax2_fused_0_0_1) * T.int64(256) + ax1_ax2_fused_0_1 * T.int64(8) + ax1_ax2_fused_1) % T.int64(64))
                                                T.where(ax1_ax2_fused_0_0_0 * T.int64(6) + ax1_ax2_fused_0_0_1 < T.int64(16))
                            ...
                            for ax0_1, ax1_ax2_fused_0_0_0 in T.grid(T.int64(1), T.int64(12)):
                                for ax1_ax2_fused_0_0_1 in T.thread_binding(T.int64(6), thread="threadIdx.y"):
                                    for ax1_ax2_fused_0_1 in T.thread_binding(T.int64(32), thread="threadIdx.x"):
                                        for ax1_ax2_fused_1 in T.vectorized(T.int64(8), annotations={"check_vector_load": 1, "remove_vector_condition": 1}):
                                            with T.block("lv3_reindex_pad_shared.dyn"):
                                                v0 = T.axis.spatial(T.int64(1), ax0_1)
                                                v1 = T.axis.spatial(T.int64(2592), ax1_0_1_ax2_0_1_fused * T.int64(288) + (ax1_ax2_fused_0_0_0 * T.int64(1536) + ax1_ax2_fused_0_0_1 * T.int64(256) + ax1_ax2_fused_0_1 * T.int64(8) + ax1_ax2_fused_1) // T.int64(64))
                                                v2 = T.axis.spatial(T.int64(10240), ax3_0_0 * T.int64(64) + (ax1_ax2_fused_0_0_0 * T.int64(1536) + ax1_ax2_fused_0_0_1 * T.int64(256) + ax1_ax2_fused_0_1 * T.int64(8) + ax1_ax2_fused_1) % T.int64(64))
                                                T.reads(lv3[v1, v2])
                                                T.writes(lv3_reindex_pad_shared_dyn[v0, v1, v2])
                                                T.block_attr({"buffer_dim_align": [[0, 1, 16, 8]], "double_buffer_scope": 0, "tir.manifest_shared_memory_local_stage": 1})
                                                lv3_reindex_pad_shared_dyn[v0, v1, v2] = T.if_then_else(v1 < T.int64(2560), lv3[v1, v2], T.float16(0))
                            for ax3_0_1 in T.serial(T.int64(4), annotations={"software_pipeline_order": [0, 1, 2], "software_pipeline_stage": [0, 0, 1]}):
                                for ax0_0 in T.unroll(T.int64(2)):
                                    for ax1_0 in T.unroll(T.int64(1)):
                                        with T.block("lv9_reindex_pad_shared.dyn_wmma.matrix_a_o"):
                                            ...
                                            v1_o = T.axis.spatial(T.int64(4) * ((n + T.int64(63)) // T.int64(64)), ax1_0_0_ax2_0_0_fused * T.int64(4) + ax2_0_2_ax1_0_2_fused % T.int64(2) * T.int64(2) + ax0_0)
                                ...
                                for ax0_0 in T.unroll(T.int64(6)):
                                    for ax1_0 in T.unroll(T.int64(1)):
                                        with T.block("lv3_reindex_pad_shared.dyn_wmma.matrix_b_o"):
                                            v0_o = T.axis.spatial(T.int64(1), T.int64(0))
                                            v1_o = T.axis.spatial(T.int64(162), ax1_0_1_ax2_0_1_fused * T.int64(18) + ax2_0_2_ax1_0_2_fused // T.int64(2) * T.int64(6) + ax0_0)
                                            v2_o = T.axis.spatial(T.int64(640), ax3_0_0 * T.int64(4) + ax3_0_1 + ax1_0)
                                            T.reads(lv3_reindex_pad_shared_dyn[v0_o, v1_o * T.int64(16):v1_o * T.int64(16) + T.int64(16), v2_o * T.int64(16):v2_o * T.int64(16) + T.int64(16)])
                                            T.writes(lv3_reindex_pad_shared_dyn_wmma_matrix_b[v0_o, v1_o * T.int64(16):v1_o * T.int64(16) + T.int64(16), v2_o * T.int64(16):v2_o * T.int64(16) + T.int64(16)])
                                            A = T.match_buffer(lv3_reindex_pad_shared_dyn[v0_o, v1_o * T.int64(16):v1_o * T.int64(16) + T.int64(16), v2_o * T.int64(16):v2_o * T.int64(16) + T.int64(16)], (T.int64(16), T.int64(16)), "float16", strides=("A_s0", "A_s1"), scope="shared.dyn", offset_factor=16)
                                            C = T.match_buffer(lv3_reindex_pad_shared_dyn_wmma_matrix_b[v0_o, v1_o * T.int64(16):v1_o * T.int64(16) + T.int64(16), v2_o * T.int64(16):v2_o * T.int64(16) + T.int64(16)], (T.int64(16), T.int64(16)), "float16", strides=("C_s0", "C_s1"), scope="wmma.matrix_b", offset_factor=16)
                                ...
                                for ax1_0_3, ax2_0_3 in T.grid(T.int64(2), T.int64(6)):
                                    with T.block("NT_matmul_o_update"):
                                        ...
                                        with T.block("NT_matmul_o"):
                                            ...
                                            B = T.match_buffer(lv3_reindex_pad_shared_dyn_wmma_matrix_b[T.int64(0), v2_o * T.int64(16):v2_o * T.int64(16) + T.int64(16), v3_o * T.int64(16):v3_o * T.int64(16) + T.int64(16)], (T.int64(16), T.int64(16)), "float16", strides=("B_s0", "B_s1"), scope="wmma.matrix_b", offset_factor=16)
                                            C = T.match_buffer(var_NT_matmul_intermediate_reindex_pad_shared_dyn_wmma_accumulator[T.int64(0), v1_o * T.int64(16):v1_o * T.int64(16) + T.int64(16), v2_o * T.int64(16):v2_o * T.int64(16) + T.int64(16)], (T.int64(16), T.int64(16)), "float16", strides=("C_s0", "C_s1"), scope="wmma.accumulator", offset_factor=16)
                        ...
                        for ax0_0, ax1_0 in T.grid(T.int64(2), T.int64(6)):
                            with T.block("var_NT_matmul_intermediate_reindex_pad_shared.dyn_wmma.accumulator_o"):
                                v0_o = T.axis.spatial(T.int64(1), T.int64(0))
                                v1_o = T.axis.spatial(T.int64(4) * ((n + T.int64(63)) // T.int64(64)), ax1_0_0_ax2_0_0_fused * T.int64(4) + ax2_0_2_ax1_0_2_fused % T.int64(2) * T.int64(2) + ax0_0)
                                v2_o = T.axis.spatial(T.int64(162), ax1_0_1_ax2_0_1_fused * T.int64(18) + ax2_0_2_ax1_0_2_fused // T.int64(2) * T.int64(6) + ax1_0)
                            ...
                            for ax0_ax1_fused_1 in T.thread_binding(T.int64(32), thread="threadIdx.x"):
                                for ax0_ax1_fused_2 in T.vectorized(T.int64(8)):
                                    with T.block("var_NT_matmul_intermediate_reindex_pad_shared.dyn"):
                                        ...
                                        v1 = T.axis.spatial((n + T.int64(63)) // T.int64(64) * T.int64(64), ax1_0_0_ax2_0_0_fused * T.int64(64) + ax2_0_2_ax1_0_2_fused % T.int64(2) * T.int64(32) + (ax0_ax1_fused_0 * T.int64(256) + ax0_ax1_fused_1 * T.int64(8) + ax0_ax1_fused_2) // T.int64(96))
                                        v2 = T.axis.spatial(T.int64(2592), ax1_0_1_ax2_0_1_fused * T.int64(288) + ax2_0_2_ax1_0_2_fused // T.int64(2) * T.int64(96) + (ax0_ax1_fused_0 * T.int64(256) + ax0_ax1_fused_1 * T.int64(8) + ax0_ax1_fused_2) % T.int64(96))
    ...
    def WT_test(A: R.Tensor((1, "n", 10240), dtype=dtype), w_q: R.Tensor((2560, 10240), dtype=dtype), bias_q: R.Tensor((2560,), dtype=dtype)) -> R.Tensor((1, "n", 2560), dtype=dtype):
        ...
        cls = Module
        with R.dataflow():
            lv = R.call_tir(cls.main, (A, w_q, bias_q), out_sinfo=R.Tensor((1, n, 2560), dtype=dtype))
...
save_to_json(
    result,
    "/home/weitao/XIAG8XX/profile/testIR/GEMM/m_n2560_k10240/data/16x16x16/i2j3_x2y6_in8.json",
)                                             