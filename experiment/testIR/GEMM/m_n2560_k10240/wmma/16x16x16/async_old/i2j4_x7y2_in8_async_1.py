            ...
            for ax1_0_0_ax2_0_0_fused in T.thread_binding((n + T.int64(223)) // T.int64(224), thread="blockIdx.x"):
                for ax1_0_1_ax2_0_1_fused in T.thread_binding(T.int64(20), thread="blockIdx.y"):
                    for ax2_0_2_ax1_0_2_fused in T.thread_binding(T.int64(8), thread="threadIdx.y"):
                        ...
                        for ax3_0_0 in T.serial(T.int64(160), annotations={"software_pipeline_async_stages": [0], "software_pipeline_order": [0, 1, 2], "software_pipeline_stage": [0, 0, 1]}):
                            ...
                            for ax0_ax1_fused_1 in T.thread_binding(T.int64(32), thread="threadIdx.x"):
                                for ax0_ax1_fused_2 in T.vectorized(T.int64(8)):
                                    with T.block("var_NT_matmul_intermediate_reindex_pad_shared.dyn"):
                                        ...
                                        v1 = T.axis.spatial((n + T.int64(223)) // T.int64(224) * T.int64(224), ax1_0_0_ax2_0_0_fused * T.int64(224) + ax2_0_2_ax1_0_2_fused % T.int64(2) * T.int64(112) + (ax0_ax1_fused_0 * T.int64(256) + ax0_ax1_fused_1 * T.int64(8) + ax0_ax1_fused_2) // T.int64(32))
...
save_to_json(
    result,
    "/home/weitao/XIAG8XX/profile/testIR/GEMM/m_n2560_k10240/data/16x16x16/async/i2j4_x7y2_in8_async.json",
)                                                                                                  
...
#     with open(filename,"w") as f:
#         f.write(mod.script())
# save_to_file("/home/weitao/XIAG8XX/profile/async_test/3rewrite.py",mod) 