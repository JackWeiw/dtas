...
class Module:
    ...
    def main(p_lv9: T.handle, lv3: T.Buffer((T.int64(2560), T.int64(10240)), "float16"), lv4: T.Buffer((T.int64(2560),), "float16"), p_output0: T.handle):
        ...
        # with T.block("root"):
        lv9_reindex_pad_shared_dyn = T.alloc_buffer((T.int64(1), (n + T.int64(127)) // T.int64(128) * T.int64(128), T.int64(10240)), "float16", scope="shared.dyn")
        lv3_reindex_pad_shared_dyn = T.alloc_buffer((T.int64(1), T.int64(2688), T.int64(10240)), "float16", scope="shared.dyn")
        lv9_reindex_pad_shared_dyn_wmma_matrix_a = T.alloc_buffer((T.int64(1), (n + T.int64(127)) // T.int64(128) * T.int64(128), T.int64(10240)), "float16", scope="wmma.matrix_a")
        lv3_reindex_pad_shared_dyn_wmma_matrix_b = T.alloc_buffer((T.int64(1), T.int64(2688), T.int64(10240)), "float16", scope="wmma.matrix_b")
        var_NT_matmul_intermediate_reindex_pad_shared_dyn = T.alloc_buffer((T.int64(1), (n + T.int64(127)) // T.int64(128) * T.int64(128), T.int64(2688)), "float16", scope="shared.dyn")
        var_NT_matmul_intermediate_reindex_pad_shared_dyn_wmma_accumulator = T.alloc_buffer((T.int64(1), (n + T.int64(127)) // T.int64(128) * T.int64(128), T.int64(2688)), "float16", scope="wmma.accumulator")
        for ax0 in T.thread_binding(T.int64(1), thread="blockIdx.z"):
            for ax1_0_0_ax2_0_0_fused in T.thread_binding((n + T.int64(127)) // T.int64(128), thread="blockIdx.x"):
                for ax1_0_1_ax2_0_1_fused in T.thread_binding(T.int64(14), thread="blockIdx.y"):
                    for ax2_0_2_ax1_0_2_fused in T.thread_binding(T.int64(6), thread="threadIdx.y"):
                        for ax1_0_3_init, ax2_0_3_init in T.grid(T.int64(4), T.int64(4)):
                            with T.block("NT_matmul_o_init"):
                                ...
                                v1_o = T.axis.spatial((n + T.int64(127)) // T.int64(128) * T.int64(8), ax1_0_0_ax2_0_0_fused * T.int64(8) + ax2_0_2_ax1_0_2_fused % T.int64(2) * T.int64(4) + ax1_0_3_init)
                                v2_o = T.axis.spatial(T.int64(168), ax1_0_1_ax2_0_1_fused * T.int64(12) + ax2_0_2_ax1_0_2_fused // T.int64(2) * T.int64(4) + ax2_0_3_init)
                                T.reads()
                        ...
                        for ax3_0_0 in T.serial(T.int64(160), annotations={"software_pipeline_async_stages": [0], "software_pipeline_order": [0, 1, 2, 3, 4], "software_pipeline_stage": [0, 0, 1, 1, 1]}):
                                    ...
                                    for ax1_ax2_fused_0_1 in T.thread_binding(T.int64(32), thread="threadIdx.x"):
                                        for ax1_ax2_fused_1 in T.vectorized(T.int64(8), annotations={"check_vector_load": 1, "remove_vector_condition": 1}):
                                            with T.block("lv9_reindex_pad_shared.dyn"):
                                                ...
                                                v1 = T.axis.spatial((n + T.int64(127)) // T.int64(128) * T.int64(128), ax1_0_0_ax2_0_0_fused * T.int64(128) + ((ax1_ax2_fused_0_0_0 * T.int64(6) + ax1_ax2_fused_0_0_1) * T.int64(256) + ax1_ax2_fused_0_1 * T.int64(8) + ax1_ax2_fused_1) // T.int64(64))
                                                ...
                                                T.where(ax1_ax2_fused_0_0_0 * T.int64(6) + ax1_ax2_fused_0_0_1 < T.int64(32))
                                    ...
                                    for ax1_ax2_fused_0_1 in T.thread_binding(T.int64(32), thread="threadIdx.x"):
                                        for ax1_ax2_fused_1 in T.vectorized(T.int64(8), annotations={"check_vector_load": 1, "remove_vector_condition": 1}):
                                            with T.block("lv3_reindex_pad_shared.dyn"):
                                                v0 = T.axis.spatial(T.int64(1), ax0_1)
                                                v1 = T.axis.spatial(T.int64(2688), ax1_0_1_ax2_0_1_fused * T.int64(192) + (ax1_ax2_fused_0_0_0 * T.int64(1536) + ax1_ax2_fused_0_0_1 * T.int64(256) + ax1_ax2_fused_0_1 * T.int64(8) + ax1_ax2_fused_1) // T.int64(64))
                            ...
                            for ax3_0_1 in T.serial(T.int64(4), annotations={"software_pipeline_order": [0, 1, 2], "software_pipeline_stage": [0, 0, 1]}):
                                for ax0_0 in T.unroll(T.int64(4)):
                                    for ax1_0 in T.unroll(T.int64(1)):
                                        with T.block("lv9_reindex_pad_shared.dyn_wmma.matrix_a_o"):
                                            ...
                                            v1_o = T.axis.spatial(T.int64(8) * ((n + T.int64(127)) // T.int64(128)), ax1_0_0_ax2_0_0_fused * T.int64(8) + ax2_0_2_ax1_0_2_fused % T.int64(2) * T.int64(4) + ax0_0)
                                ...
                                for ax0_0 in T.unroll(T.int64(4)):
                                    for ax1_0 in T.unroll(T.int64(1)):
                                        with T.block("lv3_reindex_pad_shared.dyn_wmma.matrix_b_o"):
                                            v0_o = T.axis.spatial(T.int64(1), T.int64(0))
                                            v1_o = T.axis.spatial(T.int64(168), ax1_0_1_ax2_0_1_fused * T.int64(12) + ax2_0_2_ax1_0_2_fused // T.int64(2) * T.int64(4) + ax0_0)
                                            v2_o = T.axis.spatial(T.int64(640), ax3_0_0 * T.int64(4) + ax3_0_1 + ax1_0)
                                ...
                                for ax1_0_3, ax2_0_3 in T.grid(T.int64(4), T.int64(4)):
                                    with T.block("NT_matmul_o_update"):
                                        v0_o = T.axis.spatial(T.int64(1), ax0)
                                        v1_o = T.axis.spatial((n + T.int64(127)) // T.int64(128) * T.int64(8), ax1_0_0_ax2_0_0_fused * T.int64(8) + ax2_0_2_ax1_0_2_fused % T.int64(2) * T.int64(4) + ax1_0_3)
                                        v2_o = T.axis.spatial(T.int64(168), ax1_0_1_ax2_0_1_fused * T.int64(12) + ax2_0_2_ax1_0_2_fused // T.int64(2) * T.int64(4) + ax2_0_3)
                        ...
                        for ax0_0, ax1_0 in T.grid(T.int64(4), T.int64(4)):
                            with T.block("var_NT_matmul_intermediate_reindex_pad_shared.dyn_wmma.accumulator_o"):
                                v0_o = T.axis.spatial(T.int64(1), T.int64(0))
                                v1_o = T.axis.spatial(T.int64(8) * ((n + T.int64(127)) // T.int64(128)), ax1_0_0_ax2_0_0_fused * T.int64(8) + ax2_0_2_ax1_0_2_fused % T.int64(2) * T.int64(4) + ax0_0)
                                v2_o = T.axis.spatial(T.int64(168), ax1_0_1_ax2_0_1_fused * T.int64(12) + ax2_0_2_ax1_0_2_fused // T.int64(2) * T.int64(4) + ax1_0)
                            ...
                            for ax0_ax1_fused_1 in T.thread_binding(T.int64(32), thread="threadIdx.x"):
                                for ax0_ax1_fused_2 in T.vectorized(T.int64(8)):
                                    with T.block("var_NT_matmul_intermediate_reindex_pad_shared.dyn"):
                                        ...
                                        v1 = T.axis.spatial((n + T.int64(127)) // T.int64(128) * T.int64(128), ax1_0_0_ax2_0_0_fused * T.int64(128) + ax2_0_2_ax1_0_2_fused % T.int64(2) * T.int64(64) + (ax0_ax1_fused_0 * T.int64(256) + ax0_ax1_fused_1 * T.int64(8) + ax0_ax1_fused_2) // T.int64(64))
                                        v2 = T.axis.spatial(T.int64(2688), ax1_0_1_ax2_0_1_fused * T.int64(192) + ax2_0_2_ax1_0_2_fused // T.int64(2) * T.int64(64) + (ax0_ax1_fused_0 * T.int64(256) + ax0_ax1_fused_1 * T.int64(8) + ax0_ax1_fused_2) % T.int64(64))
...
save_to_json(
    result,
    "/home/weitao/XIAG8XX/profile/testIR/GEMM/m_n2560_k10240/data/16x16x16/async/i2j3_x4y4_in8_async.json",
)                                              