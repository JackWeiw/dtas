...
class Module:
    ...
    def main(p_lv9: T.handle, lv3: T.Buffer((T.int64(2560), T.int64(10240)), "float16"), lv4: T.Buffer((T.int64(2560),), "float16"), p_output0: T.handle):
        ...
        # with T.block("root"):
        lv9_reindex_pad_shared_dyn = T.alloc_buffer((T.int64(1), (n + T.int64(223)) // T.int64(224) * T.int64(224), T.int64(10240)), "float16", scope="shared.dyn")
        lv3_reindex_shared_dyn = T.alloc_buffer((T.int64(1), T.int64(2560), T.int64(10240)), "float16", scope="shared.dyn")
        lv9_reindex_pad_shared_dyn_wmma_matrix_a = T.alloc_buffer((T.int64(1), (n + T.int64(223)) // T.int64(224) * T.int64(224), T.int64(10240)), "float16", scope="wmma.matrix_a")
        lv3_reindex_shared_dyn_wmma_matrix_b = T.alloc_buffer((T.int64(1), T.int64(2560), T.int64(10240)), "float16", scope="wmma.matrix_b")
        var_NT_matmul_intermediate_reindex_pad_shared_dyn = T.alloc_buffer((T.int64(1), (n + T.int64(223)) // T.int64(224) * T.int64(224), T.int64(2560)), "float16", scope="shared.dyn")
        var_NT_matmul_intermediate_reindex_pad_shared_dyn_wmma_accumulator = T.alloc_buffer((T.int64(1), (n + T.int64(223)) // T.int64(224) * T.int64(224), T.int64(2560)), "float16", scope="wmma.accumulator")
                                    ...
                                    for ax1_ax2_fused_0_1 in T.thread_binding(T.int64(32), thread="threadIdx.x"):
                                        for ax1_ax2_fused_1 in T.vectorized(T.int64(8), annotations={"check_vector_load": 1, "remove_vector_condition": 1}):
                                            with T.block("lv9_reindex_pad_shared.dyn"):
                                                ...
                                                v1 = T.axis.spatial((n + T.int64(223)) // T.int64(224) * T.int64(224), ax1_0_0_ax2_0_0_fused * T.int64(224) + (ax1_ax2_fused_0_0_0 * T.int64(2048) + ax1_ax2_fused_0_0_1 * T.int64(256) + ax1_ax2_fused_0_1 * T.int64(8) + ax1_ax2_fused_1) // T.int64(64))
                                                ...
                                                T.block_attr({"permuted_layout": 1, "double_buffer_scope": 0, "tir.manifest_shared_memory_local_stage": 1})
                            ...
                            for ax0_ax1_fused_1 in T.thread_binding(T.int64(32), thread="threadIdx.x"):
                                for ax0_ax1_fused_2 in T.vectorized(T.int64(4)):
                                    with T.block("var_NT_matmul_intermediate_reindex_pad_shared.dyn"):
                                        ...
                                        v2 = T.axis.spatial(T.int64(2560), ax1_0_1_ax2_0_1_fused * T.int64(128) + ax2_0_2_ax1_0_2_fused // T.int64(2) * T.int64(32) + (ax0_ax1_fused_0 * T.int64(128) + ax0_ax1_fused_1 * T.int64(4) + ax0_ax1_fused_2) % T.int64(32))
...
hidden_size = 2560
result = {}
timer = lib.time_evaluator("main", dev, number=2)
...
save_to_json(
    result,
    "/home/weitao/XIAG8XX/profile/testIR/swizz_gemm/data/i2j4_x7y2_in8_swizzsmem.json",
)   